...
require_relative "merge_ruby_client/organizations/client"
...
module Merge
  class Client
    ...
    def initialize(api_key:, base_url: nil, environment: Merge::Environment::PRODUCTION, max_retries: nil,
      ...
      @organizations = Merge::Organizations::Client.new(request_client: @request_client)
    end
  end
  ...
  class AsyncClient
    ...
    def initialize(api_key:, base_url: nil, environment: Merge::Environment::PRODUCTION, max_retries: nil,
      ...
      @organizations = Merge::Organizations::AsyncClient.new(request_client: @async_request_client)
    end
  end
end
