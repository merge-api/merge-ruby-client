...
require_relative "purchase_order_line_item_request_currency"
require "json"
...
Fetch from the `GET PurchaseOrder` endpoint and view a company's purchase orders.
    class PurchaseOrderLineItemRequest
      attr_reader :remote_id, :description, :unit_price, :quantity, :item, :account, :tracking_category, :tracking_categories, :tax_amount, :total_line_amount, :currency, :exchange_rate, :company, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param item [Accounting::PurchaseOrderLineItemRequestItem] 
      ...
      # @param currency [Accounting::PurchaseOrderLineItemRequestCurrency] The purchase order line item's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # @return [Accounting::PurchaseOrderLineItemRequest]
      def initialize(remote_id: nil, description: nil, unit_price: nil, quantity: nil, item: nil, account: nil, tracking_category: nil, tracking_categories:, tax_amount: nil, total_line_amount: nil, currency: nil, exchange_rate: nil, company: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
        ...
        @quantity = quantity
        # @type [Accounting::PurchaseOrderLineItemRequestItem] 
        @item = item
        ...
        # @type [Accounting::PurchaseOrderLineItemRequestCurrency] The purchase order line item's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # Deserialize a JSON object to an instance of PurchaseOrderLineItemRequest
      #
      ...
      def self.from_json(json_object:)
        ...
        item = Accounting::PurchaseOrderLineItemRequestItem.from_json(json_object: item)
        ...
        currency = Accounting::PurchaseOrderLineItemRequestCurrency.from_json(json_object: currency)
        exchange_rate = struct.exchange_rate
        company = struct.company
        integration_params = struct.integration_params
        linked_account_params = struct.linked_account_params
        new(remote_id: remote_id, description: description, unit_price: unit_price, quantity: quantity, item: item, account: account, tracking_category: tracking_category, tracking_categories: tracking_categories, tax_amount: tax_amount, total_line_amount: total_line_amount, currency: currency, exchange_rate: exchange_rate, company: company, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of PurchaseOrderLineItemRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "remote_id": @remote_id, "description": @description, "unit_price": @unit_price, "quantity": @quantity, "item": @item, "account": @account, "tracking_category": @tracking_category, "tracking_categories": @tracking_categories, "tax_amount": @tax_amount, "total_line_amount": @total_line_amount, "currency": @currency, "exchange_rate": @exchange_rate, "company": @company, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.item.nil?() || Accounting::PurchaseOrderLineItemRequestItem.validate_raw(obj: obj.item)
        ...
        obj.currency.nil?() || Accounting::PurchaseOrderLineItemRequestCurrency.validate_raw(obj: obj.currency)
