...
require_relative "transaction_line_item_currency"
require "date"
require "date"
require "json"
...
Fetch from the `GET TransactionLineItem` endpoint and view the transaction's line items.
    class TransactionLineItem
      attr_reader :remote_id, :memo, :unit_price, :quantity, :item, :account, :tracking_category, :tracking_categories, :total_line_amount, :tax_rate, :currency, :exchange_rate, :company, :remote_was_deleted, :id, :created_at, :modified_at, :additional_properties
      ...
      # @param item [Accounting::TransactionLineItemItem] 
      ...
      # @param currency [Accounting::TransactionLineItemCurrency] The line item's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # @return [Accounting::TransactionLineItem]
      def initialize(remote_id: nil, memo: nil, unit_price: nil, quantity: nil, item: nil, account: nil, tracking_category: nil, tracking_categories:, total_line_amount: nil, tax_rate: nil, currency: nil, exchange_rate: nil, company: nil, remote_was_deleted: nil, id: nil, created_at: nil, modified_at: nil, additional_properties: nil)
        # @type [String] The third-party API ID of the matching object.
        @remote_id = remote_id
        # @type [String] An internal note used by the business to clarify purpose of the transaction.
        @memo = memo
        # @type [String] The line item's unit price.
        @unit_price = unit_price
        # @type [String] The line item's quantity.
        @quantity = quantity
        # @type [Accounting::TransactionLineItemItem] 
        @item = item
        # @type [String] The line item's account.
        @account = account
        ...
        # @type [String] The line item's total.
        @total_line_amount = total_line_amount
        # @type [String] The line item's tax rate.
        @tax_rate = tax_rate
        # @type [Accounting::TransactionLineItemCurrency] The line item's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        item = Accounting::TransactionLineItemItem.from_json(json_object: item)
        ...
        currency = Accounting::TransactionLineItemCurrency.from_json(json_object: currency)
        ...
        new(remote_id: remote_id, memo: memo, unit_price: unit_price, quantity: quantity, item: item, account: account, tracking_category: tracking_category, tracking_categories: tracking_categories, total_line_amount: total_line_amount, tax_rate: tax_rate, currency: currency, exchange_rate: exchange_rate, company: company, remote_was_deleted: remote_was_deleted, id: id, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of TransactionLineItem to a JSON object
      #
      # @return [JSON]
      def to_json
        { "remote_id": @remote_id, "memo": @memo, "unit_price": @unit_price, "quantity": @quantity, "item": @item, "account": @account, "tracking_category": @tracking_category, "tracking_categories": @tracking_categories, "total_line_amount": @total_line_amount, "tax_rate": @tax_rate, "currency": @currency, "exchange_rate": @exchange_rate, "company": @company, "remote_was_deleted": @remote_was_deleted, "id": @id, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.item.nil?() || Accounting::TransactionLineItemItem.validate_raw(obj: obj.item)
        ...
        obj.currency.nil?() || Accounting::TransactionLineItemCurrency.validate_raw(obj: obj.currency)
