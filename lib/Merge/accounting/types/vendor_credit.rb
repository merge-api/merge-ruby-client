...
require_relative "vendor_credit_currency"
...
Fetch from the `GET VendorCredit` endpoint and view a company's vendor credits.
    class VendorCredit
      attr_reader :id, :remote_id, :number, :transaction_date, :vendor, :total_amount, :currency, :exchange_rate, :company, :lines, :tracking_categories, :remote_was_deleted, :accounting_period, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param currency [Accounting::VendorCreditCurrency] The vendor credit's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(id: nil, remote_id: nil, number: nil, transaction_date: nil, vendor: nil, total_amount: nil, currency: nil, exchange_rate: nil, company: nil, lines: nil, tracking_categories: nil, remote_was_deleted: nil, accounting_period: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        # @type [Accounting::VendorCreditCurrency] The vendor credit's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        currency = Accounting::VendorCreditCurrency.from_json(json_object: currency)
  ...
  Accounting::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, number: number, transaction_date: transaction_date, vendor: vendor, total_amount: total_amount, currency: currency, exchange_rate: exchange_rate, company: company, lines: lines, tracking_categories: tracking_categories, remote_was_deleted: remote_was_deleted, accounting_period: accounting_period, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.currency.nil?() || Accounting::VendorCreditCurrency.validate_raw(obj: obj.currency)
