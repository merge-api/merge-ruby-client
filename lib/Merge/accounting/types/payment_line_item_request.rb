...
`Payment` will have a field called `applied-to-lines` which will be an array of `PaymentLineItemInternalMappingSerializer` objects that can either be a `Invoice`, `CreditNote`, or `JournalEntry`.
    class PaymentLineItemRequest
      attr_reader :applied_amount, :applied_date, :remote_id, :related_object_id, :related_object_type, :integration_params, :linked_account_params, :additional_properties
      ...
      def initialize(applied_amount: nil, applied_date: nil, remote_id: nil, related_object_id: nil, related_object_type: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(applied_amount: applied_amount, applied_date: applied_date, remote_id: remote_id, related_object_id: related_object_id, related_object_type: related_object_type, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of PaymentLineItemRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "applied_amount": @applied_amount, "applied_date": @applied_date, "remote_id": @remote_id, "related_object_id": @related_object_id, "related_object_type": @related_object_type, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
