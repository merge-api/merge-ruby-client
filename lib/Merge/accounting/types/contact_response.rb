...
module Merge
  module Accounting
    class ContactResponse
      ...
      # @param model [Accounting::Contact]
      ...
      # Deserialize a JSON object to an instance of ContactResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        model = Accounting::Contact.from_json(json_object: model)
      ...
      # Serialize an instance of ContactResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
      ...
      def self.validate_raw(obj:)
        Accounting::Contact.validate_raw(obj: obj.model)
