...
Fetch from the `GET VendorCredit` endpoint and view the vendor credit's line items.
    class VendorCreditLine
      attr_reader :remote_id, :net_amount, :tracking_category, :tracking_categories, :description, :account, :company, :exchange_rate, :remote_was_deleted, :id, :created_at, :modified_at, :additional_properties
      ...
      def initialize(remote_id: nil, net_amount: nil, tracking_category: nil, tracking_categories:, description: nil, account: nil, company: nil, exchange_rate: nil, remote_was_deleted: nil, id: nil, created_at: nil, modified_at: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(remote_id: remote_id, net_amount: net_amount, tracking_category: tracking_category, tracking_categories: tracking_categories, description: description, account: account, company: company, exchange_rate: exchange_rate, remote_was_deleted: remote_was_deleted, id: id, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of VendorCreditLine to a JSON object
      #
      # @return [JSON]
      def to_json
        { "remote_id": @remote_id, "net_amount": @net_amount, "tracking_category": @tracking_category, "tracking_categories": @tracking_categories, "description": @description, "account": @account, "company": @company, "exchange_rate": @exchange_rate, "remote_was_deleted": @remote_was_deleted, "id": @id, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
