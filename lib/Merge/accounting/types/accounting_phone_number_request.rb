...
Fetch from the `GET CompanyInfo` endpoint and view the company's phone numbers.
    class AccountingPhoneNumberRequest
      ...
      def initialize(number: nil, type: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(number: number, type: type, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of AccountingPhoneNumberRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "number": @number, "type": @type, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
