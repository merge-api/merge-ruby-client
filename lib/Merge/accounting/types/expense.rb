...
Fetch from the `GET Expense` endpoint and view a company's expense.
    class Expense
      attr_reader :transaction_date, :remote_created_at, :account, :contact, :total_amount, :sub_total, :total_tax_amount, :currency, :exchange_rate, :company, :memo, :lines, :tracking_categories, :remote_was_deleted, :accounting_period, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      # @param currency [Accounting::ExpenseCurrency] The expense's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(transaction_date: nil, remote_created_at: nil, account: nil, contact: nil, total_amount: nil, sub_total: nil, total_tax_amount: nil, currency: nil, exchange_rate: nil, company: nil, memo: nil, lines: nil, tracking_categories: nil, remote_was_deleted: nil, accounting_period: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
...
- `ZWL` - Zimbabwean Dollar (2009)
  ...
  Accounting::RemoteData.from_json(json_object: v)
        ...
        new(transaction_date: transaction_date, remote_created_at: remote_created_at, account: account, contact: contact, total_amount: total_amount, sub_total: sub_total, total_tax_amount: total_tax_amount, currency: currency, exchange_rate: exchange_rate, company: company, memo: memo, lines: lines, tracking_categories: tracking_categories, remote_was_deleted: remote_was_deleted, accounting_period: accounting_period, id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
