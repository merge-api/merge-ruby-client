...
module Merge
  module Accounting
    class MetaResponse
      ...
      # @param status [Accounting::LinkedAccountStatus]
      ...
      def initialize(request_schema:, has_conditional_params:, has_required_linked_account_params:,
        ...
        # @type [Accounting::LinkedAccountStatus]
        @status = status
        # @type [Boolean]
      ...
      def self.from_json(json_object:)
        ...
        status = Accounting::LinkedAccountStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Accounting::LinkedAccountStatus.validate_raw(obj: obj.status)
