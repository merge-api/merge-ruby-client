...
Fetch from the `GET CompanyInfo` endpoint and view the company's addresses.
    class AddressRequest
      attr_reader :type, :street_1, :street_2, :city, :country_subdivision, :country, :zip_code, :integration_params, :linked_account_params, :additional_properties
      # @param type [Accounting::AddressRequestType] The address type.  - `BILLING` - BILLING
- `SHIPPING` - SHIPPING
      ...
      # @param country [Accounting::AddressRequestCountry] The address's country.  - `AF` - Afghanistan
- `AX` - Åland Islands
- `AL` - Albania
- `DZ` - Algeria
- `AS` - American Samoa
...
- `ZW` - Zimbabwe
      ...
      def initialize(type: nil, street_1: nil, street_2: nil, city: nil, country_subdivision: nil, country: nil, zip_code: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `ZW` - Zimbabwe
      ...
      def self.from_json(json_object:)
        ...
        new(type: type, street_1: street_1, street_2: street_2, city: city, country_subdivision: country_subdivision, country: country, zip_code: zip_code, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of AddressRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "type": @type, "street_1": @street_1, "street_2": @street_2, "city": @city, "country_subdivision": @country_subdivision, "country": @country, "zip_code": @zip_code, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
