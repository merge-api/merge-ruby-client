...
require_relative "journal_entry_currency"
...
require_relative "journal_entry_posting_status"
...
Fetch from the `GET JournalEntry` endpoint and view a company's journey entry.
    class JournalEntry
      attr_reader :transaction_date, :remote_created_at, :remote_updated_at, :payments, :applied_payments, :memo, :currency, :exchange_rate, :company, :lines, :journal_number, :tracking_categories, :remote_was_deleted, :posting_status, :accounting_period, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      # @param currency [Accounting::JournalEntryCurrency] The journal's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # @param posting_status [Accounting::JournalEntryPostingStatus] The journal's posting status.  - `UNPOSTED` - UNPOSTED
- `POSTED` - POSTED
      ...
      def initialize(transaction_date: nil, remote_created_at: nil, remote_updated_at: nil, payments: nil, applied_payments: nil, memo: nil, currency: nil, exchange_rate: nil, company: nil, lines: nil, journal_number: nil, tracking_categories: nil, remote_was_deleted: nil, posting_status: nil, accounting_period: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        ...
        @memo = memo
        # @type [Accounting::JournalEntryCurrency] The journal's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
        ...
        # @type [Accounting::JournalEntryPostingStatus] The journal's posting status. 
- `UNPOSTED` - UNPOSTED
- `POSTED` - POSTED
  ...
  Accounting::JournalEntryAppliedPaymentsItem.from_json(json_object: v)
        ...
        currency = Accounting::JournalEntryCurrency.from_json(json_object: currency)
  ...
  Accounting::JournalEntryTrackingCategoriesItem.from_json(json_object: v)
        ...
        posting_status = struct.posting_status.to_h.to_json()
        posting_status = Accounting::JournalEntryPostingStatus.from_json(json_object: posting_status)
  ...
  Accounting::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.currency.nil?() || Accounting::JournalEntryCurrency.validate_raw(obj: obj.currency)
        ...
        obj.posting_status.nil?() || Accounting::JournalEntryPostingStatus.validate_raw(obj: obj.posting_status)
