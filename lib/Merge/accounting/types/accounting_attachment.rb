...
Fetch from the `LIST AccountingAttachments` endpoint and view a company's attachments.
    class AccountingAttachment
      attr_reader :id, :remote_id, :file_name, :file_url, :company, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      def initialize(id: nil, remote_id: nil, file_name: nil, file_url: nil, company: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
  ...
  Accounting::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, file_name: file_name, file_url: file_url, company: company, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of AccountingAttachment to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "file_name": @file_name, "file_url": @file_url, "company": @company, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
