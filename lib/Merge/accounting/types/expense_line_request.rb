...
Fetch from the `GET Expense` endpoint and view the expense's line items.
    class ExpenseLineRequest
      attr_reader :remote_id, :item, :net_amount, :tracking_category, :tracking_categories, :company, :currency, :account, :contact, :description, :exchange_rate, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param currency [Accounting::ExpenseLineRequestCurrency] The expense line item's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(remote_id: nil, item: nil, net_amount: nil, tracking_category: nil, tracking_categories: nil, company: nil, currency: nil, account: nil, contact: nil, description: nil, exchange_rate: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `ZWL` - Zimbabwean Dollar (2009)
  ...
  Accounting::ExpenseLineRequestTrackingCategoriesItem.from_json(json_object: v)
        ...
        new(remote_id: remote_id, item: item, net_amount: net_amount, tracking_category: tracking_category, tracking_categories: tracking_categories, company: company, currency: currency, account: account, contact: contact, description: description, exchange_rate: exchange_rate, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
