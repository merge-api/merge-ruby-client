...
require "date"
require_relative "credit_note_status"
...
require_relative "credit_note_currency"
require "date"
require "date"
...
Fetch from the `LIST CreditNotes` endpoint and view a company's credit notes.
    class CreditNote
      attr_reader :id, :remote_id, :transaction_date, :status, :number, :contact, :company, :exchange_rate, :total_amount, :remaining_credit, :line_items, :tracking_categories, :currency, :remote_created_at, :remote_updated_at, :payments, :applied_payments, :remote_was_deleted, :accounting_period, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param transaction_date [DateTime] The credit note's transaction date.
      # @param status [Accounting::CreditNoteStatus] The credit note's status.  - `SUBMITTED` - SUBMITTED
...
- `PAID` - PAID
      ...
      # @param currency [Accounting::CreditNoteCurrency] The credit note's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(id: nil, remote_id: nil, transaction_date: nil, status: nil, number: nil, contact: nil, company: nil, exchange_rate: nil, total_amount: nil, remaining_credit: nil, line_items: nil, tracking_categories: nil, currency: nil, remote_created_at: nil, remote_updated_at: nil, payments: nil, applied_payments: nil, remote_was_deleted: nil, accounting_period: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        # @type [Accounting::CreditNoteStatus] The credit note's status. 
- `SUBMITTED` - SUBMITTED
- `AUTHORIZED` - AUTHORIZED
- `PAID` - PAID
        @status = status
        ...
        # @type [Accounting::CreditNoteCurrency] The credit note's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        status = Accounting::CreditNoteStatus.from_json(json_object: status)
  ...
  Accounting::CreditNoteTrackingCategoriesItem.from_json(json_object: v)
        ...
        currency = Accounting::CreditNoteCurrency.from_json(json_object: currency)
  ...
  Accounting::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil?() || Accounting::CreditNoteStatus.validate_raw(obj: obj.status)
        ...
        obj.currency.nil?() || Accounting::CreditNoteCurrency.validate_raw(obj: obj.currency)
