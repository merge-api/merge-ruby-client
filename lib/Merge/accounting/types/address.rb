...
Fetch from the `GET CompanyInfo` endpoint and view the company's addresses.
    class Address
      attr_reader :type, :street_1, :street_2, :city, :state, :country_subdivision, :country, :zip_code, :created_at, :modified_at, :additional_properties
      # @param type [Accounting::AddressType] The address type.  - `BILLING` - BILLING
- `SHIPPING` - SHIPPING
      ...
      # @param country [Accounting::AddressCountry] The address's country.  - `AF` - Afghanistan
- `AX` - Åland Islands
- `AL` - Albania
- `DZ` - Algeria
- `AS` - American Samoa
...
- `ZW` - Zimbabwe
      ...
      def initialize(type: nil, street_1: nil, street_2: nil, city: nil, state: nil, country_subdivision: nil, country: nil, zip_code: nil, created_at: nil, modified_at: nil, additional_properties: nil)
        # @type [Accounting::AddressType] The address type. 
- `BILLING` - BILLING
- `SHIPPING` - SHIPPING
        @type = type
        ...
        # @type [Accounting::AddressCountry] The address's country. 
- `AF` - Afghanistan
- `AX` - Åland Islands
- `AL` - Albania
- `DZ` - Algeria
...
- `ZW` - Zimbabwe
      ...
      def self.from_json(json_object:)
        ...
        type = Accounting::AddressType.from_json(json_object: type)
        ...
        country = Accounting::AddressCountry.from_json(json_object: country)
        zip_code = struct.zip_code
        created_at = DateTime.parse(struct.created_at)
        modified_at = DateTime.parse(struct.modified_at)
        new(type: type, street_1: street_1, street_2: street_2, city: city, state: state, country_subdivision: country_subdivision, country: country, zip_code: zip_code, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of Address to a JSON object
      #
      # @return [JSON]
      def to_json
        { "type": @type, "street_1": @street_1, "street_2": @street_2, "city": @city, "state": @state, "country_subdivision": @country_subdivision, "country": @country, "zip_code": @zip_code, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        obj.type.nil?() || Accounting::AddressType.validate_raw(obj: obj.type)
        ...
        obj.country.nil?() || Accounting::AddressCountry.validate_raw(obj: obj.country)
