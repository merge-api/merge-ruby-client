...
View what operations are supported for the `Candidate` endpoint.
    class ModelOperation
      attr_reader :model_name, :available_operations, :required_post_parameters, :supported_fields, :additional_properties
      ...
      # @return [Accounting::ModelOperation]
      def initialize(model_name:, available_operations:, required_post_parameters:, supported_fields:, additional_properties: nil)
        # @type [String] 
      ...
      def self.from_json(json_object:)
        ...
        new(model_name: model_name, available_operations: available_operations, required_post_parameters: required_post_parameters, supported_fields: supported_fields, additional_properties: struct)
      end
      # Serialize an instance of ModelOperation to a JSON object
      #
      # @return [JSON]
      def to_json
        { "model_name": @model_name, "available_operations": @available_operations, "required_post_parameters": @required_post_parameters, "supported_fields": @supported_fields }.to_json()
      end
