...
Fetch from the `LIST Contacts` endpoint and view a company's contacts.
    class Contact
      attr_reader :id, :remote_id, :name, :is_supplier, :is_customer, :email_address, :tax_number, :status, :currency, :remote_updated_at, :company, :addresses, :phone_numbers, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param status [Accounting::ContactStatus] The contact's status  - `ACTIVE` - ACTIVE
- `ARCHIVED` - ARCHIVED
