...
Fetch from the `GET JournalEntry` endpoint and view a company's journey entry.
    class JournalEntryRequest
      attr_reader :transaction_date, :payments, :memo, :currency, :exchange_rate, :company, :tracking_categories, :lines, :journal_number, :posting_status, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param currency [Accounting::JournalEntryRequestCurrency] The journal's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # @param posting_status [Accounting::JournalEntryRequestPostingStatus] The journal's posting status.  - `UNPOSTED` - UNPOSTED
- `POSTED` - POSTED
      ...
      def initialize(transaction_date: nil, payments: nil, memo: nil, currency: nil, exchange_rate: nil, company: nil, tracking_categories: nil, lines: nil, journal_number: nil, posting_status: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `POSTED` - POSTED
  ...
  Accounting::JournalLineRequest.from_json(json_object: v)
        ...
        new(transaction_date: transaction_date, payments: payments, memo: memo, currency: currency, exchange_rate: exchange_rate, company: company, tracking_categories: tracking_categories, lines: lines, journal_number: journal_number, posting_status: posting_status, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
