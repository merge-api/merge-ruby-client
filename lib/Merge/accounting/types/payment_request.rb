...
require_relative "payment_request_currency"
...
Fetch from the `GET Payment` endpoint and view an invoice's payment.
    class PaymentRequest
      attr_reader :transaction_date, :contact, :account, :currency, :exchange_rate, :company, :total_amount, :tracking_categories, :accounting_period, :applied_to_lines, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param currency [Accounting::PaymentRequestCurrency] The payment's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(transaction_date: nil, contact: nil, account: nil, currency: nil, exchange_rate: nil, company: nil, total_amount: nil, tracking_categories: nil, accounting_period: nil, applied_to_lines: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
        ...
        @account = account
        # @type [Accounting::PaymentRequestCurrency] The payment's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        currency = Accounting::PaymentRequestCurrency.from_json(json_object: currency)
  ...
  Accounting::PaymentRequestAppliedToLinesItem.from_json(json_object: v)
        ...
        new(transaction_date: transaction_date, contact: contact, account: account, currency: currency, exchange_rate: exchange_rate, company: company, total_amount: total_amount, tracking_categories: tracking_categories, accounting_period: accounting_period, applied_to_lines: applied_to_lines, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.currency.nil?() || Accounting::PaymentRequestCurrency.validate_raw(obj: obj.currency)
