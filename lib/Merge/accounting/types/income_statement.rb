...
require_relative "income_statement_currency"
...
Fetch from the `GET IncomeStatement` endpoint and view a company's income statement for a given period.
    class IncomeStatement
      attr_reader :id, :remote_id, :name, :currency, :company, :start_period, :end_period, :income, :cost_of_sales, :gross_profit, :operating_expenses, :net_operating_income, :non_operating_expenses, :net_income, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param name [String] The income statement's name.
      # @param currency [Accounting::IncomeStatementCurrency] The income statement's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(id: nil, remote_id: nil, name: nil, currency: nil, company: nil, start_period: nil, end_period: nil, income: nil, cost_of_sales: nil, gross_profit: nil, operating_expenses: nil, net_operating_income: nil, non_operating_expenses: nil, net_income: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        @name = name
        # @type [Accounting::IncomeStatementCurrency] The income statement's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        currency = Accounting::IncomeStatementCurrency.from_json(json_object: currency)
        ...
        income = struct.income.map() do | v |
  v = v.to_h.to_json()
  Accounting::ReportItem.from_json(json_object: v)
end
        cost_of_sales = struct.cost_of_sales.map() do | v |
  v = v.to_h.to_json()
  Accounting::ReportItem.from_json(json_object: v)
end
        gross_profit = struct.gross_profit
        operating_expenses = struct.operating_expenses.map() do | v |
  v = v.to_h.to_json()
  Accounting::ReportItem.from_json(json_object: v)
end
        net_operating_income = struct.net_operating_income
        non_operating_expenses = struct.non_operating_expenses.map() do | v |
  v = v.to_h.to_json()
  Accounting::ReportItem.from_json(json_object: v)
end
  ...
  Accounting::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, name: name, currency: currency, company: company, start_period: start_period, end_period: end_period, income: income, cost_of_sales: cost_of_sales, gross_profit: gross_profit, operating_expenses: operating_expenses, net_operating_income: net_operating_income, non_operating_expenses: non_operating_expenses, net_income: net_income, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.currency.nil?() || Accounting::IncomeStatementCurrency.validate_raw(obj: obj.currency)
