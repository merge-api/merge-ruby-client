...
Fetch from the `LIST Accounts` endpoint and view a company's accounts.
    class AccountRequest
      attr_reader :name, :description, :classification, :type, :status, :current_balance, :currency, :account_number, :parent_account, :company, :integration_params, :linked_account_params, :additional_properties
      # @param name [String] The account's name.
      # @param description [String] The account's description.
      # @param classification [Accounting::AccountRequestClassification] The account's broadest grouping.  - `ASSET` - ASSET
- `EQUITY` - EQUITY
- `EXPENSE` - EXPENSE
- `LIABILITY` - LIABILITY
- `REVENUE` - REVENUE
      # @param type [String] The account's type is a narrower and more specific grouping within the account's classification.
      # @param status [Accounting::AccountRequestStatus] The account's status.  - `ACTIVE` - ACTIVE
- `PENDING` - PENDING
- `INACTIVE` - INACTIVE
      # @param current_balance [Float] The account's current balance.
      # @param currency [Accounting::AccountRequestCurrency] The account's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(name: nil, description: nil, classification: nil, type: nil, status: nil, current_balance: nil, currency: nil, account_number: nil, parent_account: nil, company: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        new(name: name, description: description, classification: classification, type: type, status: status, current_balance: current_balance, currency: currency, account_number: account_number, parent_account: parent_account, company: company, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
