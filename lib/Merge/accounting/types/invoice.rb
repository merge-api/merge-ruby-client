...
- `ACCOUNTS_PAYABLE` - ACCOUNTS_PAYABLE
      ...
      # @param currency [Accounting::InvoiceCurrency] The invoice's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # @param status [Accounting::InvoiceStatus] The status of the invoice.  - `PAID` - PAID
- `DRAFT` - DRAFT
- `SUBMITTED` - SUBMITTED
...
- `VOID` - VOID
      ...
      def initialize(id: nil, type: nil, contact: nil, number: nil, issue_date: nil, due_date: nil, paid_on_date: nil, memo: nil, company: nil, currency: nil, exchange_rate: nil, total_discount: nil, sub_total: nil, status: nil, total_tax_amount: nil, total_amount: nil, balance: nil, remote_updated_at: nil, tracking_categories: nil, payments: nil, applied_payments: nil, line_items: nil, remote_was_deleted: nil, accounting_period: nil, purchase_orders: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        # @type [Accounting::InvoiceType] Whether the invoice is an accounts receivable or accounts payable. If `type` is `accounts_payable`, the invoice is a bill. If `type` is `accounts_receivable`, it is an invoice. 
...
- `ACCOUNTS_PAYABLE` - ACCOUNTS_PAYABLE
        ...
        @company = company
        # @type [Accounting::InvoiceCurrency] The invoice's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
        ...
        @sub_total = sub_total
        # @type [Accounting::InvoiceStatus] The status of the invoice. 
- `PAID` - PAID
- `DRAFT` - DRAFT
- `SUBMITTED` - SUBMITTED
- `PARTIALLY_PAID` - PARTIALLY_PAID
...
- `VOID` - VOID
      ...
      def self.from_json(json_object:)
        ...
        type = Accounting::InvoiceType.from_json(json_object: type)
        ...
        currency = Accounting::InvoiceCurrency.from_json(json_object: currency)
        ...
        status = Accounting::InvoiceStatus.from_json(json_object: status)
  ...
  Accounting::InvoicePaymentsItem.from_json(json_object: v)
        ...
        applied_payments = struct.applied_payments.map() do | v |
  v = v.to_h.to_json()
  ...
  Accounting::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.type.nil?() || Accounting::InvoiceType.validate_raw(obj: obj.type)
        ...
        obj.currency.nil?() || Accounting::InvoiceCurrency.validate_raw(obj: obj.currency)
        ...
        obj.status.nil?() || Accounting::InvoiceStatus.validate_raw(obj: obj.status)
