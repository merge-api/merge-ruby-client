...
require_relative "purchase_order_line_item_currency"
require "date"
require "date"
require "json"
...
Fetch from the `GET PurchaseOrder` endpoint and view a company's purchase orders.
    class PurchaseOrderLineItem
      attr_reader :remote_id, :description, :unit_price, :quantity, :item, :account, :tracking_category, :tracking_categories, :tax_amount, :total_line_amount, :currency, :exchange_rate, :company, :remote_was_deleted, :id, :created_at, :modified_at, :additional_properties
      ...
      # @param currency [Accounting::PurchaseOrderLineItemCurrency] The purchase order line item's currency.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(remote_id: nil, description: nil, unit_price: nil, quantity: nil, item: nil, account: nil, tracking_category: nil, tracking_categories:, tax_amount: nil, total_line_amount: nil, currency: nil, exchange_rate: nil, company: nil, remote_was_deleted: nil, id: nil, created_at: nil, modified_at: nil, additional_properties: nil)
        ...
        # @type [Accounting::PurchaseOrderLineItemCurrency] The purchase order line item's currency. 
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def self.from_json(json_object:)
        ...
        currency = Accounting::PurchaseOrderLineItemCurrency.from_json(json_object: currency)
      ...
      # @return [JSON]
      def to_json
        { "remote_id": @remote_id, "description": @description, "unit_price": @unit_price, "quantity": @quantity, "item": @item, "account": @account, "tracking_category": @tracking_category, "tracking_categories": @tracking_categories, "tax_amount": @tax_amount, "total_line_amount": @total_line_amount, "currency": @currency, "exchange_rate": @exchange_rate, "company": @company, "remote_was_deleted": @remote_was_deleted, "id": @id, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.currency.nil?() || Accounting::PurchaseOrderLineItemCurrency.validate_raw(obj: obj.currency)
