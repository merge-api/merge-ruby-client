...
Fetch from the `GET CompanyInfo` endpoint and view a company's information.
    class CompanyInfo
      attr_reader :id, :remote_id, :name, :legal_name, :tax_number, :fiscal_year_end_month, :fiscal_year_end_day, :currency, :remote_created_at, :urls, :addresses, :phone_numbers, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param currency [Accounting::CompanyInfoCurrency] The currency set in the company's accounting platform.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      def initialize(id: nil, remote_id: nil, name: nil, legal_name: nil, tax_number: nil, fiscal_year_end_month: nil, fiscal_year_end_day: nil, currency: nil, remote_created_at: nil, urls: nil, addresses: nil, phone_numbers: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
