...
module Merge
  module Accounting
    class ConditionSchema
      ...
      # @param condition_type [Accounting::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.  - `BOOLEAN` - BOOLEAN
      `DATE`
      `DATE_TIME`
      `INTEGER`
      `FLOAT`
      `STRING`
      `LIST_OF_STRINGS`
      # @param operators [Array<Accounting::OperatorSchema>] The schemas for the operators that can be used on a condition.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Accounting::ConditionSchema]
      def initialize(id:, condition_type:, operators:, common_model: nil, native_name: nil, field_name: nil,
        ...
        @is_unique = is_unique
        # @type [Accounting::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.
        `BOOLEAN`
        `DATE`
        `DATE_TIME`
        `INTEGER`
        ...
        # @type [Array<Accounting::OperatorSchema>] The schemas for the operators that can be used on a condition.
        @operators = operators
      ...
      def self.from_json(json_object:)
        ...
        condition_type = Accounting::ConditionSchemaConditionType.from_json(json_object: condition_type)
        operators = struct.operators.map do |v|
          v = v.to_h.to_json
          Accounting::OperatorSchema.from_json(json_object: v)
        end
      ...
      def self.validate_raw(obj:)
        ...
        Accounting::ConditionSchemaConditionType.validate_raw(obj: obj.condition_type)
