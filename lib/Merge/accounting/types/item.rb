...
Fetch from the `LIST Items` endpoint and view a company's items.
    class Item
      attr_reader :id, :remote_id, :name, :status, :unit_price, :purchase_price, :purchase_account, :sales_account, :company, :remote_updated_at, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param name [String] The item's name.
      # @param status [Accounting::ItemStatus] The item's status.  - `ACTIVE` - ACTIVE
- `ARCHIVED` - ARCHIVED
      ...
      def initialize(id: nil, remote_id: nil, name: nil, status: nil, unit_price: nil, purchase_price: nil, purchase_account: nil, sales_account: nil, company: nil, remote_updated_at: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `ARCHIVED` - ARCHIVED
      ...
      def self.from_json(json_object:)
        ...
        purchase_account = struct.purchase_account.to_h.to_json()
        purchase_account = Accounting::ItemPurchaseAccount.from_json(json_object: purchase_account)
        sales_account = struct.sales_account.to_h.to_json()
  ...
  Accounting::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, name: name, status: status, unit_price: unit_price, purchase_price: purchase_price, purchase_account: purchase_account, sales_account: sales_account, company: company, remote_updated_at: remote_updated_at, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
