...
module Merge
  module Accounting
    class Issue
      ...
      # @param id [String]
      # @param status [Accounting::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')  - `ONGOING` - ONGOING
      `RESOLVED`
      ...
      def initialize(error_description:, id: nil, status: nil, end_user: nil, first_incident_time: nil,
        ...
        # @type [String]
        @id = id
        # @type [Accounting::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
        `ONGOING`
        `RESOLVED`
        @status = status
        # @type [String]
      ...
      def self.from_json(json_object:)
        ...
        status = Accounting::IssueStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Accounting::IssueStatus.validate_raw(obj: obj.status)
