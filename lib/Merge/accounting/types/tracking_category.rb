...
require_relative "tracking_category_status"
require_relative "tracking_category_category_type"
...
Fetch from the `GET TrackingCategory` endpoint and view a company's tracking category.
    class TrackingCategory
      attr_reader :name, :status, :category_type, :parent_category, :company, :remote_was_deleted, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param name [String] The tracking category's name.
      # @param status [Accounting::TrackingCategoryStatus] The tracking category's status.  - `ACTIVE` - ACTIVE
- `ARCHIVED` - ARCHIVED
      # @param category_type [Accounting::TrackingCategoryCategoryType] The tracking category’s type.  - `CLASS` - CLASS
- `DEPARTMENT` - DEPARTMENT
      ...
      def initialize(name: nil, status: nil, category_type: nil, parent_category: nil, company: nil, remote_was_deleted: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] The tracking category's name.
        @name = name
        # @type [Accounting::TrackingCategoryStatus] The tracking category's status. 
- `ACTIVE` - ACTIVE
- `ARCHIVED` - ARCHIVED
        @status = status
        # @type [Accounting::TrackingCategoryCategoryType] The tracking category’s type. 
- `CLASS` - CLASS
- `DEPARTMENT` - DEPARTMENT
      ...
      def self.from_json(json_object:)
        ...
        status = Accounting::TrackingCategoryStatus.from_json(json_object: status)
        category_type = struct.category_type.to_h.to_json()
        category_type = Accounting::TrackingCategoryCategoryType.from_json(json_object: category_type)
  ...
  Accounting::RemoteData.from_json(json_object: v)
        ...
        new(name: name, status: status, category_type: category_type, parent_category: parent_category, company: company, remote_was_deleted: remote_was_deleted, id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of TrackingCategory to a JSON object
      #
      # @return [JSON]
      def to_json
        { "name": @name, "status": @status, "category_type": @category_type, "parent_category": @parent_category, "company": @company, "remote_was_deleted": @remote_was_deleted, "id": @id, "remote_id": @remote_id, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil?() || Accounting::TrackingCategoryStatus.validate_raw(obj: obj.status)
        obj.category_type.nil?() || Accounting::TrackingCategoryCategoryType.validate_raw(obj: obj.category_type)
