...
module Merge
  module Ats
    class Issue
      ...
      # @param id [String]
      # @param status [Ats::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')  - `ONGOING` - ONGOING
      `RESOLVED`
      ...
      def initialize(error_description:, id: nil, status: nil, end_user: nil, first_incident_time: nil,
        ...
        # @type [String]
        @id = id
        # @type [Ats::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
        `ONGOING`
        `RESOLVED`
        @status = status
        # @type [String]
      ...
      def self.from_json(json_object:)
        ...
        status = Ats::IssueStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Ats::IssueStatus.validate_raw(obj: obj.status)
