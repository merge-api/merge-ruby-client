...
require "date"
require_relative "activity_activity_type"
require_relative "activity_visibility"
require "date"
require "date"
...
Fetch from the `LIST Activities` endpoint and filter by `ID` to show all activities.
    class Activity
      attr_reader :id, :remote_id, :user, :remote_created_at, :activity_type, :subject, :body, :visibility, :candidate, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param activity_type [Ats::ActivityActivityType] The activity's type.  - `NOTE` - NOTE
- `EMAIL` - EMAIL
- `OTHER` - OTHER
      # @param subject [String] The activity's subject.
      # @param body [String] The activity's body.
      # @param visibility [Ats::ActivityVisibility] The activity's visibility.  - `ADMIN_ONLY` - ADMIN_ONLY
- `PUBLIC` - PUBLIC
- `PRIVATE` - PRIVATE
      ...
      # @return [Ats::Activity]
      def initialize(id: nil, remote_id: nil, user: nil, remote_created_at: nil, activity_type: nil, subject: nil, body: nil, visibility: nil, candidate: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        # @type [Ats::ActivityActivityType] The activity's type. 
- `NOTE` - NOTE
- `EMAIL` - EMAIL
- `OTHER` - OTHER
        ...
        @body = body
        # @type [Ats::ActivityVisibility] The activity's visibility. 
...
- `PRIVATE` - PRIVATE
      ...
      def self.from_json(json_object:)
        ...
        activity_type = Ats::ActivityActivityType.from_json(json_object: activity_type)
        subject = struct.subject
        body = struct.body
        visibility = struct.visibility.to_h.to_json()
        visibility = Ats::ActivityVisibility.from_json(json_object: visibility)
  ...
  Ats::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.activity_type.nil?() || Ats::ActivityActivityType.validate_raw(obj: obj.activity_type)
        ...
        obj.visibility.nil?() || Ats::ActivityVisibility.validate_raw(obj: obj.visibility)
