...
Fetch from the `LIST Candidates` endpoint and filter by `ID` to show all candidates.
    class CandidateRequest
      attr_reader :first_name, :last_name, :company, :title, :last_interaction_at, :is_private, :can_email, :locations, :phone_numbers, :email_addresses, :urls, :tags, :applications, :attachments, :remote_template_id, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param applications [Array<Ats::CandidateRequestApplicationsItem>] Array of `Application` object IDs.
      # @param attachments [Array<Ats::CandidateRequestAttachmentsItem>] Array of `Attachment` object IDs.
      ...
      # @return [Ats::CandidateRequest]
      def initialize(first_name: nil, last_name: nil, company: nil, title: nil, last_interaction_at: nil, is_private: nil, can_email: nil, locations: nil, phone_numbers: nil, email_addresses: nil, urls: nil, tags: nil, applications: nil, attachments: nil, remote_template_id: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
        ...
        @tags = tags
        # @type [Array<Ats::CandidateRequestApplicationsItem>] Array of `Application` object IDs.
        @applications = applications
        # @type [Array<Ats::CandidateRequestAttachmentsItem>] Array of `Attachment` object IDs.
      ...
      def self.from_json(json_object:)
        ...
        title = struct.title
        last_interaction_at = DateTime.parse(struct.last_interaction_at)
  ...
  Ats::EmailAddressRequest.from_json(json_object: v)
        ...
        urls = struct.urls.map() do | v |
  v = v.to_h.to_json()
  Ats::UrlRequest.from_json(json_object: v)
end
        tags = struct.tags
        applications = struct.applications.map() do | v |
  v = v.to_h.to_json()
  Ats::CandidateRequestApplicationsItem.from_json(json_object: v)
end
        attachments = struct.attachments.map() do | v |
  v = v.to_h.to_json()
  Ats::CandidateRequestAttachmentsItem.from_json(json_object: v)
end
        remote_template_id = struct.remote_template_id
        integration_params = struct.integration_params
        linked_account_params = struct.linked_account_params
        new(first_name: first_name, last_name: last_name, company: company, title: title, last_interaction_at: last_interaction_at, is_private: is_private, can_email: can_email, locations: locations, phone_numbers: phone_numbers, email_addresses: email_addresses, urls: urls, tags: tags, applications: applications, attachments: attachments, remote_template_id: remote_template_id, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
