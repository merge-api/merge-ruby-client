...
module Merge
  module Ats
    class MetaResponse
      ...
      # @param status [Ats::LinkedAccountStatus]
      ...
      def self.from_json(json_object:)
        ...
        status = Ats::LinkedAccountStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Ats::LinkedAccountStatus.validate_raw(obj: obj.status)
