...
Fetch from the `LIST Activities` endpoint and filter by `ID` to show all activities.
    class ActivityRequest
      attr_reader :user, :activity_type, :subject, :body, :visibility, :candidate, :integration_params, :linked_account_params, :additional_properties
      # @param user [Ats::ActivityRequestUser] The user that performed the action.
      # @param activity_type [Ats::ActivityRequestActivityType] The activity's type.  - `NOTE` - NOTE
- `EMAIL` - EMAIL
- `OTHER` - OTHER
      # @param subject [String] The activity's subject.
      # @param body [String] The activity's body.
      # @param visibility [Ats::ActivityRequestVisibility] The activity's visibility.  - `ADMIN_ONLY` - ADMIN_ONLY
- `PUBLIC` - PUBLIC
- `PRIVATE` - PRIVATE
      ...
      def initialize(user: nil, activity_type: nil, subject: nil, body: nil, visibility: nil, candidate: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `PRIVATE` - PRIVATE
      ...
      def self.from_json(json_object:)
        ...
        new(user: user, activity_type: activity_type, subject: subject, body: body, visibility: visibility, candidate: candidate, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of ActivityRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "user": @user, "activity_type": @activity_type, "subject": @subject, "body": @body, "visibility": @visibility, "candidate": @candidate, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
