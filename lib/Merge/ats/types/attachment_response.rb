...
module Merge
  module Ats
    class AttachmentResponse
      ...
      # Deserialize a JSON object to an instance of AttachmentResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        model = Ats::Attachment.from_json(json_object: model)
      ...
      # Serialize an instance of AttachmentResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
      ...
      def self.validate_raw(obj:)
        Ats::Attachment.validate_raw(obj: obj.model)
