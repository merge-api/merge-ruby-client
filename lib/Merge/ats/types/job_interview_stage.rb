...
Fetch from the `LIST JobInterviewStages` endpoint and view the job interview stages used by a company.
    class JobInterviewStage
      attr_reader :id, :remote_id, :name, :job, :stage_order, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      def initialize(id: nil, remote_id: nil, name: nil, job: nil, stage_order: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
  ...
  Ats::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, name: name, job: job, stage_order: stage_order, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of JobInterviewStage to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "name": @name, "job": @job, "stage_order": @stage_order, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
