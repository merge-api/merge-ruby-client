...
Fetch from the `LIST RemoteUsers` endpoint to show all users for a third party.
    class RemoteUser
      attr_reader :id, :remote_id, :first_name, :last_name, :email, :disabled, :remote_created_at, :access_role, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param access_role [Ats::RemoteUserAccessRole] The user's role.  - `SUPER_ADMIN` - SUPER_ADMIN
- `ADMIN` - ADMIN
...
- `INTERVIEWER` - INTERVIEWER
      ...
      def initialize(id: nil, remote_id: nil, first_name: nil, last_name: nil, email: nil, disabled: nil, remote_created_at: nil, access_role: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `INTERVIEWER` - INTERVIEWER
      ...
      def self.from_json(json_object:)
        ...
        access_role = struct.access_role.to_h.to_json()
  ...
  Ats::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, first_name: first_name, last_name: last_name, email: email, disabled: disabled, remote_created_at: remote_created_at, access_role: access_role, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
