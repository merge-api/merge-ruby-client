...
require_relative "scheduled_interview"
...
module Merge
  module Ats
    class ScheduledInterviewResponse
      ...
      # @param model [Ats::ScheduledInterview]
      # @param warnings [Array<Ats::WarningValidationProblem>]
      # @param errors [Array<Ats::ErrorValidationProblem>]
      # @param logs [Array<Ats::DebugModeLog>]
      ...
      def initialize(model:, warnings:, errors:, logs: nil, additional_properties: nil)
        # @type [Ats::ScheduledInterview]
        @model = model
        # @type [Array<Ats::WarningValidationProblem>]
        @warnings = warnings
        # @type [Array<Ats::ErrorValidationProblem>]
        @errors = errors
        # @type [Array<Ats::DebugModeLog>]
        @logs = logs
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of ScheduledInterviewResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        model = Ats::ScheduledInterview.from_json(json_object: model)
        warnings = struct.warnings.map do |v|
          v = v.to_h.to_json
          Ats::WarningValidationProblem.from_json(json_object: v)
        end
        errors = struct.errors.map do |v|
          v = v.to_h.to_json
          Ats::ErrorValidationProblem.from_json(json_object: v)
        end
        logs = struct.logs.map do |v|
          v = v.to_h.to_json
          Ats::DebugModeLog.from_json(json_object: v)
        end
        new(model: model, warnings: warnings, errors: errors, logs: logs, additional_properties: struct)
      end

      # Serialize an instance of ScheduledInterviewResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
      ...
      def self.validate_raw(obj:)
        Ats::ScheduledInterview.validate_raw(obj: obj.model)
