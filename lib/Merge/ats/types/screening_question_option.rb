...
TODO
    class ScreeningQuestionOption
      ...
      def self.from_json(json_object:)
        ...
        new(remote_id: remote_id, label: label, id: id, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of ScreeningQuestionOption to a JSON object
      #
      # @return [JSON]
      def to_json
        { "remote_id": @remote_id, "label": @label, "id": @id, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
