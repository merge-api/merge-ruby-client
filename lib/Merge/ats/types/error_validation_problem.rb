  ...
  module Ats
    class ErrorValidationProblem
      ...
      def self.from_json(json_object:)
        ...
        source = Ats::ValidationProblemSource.from_json(json_object: source)
        title = struct.title
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Ats::ValidationProblemSource.validate_raw(obj: obj.source)
