...
Fetch from the `GET Candidate` endpoint and view their email addresses.
    class EmailAddressRequest
      ...
      # @param email_address_type [Ats::EmailAddressRequestEmailAddressType] The type of email address.  - `PERSONAL` - PERSONAL
- `WORK` - WORK
- `OTHER` - OTHER
      ...
      def initialize(value: nil, email_address_type: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `OTHER` - OTHER
      ...
      def self.from_json(json_object:)
        ...
        new(value: value, email_address_type: email_address_type, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of EmailAddressRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "value": @value, "email_address_type": @email_address_type, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
