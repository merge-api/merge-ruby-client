...
Fetch from the `LIST Applications` endpoint and filter by `ID` to show all applications.
    class Application
      attr_reader :id, :remote_id, :candidate, :job, :applied_at, :rejected_at, :source, :credited_to, :current_stage, :reject_reason, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      def initialize(id: nil, remote_id: nil, candidate: nil, job: nil, applied_at: nil, rejected_at: nil, source: nil, credited_to: nil, current_stage: nil, reject_reason: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
  ...
  Ats::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, candidate: candidate, job: job, applied_at: applied_at, rejected_at: rejected_at, source: source, credited_to: credited_to, current_stage: current_stage, reject_reason: reject_reason, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
