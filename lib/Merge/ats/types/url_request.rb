...
Fetch from the `GET Candidate` endpoint and view their website urls.
    class UrlRequest
      ...
      # @param url_type [Ats::UrlRequestUrlType] The type of site.  - `PERSONAL` - PERSONAL
- `COMPANY` - COMPANY
- `PORTFOLIO` - PORTFOLIO
- `BLOG` - BLOG
...
- `JOB_POSTING` - JOB_POSTING
      ...
      def initialize(value: nil, url_type: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `JOB_POSTING` - JOB_POSTING
      ...
      def self.from_json(json_object:)
        ...
        new(value: value, url_type: url_type, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of UrlRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "value": @value, "url_type": @url_type, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
