...
module Merge
  module Ats
    class ActivityResponse
      ...
      # Deserialize a JSON object to an instance of ActivityResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        model = Ats::Activity.from_json(json_object: model)
      ...
      # Serialize an instance of ActivityResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
      ...
      def self.validate_raw(obj:)
        Ats::Activity.validate_raw(obj: obj.model)
