...
Fetch from the `LIST Offers` endpoint and filter by `ID` to show all offers.
    class Offer
      attr_reader :id, :remote_id, :application, :creator, :remote_created_at, :closed_at, :sent_at, :start_date, :status, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param status [Ats::OfferStatus] The offer's status.  - `DRAFT` - DRAFT
...
- `DEPRECATED` - DEPRECATED
      ...
      # @return [Ats::Offer]
      def initialize(id: nil, remote_id: nil, application: nil, creator: nil, remote_created_at: nil, closed_at: nil, sent_at: nil, start_date: nil, status: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `DEPRECATED` - DEPRECATED
      ...
      def self.from_json(json_object:)
        ...
        closed_at = DateTime.parse(struct.closed_at)
        sent_at = DateTime.parse(struct.sent_at)
  ...
  Ats::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, application: application, creator: creator, remote_created_at: remote_created_at, closed_at: closed_at, sent_at: sent_at, start_date: start_date, status: status, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
