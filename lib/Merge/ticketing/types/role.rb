...
TODO
    class Role
      attr_reader :id, :remote_id, :name, :ticket_actions, :ticket_access, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param ticket_access [Ticketing::RoleTicketAccess] The level of Ticket access that a User with this Role can perform.  - `ALL` - ALL
...
- `TEAM_ONLY` - TEAM_ONLY
      ...
      def initialize(id: nil, remote_id: nil, name: nil, ticket_actions: nil, ticket_access: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `TEAM_ONLY` - TEAM_ONLY
      ...
      def self.from_json(json_object:)
        ...
        name = struct.name
        ticket_actions = struct.ticket_actions.map() do | v |
  v = v.to_h.to_json()
  Ticketing::RoleTicketActionsItem.from_json(json_object: v)
end
        ticket_access = struct.ticket_access.to_h.to_json()
  ...
  Ticketing::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, name: name, ticket_actions: ticket_actions, ticket_access: ticket_access, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Role to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "name": @name, "ticket_actions": @ticket_actions, "ticket_access": @ticket_access, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
