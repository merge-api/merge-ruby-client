...
TODO
    class AttachmentRequest
      attr_reader :file_name, :ticket, :file_url, :content_type, :uploaded_by, :integration_params, :linked_account_params, :additional_properties
      ...
      def initialize(file_name: nil, ticket: nil, file_url: nil, content_type: nil, uploaded_by: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(file_name: file_name, ticket: ticket, file_url: file_url, content_type: content_type, uploaded_by: uploaded_by, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of AttachmentRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "file_name": @file_name, "ticket": @ticket, "file_url": @file_url, "content_type": @content_type, "uploaded_by": @uploaded_by, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
