...
TODO
    class Account
      attr_reader :id, :remote_id, :name, :domains, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @return [Ticketing::Account]
      def initialize(id: nil, remote_id: nil, name: nil, domains: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        @name = name
        # @type [Array<String>] The account's domain names.
        @domains = domains
  ...
  Ticketing::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, name: name, domains: domains, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Account to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "name": @name, "domains": @domains, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
