...
module Merge
  module Ticketing
    class RemoteFieldClass
      ...
      # @param field_type [Ticketing::RemoteFieldClassFieldType]
      # @param field_format [Ticketing::RemoteFieldClassFieldFormat]
      ...
      def initialize(id: nil, display_name: nil, remote_key_name: nil, description: nil, is_custom: nil,
        ...
        # @type [Ticketing::RemoteFieldClassFieldType]
        @field_type = field_type
        # @type [Ticketing::RemoteFieldClassFieldFormat]
      ...
      def self.from_json(json_object:)
        ...
        field_type = Ticketing::RemoteFieldClassFieldType.from_json(json_object: field_type)
        field_format = struct.field_format.to_h.to_json
        field_format = Ticketing::RemoteFieldClassFieldFormat.from_json(json_object: field_format)
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_type.nil? || Ticketing::RemoteFieldClassFieldType.validate_raw(obj: obj.field_type)
        obj.field_format.nil? || Ticketing::RemoteFieldClassFieldFormat.validate_raw(obj: obj.field_format)
