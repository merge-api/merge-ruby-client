...
require "date"
require "date"
require_relative "ticket_priority"
require "date"
require "date"
...
TODO
    class Ticket
      attr_reader :id, :remote_id, :name, :assignees, :creator, :due_date, :status, :description, :collections, :ticket_type, :account, :contact, :parent_ticket, :attachments, :tags, :remote_created_at, :remote_updated_at, :completed_at, :remote_was_deleted, :ticket_url, :priority, :created_at, :modified_at, :field_mappings, :remote_data, :remote_fields, :additional_properties
      # @param id [String] 
      ...
      # @param status [Ticketing::TicketStatus] The current status of the ticket.  - `OPEN` - OPEN
- `CLOSED` - CLOSED
...
- `ON_HOLD` - ON_HOLD
      ...
      # @param priority [Ticketing::TicketPriority] The priority or urgency of the Ticket.  - `URGENT` - URGENT
- `HIGH` - HIGH
- `NORMAL` - NORMAL
- `LOW` - LOW
      ...
      def initialize(id: nil, remote_id: nil, name: nil, assignees: nil, creator: nil, due_date: nil, status: nil, description: nil, collections: nil, ticket_type: nil, account: nil, contact: nil, parent_ticket: nil, attachments: nil, tags: nil, remote_created_at: nil, remote_updated_at: nil, completed_at: nil, remote_was_deleted: nil, ticket_url: nil, priority: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, remote_fields: nil, additional_properties: nil)
        ...
        @due_date = due_date
        # @type [Ticketing::TicketStatus] The current status of the ticket. 
- `OPEN` - OPEN
- `CLOSED` - CLOSED
- `IN_PROGRESS` - IN_PROGRESS
- `ON_HOLD` - ON_HOLD
        ...
        # @type [Ticketing::TicketPriority] The priority or urgency of the Ticket. 
- `URGENT` - URGENT
- `HIGH` - HIGH
- `NORMAL` - NORMAL
- `LOW` - LOW
  ...
  Ticketing::TicketAssigneesItem.from_json(json_object: v)
        ...
        status = Ticketing::TicketStatus.from_json(json_object: status)
  ...
  Ticketing::TicketAttachmentsItem.from_json(json_object: v)
        ...
        priority = Ticketing::TicketPriority.from_json(json_object: priority)
  ...
  Ticketing::RemoteField.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil?() || Ticketing::TicketStatus.validate_raw(obj: obj.status)
        ...
        obj.priority.nil?() || Ticketing::TicketPriority.validate_raw(obj: obj.priority)
