...
TODO
    class CommentRequest
      attr_reader :user, :contact, :body, :html_body, :ticket, :is_private, :integration_params, :linked_account_params, :additional_properties
      ...
      def initialize(user: nil, contact: nil, body: nil, html_body: nil, ticket: nil, is_private: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(user: user, contact: contact, body: body, html_body: html_body, ticket: ticket, is_private: is_private, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of CommentRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "user": @user, "contact": @contact, "body": @body, "html_body": @html_body, "ticket": @ticket, "is_private": @is_private, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
