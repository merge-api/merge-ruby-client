...
module Merge
  module Ticketing
    class Issue
      ...
      # @param id [String]
      # @param status [Ticketing::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')  - `ONGOING` - ONGOING
      `RESOLVED`
      ...
      def initialize(error_description:, id: nil, status: nil, end_user: nil, first_incident_time: nil,
        ...
        # @type [String]
        @id = id
        # @type [Ticketing::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
        `ONGOING`
        `RESOLVED`
        @status = status
        # @type [String]
      ...
      def self.from_json(json_object:)
        ...
        status = Ticketing::IssueStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Ticketing::IssueStatus.validate_raw(obj: obj.status)
