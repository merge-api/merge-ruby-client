...
module Merge
  module Ticketing
    class AuditLogEvent
      ...
      # @param role [Ticketing::AuditLogEventRole] Designates the role of the user (or SYSTEM/API if action not taken by a user) at the time of this Event occurring.  - `ADMIN` - ADMIN
      `DEVELOPER`
      `MEMBER`
      `API`
      `SYSTEM`
      ...
      # @param event_type [Ticketing::AuditLogEventEventType] Designates the type of event that occurred.  - `CREATED_REMOTE_PRODUCTION_API_KEY` - CREATED_REMOTE_PRODUCTION_API_KEY
      ...
      # @return [Ticketing::AuditLogEvent]
      def initialize(role:, ip_address:, event_type:, event_description:, id: nil, user_name: nil, user_email: nil,
        ...
        # @type [Ticketing::AuditLogEventRole] Designates the role of the user (or SYSTEM/API if action not taken by a user) at the time of this Event occurring.
        `ADMIN`
        `DEVELOPER`
        `MEMBER`
        `API`
        ...
        # @type [Ticketing::AuditLogEventEventType] Designates the type of event that occurred.
      ...
      def self.from_json(json_object:)
        ...
        role = Ticketing::AuditLogEventRole.from_json(json_object: role)
        ip_address = struct.ip_address
        event_type = struct.event_type.to_h.to_json
        event_type = Ticketing::AuditLogEventEventType.from_json(json_object: event_type)
