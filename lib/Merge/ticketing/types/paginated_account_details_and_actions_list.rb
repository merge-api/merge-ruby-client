...
module Merge
  module Ticketing
    class PaginatedAccountDetailsAndActionsList
      ...
      # @param results [Array<Ticketing::AccountDetailsAndActions>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ticketing::PaginatedAccountDetailsAndActionsList]
      def initialize(next_: nil, previous: nil, results: nil, additional_properties: nil)
        # @type [String]
        @next_ = next_
        # @type [String]
        @previous = previous
        # @type [Array<Ticketing::AccountDetailsAndActions>]
        @results = results
      ...
      def self.from_json(json_object:)
        ...
        results = struct.results.map do |v|
          v = v.to_h.to_json
          Ticketing::AccountDetailsAndActions.from_json(json_object: v)
        end
