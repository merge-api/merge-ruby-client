...
TODO
    class Contact
      attr_reader :id, :remote_id, :name, :email_address, :phone_number, :details, :account, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param account [Ticketing::ContactAccount] The contact's account.
      ...
      def initialize(id: nil, remote_id: nil, name: nil, email_address: nil, phone_number: nil, details: nil, account: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        # @type [String] The contact's phone number.
        @phone_number = phone_number
        # @type [String] The contact's details.
        @details = details
        # @type [Ticketing::ContactAccount] The contact's account.
        @account = account
      ...
      def self.from_json(json_object:)
        ...
        account = Ticketing::ContactAccount.from_json(json_object: account)
  ...
  Ticketing::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, name: name, email_address: email_address, phone_number: phone_number, details: details, account: account, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Contact to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "name": @name, "email_address": @email_address, "phone_number": @phone_number, "details": @details, "account": @account, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.account.nil?() || Ticketing::ContactAccount.validate_raw(obj: obj.account)
