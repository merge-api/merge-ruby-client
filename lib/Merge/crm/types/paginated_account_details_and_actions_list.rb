...
module Merge
  module Crm
    class PaginatedAccountDetailsAndActionsList
      ...
      # @param results [Array<Crm::AccountDetailsAndActions>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Crm::PaginatedAccountDetailsAndActionsList]
      def initialize(next_: nil, previous: nil, results: nil, additional_properties: nil)
        # @type [String]
        @next_ = next_
        # @type [String]
        @previous = previous
        # @type [Array<Crm::AccountDetailsAndActions>]
        @results = results
      ...
      def self.from_json(json_object:)
        ...
        results = struct.results.map do |v|
          v = v.to_h.to_json
          Crm::AccountDetailsAndActions.from_json(json_object: v)
        end
