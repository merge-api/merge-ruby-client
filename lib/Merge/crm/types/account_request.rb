...
TODO
    class AccountRequest
      attr_reader :owner, :name, :description, :industry, :website, :number_of_employees, :last_activity_at, :integration_params, :linked_account_params, :remote_fields, :additional_properties
      # @param owner [Crm::AccountRequestOwner] The account's owner.
      ...
      # @return [Crm::AccountRequest]
      def initialize(owner: nil, name: nil, description: nil, industry: nil, website: nil, number_of_employees: nil, last_activity_at: nil, integration_params: nil, linked_account_params: nil, remote_fields: nil, additional_properties: nil)
        # @type [Crm::AccountRequestOwner] The account's owner.
        @owner = owner
      ...
      def self.from_json(json_object:)
        ...
        owner = Crm::AccountRequestOwner.from_json(json_object: owner)
        name = struct.name
  ...
  Crm::RemoteFieldRequest.from_json(json_object: v)
        ...
        new(owner: owner, name: name, description: description, industry: industry, website: website, number_of_employees: number_of_employees, last_activity_at: last_activity_at, integration_params: integration_params, linked_account_params: linked_account_params, remote_fields: remote_fields, additional_properties: struct)
      end
      # Serialize an instance of AccountRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "owner": @owner, "name": @name, "description": @description, "industry": @industry, "website": @website, "number_of_employees": @number_of_employees, "last_activity_at": @last_activity_at, "integration_params": @integration_params, "linked_account_params": @linked_account_params, "remote_fields": @remote_fields }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        obj.owner.nil?() || Crm::AccountRequestOwner.validate_raw(obj: obj.owner)
