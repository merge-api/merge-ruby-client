...
require "date"
require "date"
require_relative "patched_task_request_status"
...
TODO
    class PatchedTaskRequest
      ...
      # @param status [Crm::PatchedTaskRequestStatus] The task's status.  - `OPEN` - OPEN
- `CLOSED` - CLOSED
      ...
      def initialize(subject: nil, content: nil, owner: nil, account: nil, opportunity: nil, completed_date: nil, due_date: nil, status: nil, integration_params: nil, linked_account_params: nil, remote_fields: nil, additional_properties: nil)
        ...
        @due_date = due_date
        # @type [Crm::PatchedTaskRequestStatus] The task's status. 
- `OPEN` - OPEN
- `CLOSED` - CLOSED
        @status = status
      ...
      def self.from_json(json_object:)
        ...
        status = Crm::PatchedTaskRequestStatus.from_json(json_object: status)
  ...
  Crm::RemoteFieldRequest.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil?() || Crm::PatchedTaskRequestStatus.validate_raw(obj: obj.status)
