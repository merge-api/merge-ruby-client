...
module Merge
  module Crm
    class ObjectClassDescriptionRequest
      ...
      # @param id [String]
      # @param origin_type [Hash{String => String}]
      ...
      def self.from_json(json_object:)
        ...
        id = struct.id
        origin_type = ORIGIN_TYPE_ENUM.key(struct.origin_type)
      ...
      # @return [JSON]
      def to_json(*_args)
        { "id": @id, "origin_type": @origin_type }.to_json
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.origin_type.is_a?(ORIGIN_TYPE_ENUM) != false || raise("Passed value for field obj.origin_type is not the expected type, validation failed.")
      end
    end
  end
end
