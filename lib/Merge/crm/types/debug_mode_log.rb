  ...
  module Crm
    class DebugModeLog
      ...
      def self.from_json(json_object:)
        ...
        log_summary = Crm::DebugModelLogSummary.from_json(json_object: log_summary)
      ...
      def self.validate_raw(obj:)
        ...
        Crm::DebugModelLogSummary.validate_raw(obj: obj.log_summary)
      end
    end
  end
end
