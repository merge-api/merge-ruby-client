...
module Merge
  module Crm
    class RemoteFieldClassForCustomObjectClassFieldChoicesItem
      attr_reader :value, :display_name, :additional_properties

      # @param value [Object]
      # @param display_name [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Crm::RemoteFieldClassForCustomObjectClassFieldChoicesItem]
      ...
      # Deserialize a JSON object to an instance of RemoteFieldClassForCustomObjectClassFieldChoicesItem
      #
      ...
      # Serialize an instance of RemoteFieldClassForCustomObjectClassFieldChoicesItem to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
