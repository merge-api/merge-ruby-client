...
TODO
    class AddressRequest
      attr_reader :street_1, :street_2, :city, :state, :postal_code, :country, :address_type, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param country [Crm::AddressRequestCountry] The address's country.  - `AF` - Afghanistan
- `AX` - Åland Islands
- `AL` - Albania
- `DZ` - Algeria
- `AS` - American Samoa
...
- `ZM` - Zambia
- `ZW` - Zimbabwe
      # @param address_type [Crm::AddressRequestAddressType] The address type.  - `BILLING` - BILLING
- `SHIPPING` - SHIPPING
      ...
      def initialize(street_1: nil, street_2: nil, city: nil, state: nil, postal_code: nil, country: nil, address_type: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
...
- `SHIPPING` - SHIPPING
      ...
      def self.from_json(json_object:)
        ...
        new(street_1: street_1, street_2: street_2, city: city, state: state, postal_code: postal_code, country: country, address_type: address_type, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of AddressRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "street_1": @street_1, "street_2": @street_2, "city": @city, "state": @state, "postal_code": @postal_code, "country": @country, "address_type": @address_type, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
