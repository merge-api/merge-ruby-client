...
require_relative "engagement_direction"
...
TODO
    class Engagement
      attr_reader :owner, :content, :subject, :direction, :engagement_type, :start_time, :end_time, :account, :contacts, :remote_was_deleted, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :remote_fields, :additional_properties
      ...
      # @param direction [Crm::EngagementDirection] The engagement's direction.  - `INBOUND` - INBOUND
- `OUTBOUND` - OUTBOUND
      ...
      def initialize(owner: nil, content: nil, subject: nil, direction: nil, engagement_type: nil, start_time: nil, end_time: nil, account: nil, contacts: nil, remote_was_deleted: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, remote_fields: nil, additional_properties: nil)
        ...
        @subject = subject
        # @type [Crm::EngagementDirection] The engagement's direction. 
- `INBOUND` - INBOUND
- `OUTBOUND` - OUTBOUND
        @direction = direction
      ...
      def self.from_json(json_object:)
        ...
        direction = Crm::EngagementDirection.from_json(json_object: direction)
  ...
  Crm::RemoteField.from_json(json_object: v)
        ...
        new(owner: owner, content: content, subject: subject, direction: direction, engagement_type: engagement_type, start_time: start_time, end_time: end_time, account: account, contacts: contacts, remote_was_deleted: remote_was_deleted, id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, remote_fields: remote_fields, additional_properties: struct)
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.direction.nil?() || Crm::EngagementDirection.validate_raw(obj: obj.direction)
