...
Fetch from the `GET Contact` endpoint and view their phone numbers.
    class PhoneNumberRequest
      ...
      def initialize(phone_number: nil, phone_number_type: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(phone_number: phone_number, phone_number_type: phone_number_type, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of PhoneNumberRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "phone_number": @phone_number, "phone_number_type": @phone_number_type, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
