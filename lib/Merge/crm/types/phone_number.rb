...
Fetch from the `GET Contact` endpoint and view their phone numbers.
    class PhoneNumber
      ...
      def initialize(phone_number: nil, phone_number_type: nil, created_at: nil, modified_at: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(phone_number: phone_number, phone_number_type: phone_number_type, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of PhoneNumber to a JSON object
      #
      # @return [JSON]
      def to_json
        { "phone_number": @phone_number, "phone_number_type": @phone_number_type, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
