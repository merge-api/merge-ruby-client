...
TODO
    class CustomObject
      attr_reader :object_class, :fields, :remote_id, :id, :created_at, :modified_at, :remote_fields, :additional_properties
      ...
      def initialize(object_class: nil, fields: nil, remote_id: nil, id: nil, created_at: nil, modified_at: nil, remote_fields: nil, additional_properties: nil)
        # @type [String] 
  ...
  Crm::RemoteField.from_json(json_object: v)
        ...
        new(object_class: object_class, fields: fields, remote_id: remote_id, id: id, created_at: created_at, modified_at: modified_at, remote_fields: remote_fields, additional_properties: struct)
      end
      # Serialize an instance of CustomObject to a JSON object
      #
      # @return [JSON]
      def to_json
        { "object_class": @object_class, "fields": @fields, "remote_id": @remote_id, "id": @id, "created_at": @created_at, "modified_at": @modified_at, "remote_fields": @remote_fields }.to_json()
      end
