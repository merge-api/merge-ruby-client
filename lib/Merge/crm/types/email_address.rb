...
Fetch from the `GET Contact` endpoint and view their email addresses.
    class EmailAddress
      ...
      def initialize(email_address: nil, email_address_type: nil, created_at: nil, modified_at: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(email_address: email_address, email_address_type: email_address_type, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of EmailAddress to a JSON object
      #
      # @return [JSON]
      def to_json
        { "email_address": @email_address, "email_address_type": @email_address_type, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
