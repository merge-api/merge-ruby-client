...
TODO
    class LeadRequest
      attr_reader :owner, :lead_source, :title, :company, :first_name, :last_name, :addresses, :email_addresses, :phone_numbers, :converted_date, :converted_contact, :converted_account, :integration_params, :linked_account_params, :remote_fields, :additional_properties
      ...
      def initialize(owner: nil, lead_source: nil, title: nil, company: nil, first_name: nil, last_name: nil, addresses: nil, email_addresses: nil, phone_numbers: nil, converted_date: nil, converted_contact: nil, converted_account: nil, integration_params: nil, linked_account_params: nil, remote_fields: nil, additional_properties: nil)
