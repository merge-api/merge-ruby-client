...
module Merge
  module Filestorage
    class MetaResponse
      ...
      # @param status [Filestorage::LinkedAccountStatus]
      ...
      def initialize(request_schema:, has_conditional_params:, has_required_linked_account_params:,
        ...
        # @type [Filestorage::LinkedAccountStatus]
        @status = status
        # @type [Boolean]
      ...
      def self.from_json(json_object:)
        ...
        status = Filestorage::LinkedAccountStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Filestorage::LinkedAccountStatus.validate_raw(obj: obj.status)
