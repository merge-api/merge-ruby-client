...
Fetch from the `GET /api/filestorage/v1/files` endpoint and view their files.
    class File
      attr_reader :id, :remote_id, :name, :file_url, :file_thumbnail_url, :size, :mime_type, :description, :folder, :permissions, :drive, :remote_created_at, :remote_updated_at, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      def initialize(id: nil, remote_id: nil, name: nil, file_url: nil, file_thumbnail_url: nil, size: nil, mime_type: nil, description: nil, folder: nil, permissions: nil, drive: nil, remote_created_at: nil, remote_updated_at: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, file_url: file_url, file_thumbnail_url: file_thumbnail_url, size: size, mime_type: mime_type, description: description, folder: folder, permissions: permissions, drive: drive, remote_created_at: remote_created_at, remote_updated_at: remote_updated_at, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
