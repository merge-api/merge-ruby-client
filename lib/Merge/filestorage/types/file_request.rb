...
Fetch from the `GET /api/filestorage/v1/files` endpoint and view their files.
    class FileRequest
      attr_reader :name, :file_url, :file_thumbnail_url, :size, :mime_type, :description, :folder, :permissions, :drive, :integration_params, :linked_account_params, :additional_properties
      ...
      def initialize(name: nil, file_url: nil, file_thumbnail_url: nil, size: nil, mime_type: nil, description: nil, folder: nil, permissions: nil, drive: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        folder = struct.folder.to_h.to_json()
        ...
        new(name: name, file_url: file_url, file_thumbnail_url: file_thumbnail_url, size: size, mime_type: mime_type, description: description, folder: folder, permissions: permissions, drive: drive, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      # Serialize an instance of FileRequest to a JSON object
      #
      # @return [JSON]
      def to_json
        { "name": @name, "file_url": @file_url, "file_thumbnail_url": @file_thumbnail_url, "size": @size, "mime_type": @mime_type, "description": @description, "folder": @folder, "permissions": @permissions, "drive": @drive, "integration_params": @integration_params, "linked_account_params": @linked_account_params }.to_json()
      end
