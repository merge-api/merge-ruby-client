...
require_relative "condition_schema_condition_type"
...
module Merge
  module Filestorage
    class ConditionSchema
      ...
      # @param condition_type [Filestorage::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.  - `BOOLEAN` - BOOLEAN
      `DATE`
      `DATE_TIME`
      `INTEGER`
      `FLOAT`
      `STRING`
      `LIST_OF_STRINGS`
      # @param operators [Array<Filestorage::OperatorSchema>] The schemas for the operators that can be used on a condition.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Filestorage::ConditionSchema]
      def initialize(id:, condition_type:, operators:, common_model: nil, native_name: nil, field_name: nil,
        ...
        @is_unique = is_unique
        # @type [Filestorage::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.
        `BOOLEAN`
        `DATE`
        `DATE_TIME`
        `INTEGER`
        ...
        # @type [Array<Filestorage::OperatorSchema>] The schemas for the operators that can be used on a condition.
        @operators = operators
      ...
      def self.from_json(json_object:)
        ...
        condition_type = struct.condition_type.to_h.to_json
        condition_type = Filestorage::ConditionSchemaConditionType.from_json(json_object: condition_type)
        operators = struct.operators.map do |v|
          v = v.to_h.to_json
          Filestorage::OperatorSchema.from_json(json_object: v)
        end
      ...
      def self.validate_raw(obj:)
        ...
        Filestorage::ConditionSchemaConditionType.validate_raw(obj: obj.condition_type)
