  ...
  module Filestorage
    class CommonModelScopesBodyRequest
      ...
      def self.from_json(json_object:)
        ...
        enabled_actions = struct.enabled_actions.map do |v|
          v = v.to_h.to_json
          ENABLED_ACTIONS_ENUM.key(v)
        end
