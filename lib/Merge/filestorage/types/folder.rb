...
Fetch from the `GET /api/filestorage/v1/folders` endpoint and view their folders.
    class Folder
      attr_reader :id, :remote_id, :name, :folder_url, :size, :description, :parent_folder, :drive, :permissions, :remote_created_at, :remote_updated_at, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      def initialize(id: nil, remote_id: nil, name: nil, folder_url: nil, size: nil, description: nil, parent_folder: nil, drive: nil, permissions: nil, remote_created_at: nil, remote_updated_at: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, folder_url: folder_url, size: size, description: description, parent_folder: parent_folder, drive: drive, permissions: permissions, remote_created_at: remote_created_at, remote_updated_at: remote_updated_at, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
