...
Fetch all the actions available for the `Zenefits` integration.
    class AvailableActions
      ...
      # @param integration [Filestorage::AccountIntegration] 
      # @param passthrough_available [Boolean] 
      # @param available_model_operations [Array<Filestorage::ModelOperation>] 
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Filestorage::AvailableActions]
      def initialize(integration:, passthrough_available:, available_model_operations: nil, additional_properties: nil)
        # @type [Filestorage::AccountIntegration] 
        @integration = integration
        # @type [Boolean] 
        @passthrough_available = passthrough_available
        # @type [Array<Filestorage::ModelOperation>] 
      ...
      def self.from_json(json_object:)
        ...
        integration = Filestorage::AccountIntegration.from_json(json_object: integration)
        passthrough_available = struct.passthrough_available
        available_model_operations = struct.available_model_operations.map() do | v |
  v = v.to_h.to_json()
  Filestorage::ModelOperation.from_json(json_object: v)
end
      ...
      def self.validate_raw(obj:)
        Filestorage::AccountIntegration.validate_raw(obj: obj.integration)
