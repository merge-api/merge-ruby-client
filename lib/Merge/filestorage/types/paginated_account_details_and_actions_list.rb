...
module Merge
  module Filestorage
    class PaginatedAccountDetailsAndActionsList
      ...
      # @param results [Array<Filestorage::AccountDetailsAndActions>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Filestorage::PaginatedAccountDetailsAndActionsList]
      def initialize(next_: nil, previous: nil, results: nil, additional_properties: nil)
        # @type [String]
        @next_ = next_
        # @type [String]
        @previous = previous
        # @type [Array<Filestorage::AccountDetailsAndActions>]
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of PaginatedAccountDetailsAndActionsList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = struct.results.map do |v|
          v = v.to_h.to_json
          Filestorage::AccountDetailsAndActions.from_json(json_object: v)
        end
