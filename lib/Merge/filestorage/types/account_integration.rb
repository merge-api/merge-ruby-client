...
module Merge
  module Filestorage
    class AccountIntegration
      ...
      # @param categories [Array<CATEGORIES_ENUM>] Category or categories this integration belongs to. Multiple categories should be comma separated, i.e. [ats, hris].
      ...
      def initialize(name:, categories: nil, image: nil, square_image: nil, color: nil, slug: nil, is_in_beta: nil,
        ...
        @name = name
        # @type [Array<CATEGORIES_ENUM>] Category or categories this integration belongs to. Multiple categories should be comma separated, i.e. [ats, hris].
