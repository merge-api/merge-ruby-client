...
Fetch from the `LIST Earnings` endpoint and filter by `ID` to show all earnings.
    class Earning
      attr_reader :id, :remote_id, :employee_payroll_run, :amount, :type, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param employee_payroll_run [String] 
      # @param amount [Float] The amount earned.
      # @param type [Hris::EarningType] The type of earning.  - `SALARY` - SALARY
...
- `BONUS` - BONUS
      ...
      # @return [Hris::Earning]
      def initialize(id: nil, remote_id: nil, employee_payroll_run: nil, amount: nil, type: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        @amount = amount
        # @type [Hris::EarningType] The type of earning. 
- `SALARY` - SALARY
- `REIMBURSEMENT` - REIMBURSEMENT
- `OVERTIME` - OVERTIME
- `BONUS` - BONUS
      ...
      def self.from_json(json_object:)
        ...
        type = Hris::EarningType.from_json(json_object: type)
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, employee_payroll_run: employee_payroll_run, amount: amount, type: type, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Earning to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "employee_payroll_run": @employee_payroll_run, "amount": @amount, "type": @type, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.type.nil?() || Hris::EarningType.validate_raw(obj: obj.type)
