...
require_relative "location_country"
require_relative "location_location_type"
require "date"
require "date"
...
Fetch from the `LIST Locations` endpoint and filter by `ID` to show all office locations.
    class Location
      attr_reader :id, :remote_id, :name, :phone_number, :street_1, :street_2, :city, :state, :zip_code, :country, :location_type, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param country [Hris::LocationCountry] The location's country.  - `AF` - Afghanistan
- `AX` - Åland Islands
- `AL` - Albania
- `DZ` - Algeria
- `AS` - American Samoa
...
- `ZM` - Zambia
- `ZW` - Zimbabwe
      # @param location_type [Hris::LocationLocationType] The location's type. Can be either WORK or HOME  - `HOME` - HOME
- `WORK` - WORK
      ...
      def initialize(id: nil, remote_id: nil, name: nil, phone_number: nil, street_1: nil, street_2: nil, city: nil, state: nil, zip_code: nil, country: nil, location_type: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        @zip_code = zip_code
        # @type [Hris::LocationCountry] The location's country. 
- `AF` - Afghanistan
- `AX` - Åland Islands
- `AL` - Albania
- `DZ` - Algeria
...
- `ZW` - Zimbabwe
        @country = country
        # @type [Hris::LocationLocationType] The location's type. Can be either WORK or HOME 
- `HOME` - HOME
- `WORK` - WORK
      ...
      def self.from_json(json_object:)
        ...
        country = struct.country.to_h.to_json()
        country = Hris::LocationCountry.from_json(json_object: country)
        location_type = struct.location_type.to_h.to_json()
        location_type = Hris::LocationLocationType.from_json(json_object: location_type)
  ...
  Hris::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.country.nil?() || Hris::LocationCountry.validate_raw(obj: obj.country)
        obj.location_type.nil?() || Hris::LocationLocationType.validate_raw(obj: obj.location_type)
