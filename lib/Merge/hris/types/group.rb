...
Fetch from the `LIST Employee` endpoint and expand groups to view an employee's groups.
    class Group
      attr_reader :id, :remote_id, :parent_group, :name, :type, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param parent_group [String] The parent group for this group.
      # @param name [String] The group name.
      # @param type [Hris::GroupType] The group type  - `TEAM` - TEAM
...
- `GROUP` - GROUP
      ...
      # @return [Hris::Group]
      def initialize(id: nil, remote_id: nil, parent_group: nil, name: nil, type: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `GROUP` - GROUP
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, parent_group: parent_group, name: name, type: type, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Group to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "parent_group": @parent_group, "name": @name, "type": @type, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
