  ...
  module Hris
    class ErrorValidationProblem
      ...
      def self.from_json(json_object:)
        ...
        source = Hris::ValidationProblemSource.from_json(json_object: source)
        title = struct.title
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Hris::ValidationProblemSource.validate_raw(obj: obj.source)
