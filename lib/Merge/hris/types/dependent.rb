...
require_relative "dependent_relationship"
require "date"
require_relative "dependent_gender"
require "date"
require "date"
...
Fetch from the `LIST Dependents` endpoint and filter by `ID` to show all dependents.
    class Dependent
      attr_reader :id, :remote_id, :first_name, :middle_name, :last_name, :relationship, :employee, :date_of_birth, :gender, :phone_number, :home_location, :is_student, :ssn, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param relationship [Hris::DependentRelationship] The dependent's relationship to the employee.  - `CHILD` - CHILD
- `SPOUSE` - SPOUSE
- `DOMESTIC_PARTNER` - DOMESTIC_PARTNER
      ...
      # @param gender [Hris::DependentGender] The dependent's gender.  - `MALE` - MALE
- `FEMALE` - FEMALE
...
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      ...
      def initialize(id: nil, remote_id: nil, first_name: nil, middle_name: nil, last_name: nil, relationship: nil, employee: nil, date_of_birth: nil, gender: nil, phone_number: nil, home_location: nil, is_student: nil, ssn: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        ...
        @last_name = last_name
        # @type [Hris::DependentRelationship] The dependent's relationship to the employee. 
- `CHILD` - CHILD
- `SPOUSE` - SPOUSE
- `DOMESTIC_PARTNER` - DOMESTIC_PARTNER
        ...
        # @type [Hris::DependentGender] The dependent's gender. 
- `MALE` - MALE
- `FEMALE` - FEMALE
- `NON-BINARY` - NON-BINARY
- `OTHER` - OTHER
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      ...
      def self.from_json(json_object:)
        ...
        relationship = struct.relationship.to_h.to_json()
        relationship = Hris::DependentRelationship.from_json(json_object: relationship)
        employee = struct.employee
        date_of_birth = DateTime.parse(struct.date_of_birth)
        gender = struct.gender.to_h.to_json()
        gender = Hris::DependentGender.from_json(json_object: gender)
  ...
  Hris::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.relationship.nil?() || Hris::DependentRelationship.validate_raw(obj: obj.relationship)
        ...
        obj.gender.nil?() || Hris::DependentGender.validate_raw(obj: obj.gender)
