...
module Merge
  module Hris
    class Issue
      ...
      # @param id [String]
      # @param status [Hris::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')  - `ONGOING` - ONGOING
      `RESOLVED`
      ...
      def initialize(error_description:, id: nil, status: nil, end_user: nil, first_incident_time: nil,
        ...
        # @type [String]
        @id = id
        # @type [Hris::IssueStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
        `ONGOING`
        `RESOLVED`
        @status = status
        # @type [String]
      ...
      def self.from_json(json_object:)
        ...
        status = Hris::IssueStatus.from_json(json_object: status)
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Hris::IssueStatus.validate_raw(obj: obj.status)
