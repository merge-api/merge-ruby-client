...
Fetch from the `LIST Employee` endpoint and filter by `ID` to show all employees.
    class EmployeeRequest
      attr_reader :employee_number, :company, :first_name, :last_name, :preferred_name, :display_full_name, :username, :groups, :work_email, :personal_email, :mobile_phone_number, :employments, :home_location, :work_location, :manager, :team, :pay_group, :ssn, :gender, :ethnicity, :marital_status, :date_of_birth, :hire_date, :start_date, :employment_status, :termination_date, :avatar, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param gender [Hris::EmployeeRequestGender] The employee's gender.  - `MALE` - MALE
- `FEMALE` - FEMALE
- `NON-BINARY` - NON-BINARY
- `OTHER` - OTHER
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      # @param ethnicity [Hris::EmployeeRequestEthnicity] The employee's ethnicity.  - `AMERICAN_INDIAN_OR_ALASKA_NATIVE` - AMERICAN_INDIAN_OR_ALASKA_NATIVE
...
- `WHITE` - WHITE
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      # @param marital_status [Hris::EmployeeRequestMaritalStatus] The employee's filing status as related to marital status.  - `SINGLE` - SINGLE
...
- `QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD` - QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD
      ...
      # @param employment_status [Hris::EmployeeRequestEmploymentStatus] The employment status of the employee.  - `ACTIVE` - ACTIVE
- `PENDING` - PENDING
- `INACTIVE` - INACTIVE
