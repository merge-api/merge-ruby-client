...
Fetch from the `LIST Taxes` endpoint and filter by `ID` to show all taxes.
    class Tax
      attr_reader :id, :remote_id, :employee_payroll_run, :name, :amount, :employer_tax, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @return [Hris::Tax]
      def initialize(id: nil, remote_id: nil, employee_payroll_run: nil, name: nil, amount: nil, employer_tax: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, employee_payroll_run: employee_payroll_run, name: name, amount: amount, employer_tax: employer_tax, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Tax to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "employee_payroll_run": @employee_payroll_run, "name": @name, "amount": @amount, "employer_tax": @employer_tax, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
