...
Fetch from the `LIST Deductions` endpoint and filter by `ID` to show all deductions.
    class Deduction
      attr_reader :id, :remote_id, :employee_payroll_run, :name, :employee_deduction, :company_deduction, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param employee_payroll_run [String] 
      # @param name [String] The deduction's name.
      # @param employee_deduction [Float] The amount of money that is withheld from an employee's gross pay by the employee.
      ...
      # @return [Hris::Deduction]
      def initialize(id: nil, remote_id: nil, employee_payroll_run: nil, name: nil, employee_deduction: nil, company_deduction: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        # @type [String] The deduction's name.
        @name = name
        # @type [Float] The amount of money that is withheld from an employee's gross pay by the employee.
        @employee_deduction = employee_deduction
        # @type [Float] The amount of money that is withheld on behalf of an employee by the company.
      ...
      def self.from_json(json_object:)
        ...
        name = struct.name
        employee_deduction = struct.employee_deduction
        company_deduction = struct.company_deduction
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, employee_payroll_run: employee_payroll_run, name: name, employee_deduction: employee_deduction, company_deduction: company_deduction, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Deduction to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "employee_payroll_run": @employee_payroll_run, "name": @name, "employee_deduction": @employee_deduction, "company_deduction": @company_deduction, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
