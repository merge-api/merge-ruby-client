...
Fetch from the `LIST PayrollRuns` endpoint and filter by `ID` to show all payroll runs.
    class PayrollRun
      attr_reader :id, :remote_id, :run_state, :run_type, :start_date, :end_date, :check_date, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param run_state [Hris::PayrollRunRunState] The state of the payroll run  - `PAID` - PAID
- `DRAFT` - DRAFT
- `APPROVED` - APPROVED
- `FAILED` - FAILED
- `CLOSED` - CLOSED
      # @param run_type [Hris::PayrollRunRunType] The type of the payroll run  - `REGULAR` - REGULAR
- `OFF_CYCLE` - OFF_CYCLE
...
- `SIGN_ON_BONUS` - SIGN_ON_BONUS
      ...
      def initialize(id: nil, remote_id: nil, run_state: nil, run_type: nil, start_date: nil, end_date: nil, check_date: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `SIGN_ON_BONUS` - SIGN_ON_BONUS
      ...
      def self.from_json(json_object:)
        ...
        run_state = struct.run_state.to_h.to_json()
        run_state = Hris::PayrollRunRunState.from_json(json_object: run_state)
        run_type = struct.run_type.to_h.to_json()
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, run_state: run_state, run_type: run_type, start_date: start_date, end_date: end_date, check_date: check_date, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of PayrollRun to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "run_state": @run_state, "run_type": @run_type, "start_date": @start_date, "end_date": @end_date, "check_date": @check_date, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
