...
Fetch from the `LIST EmployerBenefits` endpoint and filter by `ID` to show all EmployerBenefits.
    class EmployerBenefit
      attr_reader :id, :remote_id, :benefit_plan_type, :name, :description, :deduction_code, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      # @param remote_id [String] The third-party API ID of the matching object.
      # @param benefit_plan_type [Hris::EmployerBenefitBenefitPlanType] The type of benefit plan.  - `MEDICAL` - MEDICAL
...
- `OTHER` - OTHER
      ...
      def initialize(id: nil, remote_id: nil, benefit_plan_type: nil, name: nil, description: nil, deduction_code: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `OTHER` - OTHER
      ...
      def self.from_json(json_object:)
        ...
        benefit_plan_type = struct.benefit_plan_type.to_h.to_json()
        ...
        new(id: id, remote_id: remote_id, benefit_plan_type: benefit_plan_type, name: name, description: description, deduction_code: deduction_code, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of EmployerBenefit to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "benefit_plan_type": @benefit_plan_type, "name": @name, "description": @description, "deduction_code": @deduction_code, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
