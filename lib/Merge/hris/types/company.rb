...
Fetch from the `LIST Companies` endpoint and filter by `ID` to show all companies.
    class Company
      attr_reader :id, :remote_id, :legal_name, :display_name, :eins, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @return [Hris::Company]
      def initialize(id: nil, remote_id: nil, legal_name: nil, display_name: nil, eins: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
        ...
        # @type [String] The company's display name.
        @display_name = display_name
        # @type [Array<String>] The company's Employer Identification Numbers.
        @eins = eins
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, legal_name: legal_name, display_name: display_name, eins: eins, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      # Serialize an instance of Company to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "legal_name": @legal_name, "display_name": @display_name, "eins": @eins, "remote_was_deleted": @remote_was_deleted, "created_at": @created_at, "modified_at": @modified_at, "field_mappings": @field_mappings, "remote_data": @remote_data }.to_json()
      end
