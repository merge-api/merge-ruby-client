...
GET and POST Timesheet Entries
    class TimesheetEntry
      attr_reader :id, :remote_id, :employee, :hours_worked, :start_time, :end_time, :created_at, :modified_at, :additional_properties
      # @param id [String] 
      ...
      def initialize(id: nil, remote_id: nil, employee: nil, hours_worked: nil, start_time: nil, end_time: nil, created_at: nil, modified_at: nil, additional_properties: nil)
        # @type [String] 
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, employee: employee, hours_worked: hours_worked, start_time: start_time, end_time: end_time, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      # Serialize an instance of TimesheetEntry to a JSON object
      #
      # @return [JSON]
      def to_json
        { "id": @id, "remote_id": @remote_id, "employee": @employee, "hours_worked": @hours_worked, "start_time": @start_time, "end_time": @end_time, "created_at": @created_at, "modified_at": @modified_at }.to_json()
      end
