...
module Merge
  module Hris
    class ConditionSchema
      ...
      # @param condition_type [Hris::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.  - `BOOLEAN` - BOOLEAN
      `DATE`
      `DATE_TIME`
      `INTEGER`
      `FLOAT`
      ...
      def initialize(id:, condition_type:, operators:, common_model: nil, native_name: nil, field_name: nil,
        ...
        @is_unique = is_unique
        # @type [Hris::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.
        `BOOLEAN`
        `DATE`
        `DATE_TIME`
        `INTEGER`
      ...
      def self.from_json(json_object:)
        ...
        condition_type = Hris::ConditionSchemaConditionType.from_json(json_object: condition_type)
      ...
      def self.validate_raw(obj:)
        ...
        Hris::ConditionSchemaConditionType.validate_raw(obj: obj.condition_type)
