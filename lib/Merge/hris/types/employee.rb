...
require_relative "employee_gender"
require_relative "employee_ethnicity"
require_relative "employee_marital_status"
require "date"
require "date"
require "date"
require "date"
require_relative "employee_employment_status"
require "date"
require "date"
require "date"
...
Fetch from the `LIST Employee` endpoint and filter by `ID` to show all employees.
    class Employee
      ...
      # @param gender [Hris::EmployeeGender] The employee's gender.  - `MALE` - MALE
- `FEMALE` - FEMALE
- `NON-BINARY` - NON-BINARY
- `OTHER` - OTHER
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      # @param ethnicity [Hris::EmployeeEthnicity] The employee's ethnicity.  - `AMERICAN_INDIAN_OR_ALASKA_NATIVE` - AMERICAN_INDIAN_OR_ALASKA_NATIVE
...
- `WHITE` - WHITE
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      # @param marital_status [Hris::EmployeeMaritalStatus] The employee's filing status as related to marital status.  - `SINGLE` - SINGLE
...
- `QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD` - QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD
      ...
      # @param employment_status [Hris::EmployeeEmploymentStatus] The employment status of the employee.  - `ACTIVE` - ACTIVE
- `PENDING` - PENDING
- `INACTIVE` - INACTIVE
      ...
      def initialize(id: nil, remote_id: nil, employee_number: nil, company: nil, first_name: nil, last_name: nil, preferred_name: nil, display_full_name: nil, username: nil, groups: nil, work_email: nil, personal_email: nil, mobile_phone_number: nil, employments: nil, home_location: nil, work_location: nil, manager: nil, team: nil, pay_group: nil, ssn: nil, gender: nil, ethnicity: nil, marital_status: nil, date_of_birth: nil, hire_date: nil, start_date: nil, remote_created_at: nil, employment_status: nil, termination_date: nil, avatar: nil, custom_fields: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        ...
        @ssn = ssn
        # @type [Hris::EmployeeGender] The employee's gender. 
- `MALE` - MALE
- `FEMALE` - FEMALE
- `NON-BINARY` - NON-BINARY
- `OTHER` - OTHER
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
        @gender = gender
        # @type [Hris::EmployeeEthnicity] The employee's ethnicity. 
...
- `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
        @ethnicity = ethnicity
        # @type [Hris::EmployeeMaritalStatus] The employee's filing status as related to marital status. 
- `SINGLE` - SINGLE
- `MARRIED_FILING_JOINTLY` - MARRIED_FILING_JOINTLY
- `MARRIED_FILING_SEPARATELY` - MARRIED_FILING_SEPARATELY
- `HEAD_OF_HOUSEHOLD` - HEAD_OF_HOUSEHOLD
- `QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD` - QUALIFYING_WIDOW_OR_WIDOWER_WITH_DEPENDENT_CHILD
        ...
        # @type [Hris::EmployeeEmploymentStatus] The employment status of the employee. 
- `ACTIVE` - ACTIVE
- `PENDING` - PENDING
- `INACTIVE` - INACTIVE
  ...
  Hris::EmployeeGroupsItem.from_json(json_object: v)
        ...
        employments = struct.employments.map() do | v |
  v = v.to_h.to_json()
  Hris::EmployeeEmploymentsItem.from_json(json_object: v)
end
        home_location = struct.home_location.to_h.to_json()
        home_location = Hris::EmployeeHomeLocation.from_json(json_object: home_location)
        work_location = struct.work_location.to_h.to_json()
        work_location = Hris::EmployeeWorkLocation.from_json(json_object: work_location)
        manager = struct.manager.to_h.to_json()
        manager = Hris::EmployeeManager.from_json(json_object: manager)
        team = struct.team.to_h.to_json()
        team = Hris::EmployeeTeam.from_json(json_object: team)
        pay_group = struct.pay_group.to_h.to_json()
        pay_group = Hris::EmployeePayGroup.from_json(json_object: pay_group)
        ssn = struct.ssn
        gender = struct.gender.to_h.to_json()
        gender = Hris::EmployeeGender.from_json(json_object: gender)
        ethnicity = struct.ethnicity.to_h.to_json()
        ethnicity = Hris::EmployeeEthnicity.from_json(json_object: ethnicity)
        marital_status = struct.marital_status.to_h.to_json()
        marital_status = Hris::EmployeeMaritalStatus.from_json(json_object: marital_status)
        date_of_birth = DateTime.parse(struct.date_of_birth)
        hire_date = DateTime.parse(struct.hire_date)
        start_date = DateTime.parse(struct.start_date)
        remote_created_at = DateTime.parse(struct.remote_created_at)
        employment_status = struct.employment_status.to_h.to_json()
        employment_status = Hris::EmployeeEmploymentStatus.from_json(json_object: employment_status)
        termination_date = DateTime.parse(struct.termination_date)
  ...
  Hris::RemoteData.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.gender.nil?() || Hris::EmployeeGender.validate_raw(obj: obj.gender)
        obj.ethnicity.nil?() || Hris::EmployeeEthnicity.validate_raw(obj: obj.ethnicity)
        obj.marital_status.nil?() || Hris::EmployeeMaritalStatus.validate_raw(obj: obj.marital_status)
        ...
        obj.employment_status.nil?() || Hris::EmployeeEmploymentStatus.validate_raw(obj: obj.employment_status)
