...
Fetch from the `LIST Benefits` endpoint and filter by `ID` to show all benefits.
    class Benefit
      attr_reader :id, :remote_id, :employee, :provider_name, :benefit_plan_type, :employee_contribution, :company_contribution, :start_date, :end_date, :remote_was_deleted, :employer_benefit, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @return [Hris::Benefit]
      def initialize(id: nil, remote_id: nil, employee: nil, provider_name: nil, benefit_plan_type: nil, employee_contribution: nil, company_contribution: nil, start_date: nil, end_date: nil, remote_was_deleted: nil, employer_benefit: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, employee: employee, provider_name: provider_name, benefit_plan_type: benefit_plan_type, employee_contribution: employee_contribution, company_contribution: company_contribution, start_date: start_date, end_date: end_date, remote_was_deleted: remote_was_deleted, employer_benefit: employer_benefit, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
