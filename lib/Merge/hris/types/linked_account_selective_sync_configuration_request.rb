...
module Merge
  module Hris
    class LinkedAccountSelectiveSyncConfigurationRequest
      ...
      # @param linked_account_conditions [Array<Hris::LinkedAccountConditionRequest>] The conditions belonging to a selective sync.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Hris::LinkedAccountSelectiveSyncConfigurationRequest]
      def initialize(linked_account_conditions:, additional_properties: nil)
        # @type [Array<Hris::LinkedAccountConditionRequest>] The conditions belonging to a selective sync.
      ...
      def self.from_json(json_object:)
        ...
        linked_account_conditions = struct.linked_account_conditions.map do |v|
          v = v.to_h.to_json
          Hris::LinkedAccountConditionRequest.from_json(json_object: v)
        end
