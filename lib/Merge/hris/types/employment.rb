...
Fetch from the `LIST Employments` endpoint and filter by `ID` to show all employees.
    class Employment
      attr_reader :id, :remote_id, :employee, :job_title, :pay_rate, :pay_period, :pay_frequency, :pay_currency, :pay_group, :flsa_status, :effective_date, :employment_type, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param pay_period [Hris::EmploymentPayPeriod] The time period this pay rate encompasses.  - `HOUR` - HOUR
- `DAY` - DAY
- `WEEK` - WEEK
...
- `YEAR` - YEAR
      # @param pay_frequency [Hris::EmploymentPayFrequency] The position's pay frequency.  - `WEEKLY` - WEEKLY
- `BIWEEKLY` - BIWEEKLY
- `MONTHLY` - MONTHLY
- `QUARTERLY` - QUARTERLY
...
- `PRO_RATA` - PRO_RATA
- `SEMIMONTHLY` - SEMIMONTHLY
      # @param pay_currency [Hris::EmploymentPayCurrency] The position's currency code.  - `XUA` - ADB Unit of Account
- `AFN` - Afghan Afghani
...
- `ZWL` - Zimbabwean Dollar (2009)
      ...
      # @param flsa_status [Hris::EmploymentFlsaStatus] The position's FLSA status.  - `EXEMPT` - EXEMPT
- `SALARIED_NONEXEMPT` - SALARIED_NONEXEMPT
- `NONEXEMPT` - NONEXEMPT
- `OWNER` - OWNER
      # @param effective_date [DateTime] The position's effective date.
      # @param employment_type [Hris::EmploymentEmploymentType] The position's type of employment.  - `FULL_TIME` - FULL_TIME
- `PART_TIME` - PART_TIME
- `INTERN` - INTERN
...
- `FREELANCE` - FREELANCE
      ...
      def initialize(id: nil, remote_id: nil, employee: nil, job_title: nil, pay_rate: nil, pay_period: nil, pay_frequency: nil, pay_currency: nil, pay_group: nil, flsa_status: nil, effective_date: nil, employment_type: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `FREELANCE` - FREELANCE
      ...
      def self.from_json(json_object:)
        ...
        flsa_status = struct.flsa_status.to_h.to_json()
        flsa_status = Hris::EmploymentFlsaStatus.from_json(json_object: flsa_status)
        effective_date = DateTime.parse(struct.effective_date)
        employment_type = struct.employment_type.to_h.to_json()
