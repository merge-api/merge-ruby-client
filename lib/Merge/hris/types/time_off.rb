...
Fetch from the `LIST TimeOffs` endpoint and filter by `ID` to show all time off requests.
    class TimeOff
      attr_reader :id, :remote_id, :employee, :approver, :status, :employee_note, :units, :amount, :request_type, :start_time, :end_time, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      # @param id [String] 
      ...
      # @param status [Hris::TimeOffStatus] The status of this time off request.  - `REQUESTED` - REQUESTED
- `APPROVED` - APPROVED
- `DECLINED` - DECLINED
- `CANCELLED` - CANCELLED
- `DELETED` - DELETED
      # @param employee_note [String] The employee note for this time off request.
      # @param units [Hris::TimeOffUnits] The measurement that the third-party integration uses to count time requested.  - `HOURS` - HOURS
- `DAYS` - DAYS
      # @param amount [Float] The time off quantity measured by the prescribed “units”.
      # @param request_type [Hris::TimeOffRequestType] The type of time off request.  - `VACATION` - VACATION
- `SICK` - SICK
- `PERSONAL` - PERSONAL
- `JURY_DUTY` - JURY_DUTY
- `VOLUNTEER` - VOLUNTEER
- `BEREAVEMENT` - BEREAVEMENT
      ...
      # @return [Hris::TimeOff]
      def initialize(id: nil, remote_id: nil, employee: nil, approver: nil, status: nil, employee_note: nil, units: nil, amount: nil, request_type: nil, start_time: nil, end_time: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String] 
        @id = id
...
- `BEREAVEMENT` - BEREAVEMENT
  ...
  Hris::RemoteData.from_json(json_object: v)
        ...
        new(id: id, remote_id: remote_id, employee: employee, approver: approver, status: status, employee_note: employee_note, units: units, amount: amount, request_type: request_type, start_time: start_time, end_time: end_time, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
