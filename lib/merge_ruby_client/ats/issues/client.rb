...
module Merge
  module Ats
    class IssuesClient
      ...
      #  this time
      # @param status [Merge::Ats::Issues::IssuesListRequestStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      # @param request_options [Merge::RequestOptions]
      # @return [Merge::Ats::PaginatedIssueList]
      # @example
      ...
      def list(account_token: nil, cursor: nil, end_date: nil, end_user_organization_name: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ats/v1/issues"
        end
        Merge::Ats::PaginatedIssueList.from_json(json_object: response.body)
      end
      ...
      def retrieve(id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ats/v1/issues/#{id}"
        end
        Merge::Ats::Issue.from_json(json_object: response.body)
      end
    end
