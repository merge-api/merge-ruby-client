...
module Merge
  module Ats
    class JobInterviewStagesClient
      ...
      #  BEGIN_ATS_JOBINTERVIEWSTAGE_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  RQStZ06tD9nzGAXh7NHpS1ChdO1seZGYCz6joqvb2LyFKL0sgqVk+rhrWqH/1jufP/5J73ZauvEOwAA"
      #  /></Footer>{/* END_ATS_JOBINTERVIEWSTAGE_FETCH_SUPPORTED_FIELDS * /}
      #
