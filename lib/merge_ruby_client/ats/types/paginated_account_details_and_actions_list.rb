...
module Merge
  module Ats
    class PaginatedAccountDetailsAndActionsList
      ...
      # @return [Array<Merge::Ats::AccountDetailsAndActions>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::AccountDetailsAndActions>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::AccountDetailsAndActions.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
