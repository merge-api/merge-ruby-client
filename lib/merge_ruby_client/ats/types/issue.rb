...
module Merge
  module Ats
    class Issue
      # @return [String]
      attr_reader :id
      # @return [Merge::Ats::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  - `ONGOING` - ONGOING
      #  - `RESOLVED` - RESOLVED
      attr_reader :status
      # @return [String]
      ...
      # @param id [String]
      # @param status [Merge::Ats::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  - `ONGOING` - ONGOING
      #  - `RESOLVED` - RESOLVED
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Merge::Ats::IssueStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
