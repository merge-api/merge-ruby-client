...
module Merge
  module Ats
    class LinkedAccountSelectiveSyncConfigurationRequest
      ...
      # @param linked_account_conditions [Array<Ats::LinkedAccountConditionRequest>] The conditions belonging to a selective sync.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ats::LinkedAccountSelectiveSyncConfigurationRequest]
      def initialize(linked_account_conditions:, additional_properties: nil)
        # @type [Array<Ats::LinkedAccountConditionRequest>] The conditions belonging to a selective sync.
      ...
      def self.from_json(json_object:)
        ...
        linked_account_conditions = parsed_json["linked_account_conditions"]&.map do |v|
          v = v.to_json
          Ats::LinkedAccountConditionRequest.from_json(json_object: v)
        end
