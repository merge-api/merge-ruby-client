...
module Merge
  module Ats
    ...
    class Eeoc
      ...
      # @param race [Ats::EeocRace] The candidate's race.
      ...
      # @param gender [Ats::EeocGender] The candidate's gender.
      #   - `MALE` - MALE
      #   - `FEMALE` - FEMALE
      #   - `NON-BINARY` - NON-BINARY
      #   - `OTHER` - OTHER
      #   - `DECLINE_TO_SELF_IDENTIFY` - DECLINE_TO_SELF_IDENTIFY
      # @param veteran_status [Ats::EeocVeteranStatus] The candidate's veteran status.
      ...
      # @param disability_status [Ats::EeocDisabilityStatus] The candidate's disability status.
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["race"].nil?
          race = nil
        else
          race = parsed_json["race"].to_json
        ...
        if parsed_json["veteran_status"].nil?
          veteran_status = nil
        else
          veteran_status = parsed_json["veteran_status"].to_json
          veteran_status = Ats::EeocVeteranStatus.from_json(json_object: veteran_status)
        end
        if parsed_json["disability_status"].nil?
          disability_status = nil
        else
          disability_status = parsed_json["disability_status"].to_json
