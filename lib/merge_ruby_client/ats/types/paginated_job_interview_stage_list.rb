...
module Merge
  module Ats
    class PaginatedJobInterviewStageList
      ...
      # @return [Array<Merge::Ats::JobInterviewStage>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::JobInterviewStage>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ats::PaginatedJobInterviewStageList]
      ...
      # Deserialize a JSON object to an instance of PaginatedJobInterviewStageList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::JobInterviewStage.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedJobInterviewStageList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
