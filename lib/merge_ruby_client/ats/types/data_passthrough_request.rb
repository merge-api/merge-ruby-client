...
module Merge
  module Ats
    ...
    class DataPassthroughRequest
      ...
      attr_reader :data
      # @return [Array<Merge::Ats::MultipartFormFieldRequest>] Pass an array of `MultipartFormField` objects in here instead of using the
      ...
      attr_reader :headers
      # @return [Merge::Ats::RequestFormatEnum]
      ...
      # @param method_ [Merge::Ats::MethodEnum]
      ...
      #  matching the data's format
      # @param multipart_form_data [Array<Merge::Ats::MultipartFormFieldRequest>] Pass an array of `MultipartFormField` objects in here instead of using the
      #  `data` param if `request_format` is set to `MULTIPART`.
      # @param headers [Hash{String => Object}] The headers to use for the request (Merge will handle the account's
      #  authorization headers). `Content-Type` header is required for passthrough.
      #  Choose content type corresponding to expected format of receiving server.
      # @param request_format [Merge::Ats::RequestFormatEnum]
      ...
      # @return [Merge::Ats::DataPassthroughRequest]
      ...
      def self.validate_raw(obj:)
        obj.method_.is_a?(Merge::Ats::MethodEnum) != false || raise("Passed value for field obj.method_ is not the expected type, validation failed.")
