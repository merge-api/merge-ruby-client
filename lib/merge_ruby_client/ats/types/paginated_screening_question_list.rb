...
module Merge
  module Ats
    class PaginatedScreeningQuestionList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Ats::ScreeningQuestion>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::ScreeningQuestion>]
      ...
      # Deserialize a JSON object to an instance of PaginatedScreeningQuestionList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::ScreeningQuestion.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedScreeningQuestionList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
