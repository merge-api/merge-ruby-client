...
module Merge
  module Ats
    class PaginatedApplicationList
      ...
      # @return [Array<Merge::Ats::Application>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::Application>]
      ...
      # Deserialize a JSON object to an instance of PaginatedApplicationList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::Application.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedApplicationList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
