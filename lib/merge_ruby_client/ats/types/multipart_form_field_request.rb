...
module Merge
  module Ats
    ...
    class MultipartFormFieldRequest
      ...
      # @param encoding [Ats::MultipartFormFieldRequestEncoding] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #   - `RAW` - RAW
      #   - `BASE64` - BASE64
      ...
      # @return [Ats::MultipartFormFieldRequest]
      def initialize(name:, data:, encoding: nil, file_name: nil, content_type: nil, additional_properties: nil)
        ...
        @data = data
        # @type [Ats::MultipartFormFieldRequestEncoding] The encoding of the value of `data`. Defaults to `RAW` if not defined.
        #   - `RAW` - RAW
        #   - `BASE64` - BASE64
        #   - `GZIP_BASE64` - GZIP_BASE64
        @encoding = encoding
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["encoding"].nil?
          ...
          encoding = Ats::MultipartFormFieldRequestEncoding.from_json(json_object: encoding)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.encoding.nil? || Ats::MultipartFormFieldRequestEncoding.validate_raw(obj: obj.encoding)
