...
module Merge
  module Ats
    ...
    class MultipartFormFieldRequest
      ...
      attr_reader :data
      # @return [Merge::Ats::EncodingEnum] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #  - `RAW` - RAW
      #  - `BASE64` - BASE64
      ...
      # @param encoding [Merge::Ats::EncodingEnum] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #  - `RAW` - RAW
      #  - `BASE64` - BASE64
      #  - `GZIP_BASE64` - GZIP_BASE64
      ...
      # @return [Merge::Ats::MultipartFormFieldRequest]
