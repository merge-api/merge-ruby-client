...
module Merge
  module Ats
    class FieldMappingInstanceResponse
      ...
      # @param model [Merge::Ats::FieldMappingApiInstance]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Ats::FieldMappingApiInstance.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Ats::FieldMappingApiInstance.validate_raw(obj: obj.model)
