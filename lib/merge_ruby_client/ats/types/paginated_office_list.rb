...
module Merge
  module Ats
    class PaginatedOfficeList
      ...
      # @param results [Array<Merge::Ats::Office>]
      ...
      # Deserialize a JSON object to an instance of PaginatedOfficeList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::Office.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedOfficeList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
