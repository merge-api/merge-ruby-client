...
module Merge
  module Ats
    class PaginatedScheduledInterviewList
      ...
      # @return [Array<Merge::Ats::ScheduledInterview>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::ScheduledInterview>]
      ...
      # Deserialize a JSON object to an instance of PaginatedScheduledInterviewList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::ScheduledInterview.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedScheduledInterviewList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
