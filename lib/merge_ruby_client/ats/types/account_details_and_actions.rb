...
module Merge
  module Ats
    ...
    class AccountDetailsAndActions
      # @return [String]
      attr_reader :id
      # @return [Merge::Ats::CategoryEnum]
      attr_reader :category
      # @return [Merge::Ats::AccountDetailsAndActionsStatusEnum]
      attr_reader :status
      # @return [String]
      ...
      # @return [Merge::Ats::AccountDetailsAndActionsIntegration]
      ...
      # @param id [String]
      # @param category [Merge::Ats::CategoryEnum]
      # @param status [Merge::Ats::AccountDetailsAndActionsStatusEnum]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["integration"].nil?
          ...
          integration = Merge::Ats::AccountDetailsAndActionsIntegration.from_json(json_object: integration)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.category&.is_a?(Merge::Ats::CategoryEnum) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
        obj.status.is_a?(Merge::Ats::AccountDetailsAndActionsStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
