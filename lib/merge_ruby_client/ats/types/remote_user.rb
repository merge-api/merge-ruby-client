...
module Merge
  module Ats
    ...
    class RemoteUser
      ...
      # @param access_role [ACCESS_ROLE_ENUM] The user's role.
      ...
      def initialize(id: nil, remote_id: nil, first_name: nil, last_name: nil, email: nil, disabled: nil,
        ...
        # @type [ACCESS_ROLE_ENUM] The user's role.
        #   - `SUPER_ADMIN` - SUPER_ADMIN
        #   - `ADMIN` - ADMIN
        #   - `TEAM_MEMBER` - TEAM_MEMBER
        #   - `LIMITED_TEAM_MEMBER` - LIMITED_TEAM_MEMBER
      ...
      def self.from_json(json_object:)
        ...
        access_role = Ats::ACCESS_ROLE_ENUM.key(parsed_json["access_role"]) || parsed_json["access_role"]
      ...
      def to_json(*_args)
        {
          ...
          "disabled": @disabled,
          "remote_created_at": @remote_created_at,
          "access_role": Ats::ACCESS_ROLE_ENUM[@access_role] || @access_role,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.access_role&.is_a?(Ats::ACCESS_ROLE_ENUM) != false || raise("Passed value for field obj.access_role is not the expected type, validation failed.")
