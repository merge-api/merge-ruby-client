...
module Merge
  module Ats
    class PaginatedAuditLogEventList
      ...
      # @return [Array<Merge::Ats::AuditLogEvent>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::AuditLogEvent>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ats::PaginatedAuditLogEventList]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::AuditLogEvent.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
