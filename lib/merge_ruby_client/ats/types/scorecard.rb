...
module Merge
  module Ats
    ...
    class Scorecard
      attr_reader :id, :remote_id, :application, :interview, :interviewer, :remote_created_at, :submitted_at,
                  :overall_recommendation, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      # @param overall_recommendation [OVERALL_RECOMMENDATION_ENUM] The inteviewer's recommendation.
      ...
      def initialize(id: nil, remote_id: nil, application: nil, interview: nil, interviewer: nil,
                     remote_created_at: nil, submitted_at: nil, overall_recommendation: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
        ...
        # @type [OVERALL_RECOMMENDATION_ENUM] The inteviewer's recommendation.
        #   - `DEFINITELY_NO` - DEFINITELY_NO
        #   - `NO` - NO
        #   - `YES` - YES
        #   - `STRONG_YES` - STRONG_YES
      ...
      def self.from_json(json_object:)
        ...
        overall_recommendation = Ats::OVERALL_RECOMMENDATION_ENUM.key(parsed_json["overall_recommendation"]) || parsed_json["overall_recommendation"]
        ...
        new(id: id, remote_id: remote_id, application: application, interview: interview, interviewer: interviewer,
            remote_created_at: remote_created_at, submitted_at: submitted_at, overall_recommendation: overall_recommendation, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
      ...
      def to_json(*_args)
        {
          ...
          "remote_created_at": @remote_created_at,
          "submitted_at": @submitted_at,
          "overall_recommendation": Ats::OVERALL_RECOMMENDATION_ENUM[@overall_recommendation] || @overall_recommendation,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.overall_recommendation&.is_a?(Ats::OVERALL_RECOMMENDATION_ENUM) != false || raise("Passed value for field obj.overall_recommendation is not the expected type, validation failed.")
