...
module Merge
  module Ats
    ...
    class Scorecard
      ...
      # @param overall_recommendation [Ats::ScorecardOverallRecommendation] The inteviewer's recommendation.
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["overall_recommendation"].nil?
          overall_recommendation = nil
        else
          overall_recommendation = parsed_json["overall_recommendation"].to_json
