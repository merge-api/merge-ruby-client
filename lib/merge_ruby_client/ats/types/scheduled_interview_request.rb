...
module Merge
  module Ats
    ...
    class ScheduledInterviewRequest
      attr_reader :application, :job_interview_stage, :organizer, :interviewers, :location, :start_at, :end_at,
                  :status, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param status [SCHEDULED_INTERVIEW_STATUS_ENUM] The interview's status.
      #   - `SCHEDULED` - SCHEDULED
      ...
      def initialize(application: nil, job_interview_stage: nil, organizer: nil, interviewers: nil, location: nil,
                     start_at: nil, end_at: nil, status: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
        ...
        @end_at = end_at
        # @type [SCHEDULED_INTERVIEW_STATUS_ENUM] The interview's status.
        #   - `SCHEDULED` - SCHEDULED
        #   - `AWAITING_FEEDBACK` - AWAITING_FEEDBACK
        #   - `COMPLETE` - COMPLETE
        @status = status
      ...
      def self.from_json(json_object:)
        ...
        status = Ats::SCHEDULED_INTERVIEW_STATUS_ENUM.key(parsed_json["status"]) || parsed_json["status"]
        integration_params = struct.integration_params
        linked_account_params = struct.linked_account_params
        new(application: application, job_interview_stage: job_interview_stage, organizer: organizer,
            interviewers: interviewers, location: location, start_at: start_at, end_at: end_at, status: status, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      ...
      def to_json(*_args)
        {
          ...
          "start_at": @start_at,
          "end_at": @end_at,
          "status": Ats::SCHEDULED_INTERVIEW_STATUS_ENUM[@status] || @status,
          "integration_params": @integration_params,
          "linked_account_params": @linked_account_params
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Ats::SCHEDULED_INTERVIEW_STATUS_ENUM) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
