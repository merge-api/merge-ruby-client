...
module Merge
  module Ats
    class ScheduledInterviewResponse
      ...
      # @param model [Merge::Ats::ScheduledInterview]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Ats::ScheduledInterview.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Ats::ScheduledInterview.validate_raw(obj: obj.model)
