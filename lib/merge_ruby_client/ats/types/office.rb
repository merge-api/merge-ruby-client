...
module Merge
  module Ats
    ...
    class Office
      attr_reader :id, :remote_id, :name, :location, :remote_was_deleted, :created_at, :modified_at, :field_mappings,
      ...
      # @return [Ats::Office]
      def initialize(id: nil, remote_id: nil, name: nil, location: nil, remote_was_deleted: nil, created_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, location: location, remote_was_deleted: remote_was_deleted,
