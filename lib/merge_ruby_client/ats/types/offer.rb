...
module Merge
  module Ats
    ...
    class Offer
      ...
      # @param status [OFFER_STATUS_ENUM] The offer's status.
      #   - `DRAFT` - DRAFT
      ...
      def initialize(id: nil, remote_id: nil, application: nil, creator: nil, remote_created_at: nil, closed_at: nil,
        ...
        # @type [OFFER_STATUS_ENUM] The offer's status.
        #   - `DRAFT` - DRAFT
        #   - `APPROVAL-SENT` - APPROVAL-SENT
        #   - `APPROVED` - APPROVED
        #   - `SENT` - SENT
      ...
      def self.from_json(json_object:)
        ...
        status = Ats::OFFER_STATUS_ENUM.key(parsed_json["status"]) || parsed_json["status"]
      ...
      def to_json(*_args)
        {
          ...
          "sent_at": @sent_at,
          "start_date": @start_date,
          "status": Ats::OFFER_STATUS_ENUM[@status] || @status,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Ats::OFFER_STATUS_ENUM) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
