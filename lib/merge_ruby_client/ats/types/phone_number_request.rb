...
module Merge
  module Ats
    ...
    class PhoneNumberRequest
      ...
      # @param phone_number_type [Ats::PhoneNumberRequestPhoneNumberType] The type of phone number.
      #   - `HOME` - HOME
      #   - `WORK` - WORK
      #   - `MOBILE` - MOBILE
      #   - `SKYPE` - SKYPE
      ...
      def initialize(value: nil, phone_number_type: nil, integration_params: nil, linked_account_params: nil,
      ...
      def self.from_json(json_object:)
        ...
        value = struct.value
        if parsed_json["phone_number_type"].nil?
          phone_number_type = nil
        else
          phone_number_type = parsed_json["phone_number_type"].to_json
          phone_number_type = Ats::PhoneNumberRequestPhoneNumberType.from_json(json_object: phone_number_type)
        end
        integration_params = struct.integration_params
        linked_account_params = struct.linked_account_params
        new(value: value, phone_number_type: phone_number_type, integration_params: integration_params,
