...
module Merge
  module Ats
    ...
    class Job
      attr_reader :id, :remote_id, :name, :description, :code, :status, :job_posting_urls, :remote_created_at,
                  :remote_updated_at, :confidential, :departments, :offices, :hiring_managers, :recruiters, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      # @param status [JOB_STATUS_ENUM] The job's status.
      #   - `OPEN` - OPEN
      #   - `CLOSED` - CLOSED
      #   - `DRAFT` - DRAFT
      #   - `ARCHIVED` - ARCHIVED
      ...
      # @return [Ats::Job]
      def initialize(id: nil, remote_id: nil, name: nil, description: nil, code: nil, status: nil,
                     job_posting_urls: nil, remote_created_at: nil, remote_updated_at: nil, confidential: nil, departments: nil, offices: nil, hiring_managers: nil, recruiters: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
        ...
        @code = code
        # @type [JOB_STATUS_ENUM] The job's status.
        #   - `OPEN` - OPEN
        #   - `CLOSED` - CLOSED
        #   - `DRAFT` - DRAFT
        #   - `ARCHIVED` - ARCHIVED
      ...
      def self.from_json(json_object:)
        ...
        code = struct.code
        status = Ats::JOB_STATUS_ENUM.key(parsed_json["status"]) || parsed_json["status"]
      ...
      def to_json(*_args)
        {
          ...
          "description": @description,
          "code": @code,
          "status": Ats::JOB_STATUS_ENUM[@status] || @status,
          "job_posting_urls": @job_posting_urls,
          "remote_created_at": @remote_created_at,
          "remote_updated_at": @remote_updated_at,
          "confidential": @confidential,
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Ats::JOB_STATUS_ENUM) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
