...
module Merge
  module Ats
    class ConditionSchema
      ...
      # @return [Merge::Ats::ConditionTypeEnum] The type of value(s) that can be set for this condition.
      #  - `BOOLEAN` - BOOLEAN
      #  - `DATE` - DATE
      #  - `DATE_TIME` - DATE_TIME
      #  - `INTEGER` - INTEGER
      ...
      # @return [Array<Merge::Ats::OperatorSchema>] The schemas for the operators that can be used on a condition.
      ...
      #  AND'd together multiple times.
      # @param condition_type [Merge::Ats::ConditionTypeEnum] The type of value(s) that can be set for this condition.
      #  - `BOOLEAN` - BOOLEAN
      #  - `DATE` - DATE
      #  - `DATE_TIME` - DATE_TIME
      #  - `INTEGER` - INTEGER
      ...
      #  - `STRING` - STRING
      #  - `LIST_OF_STRINGS` - LIST_OF_STRINGS
      # @param operators [Array<Merge::Ats::OperatorSchema>] The schemas for the operators that can be used on a condition.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ats::ConditionSchema]
      ...
      def self.from_json(json_object:)
        ...
        operators = parsed_json["operators"]&.map do |v|
          v = v.to_json
          Merge::Ats::OperatorSchema.from_json(json_object: v)
        end
        new(
          id: id,
          common_model: common_model,
      ...
      def self.validate_raw(obj:)
        ...
        obj.condition_type.is_a?(Merge::Ats::ConditionTypeEnum) != false || raise("Passed value for field obj.condition_type is not the expected type, validation failed.")
