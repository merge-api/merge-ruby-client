...
module Merge
  module Ats
    ...
    class SyncStatus
      ...
      # @return [Merge::Ats::SyncStatusStatusEnum]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Ats::SyncStatusStatusEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.is_a?(Merge::Ats::SyncStatusStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
