...
module Merge
  module Ats
    ...
    class Department
      attr_reader :id, :remote_id, :name, :remote_was_deleted, :created_at, :modified_at, :field_mappings,
      ...
      def initialize(id: nil, remote_id: nil, name: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, remote_was_deleted: remote_was_deleted, created_at: created_at,
