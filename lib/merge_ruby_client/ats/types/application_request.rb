...
module Merge
  module Ats
    ...
    class ApplicationRequest
      attr_reader :candidate, :job, :applied_at, :rejected_at, :source, :credited_to, :current_stage, :reject_reason,
                  :remote_template_id, :integration_params, :linked_account_params, :additional_properties
      ...
      def initialize(candidate: nil, job: nil, applied_at: nil, rejected_at: nil, source: nil, credited_to: nil,
                     current_stage: nil, reject_reason: nil, remote_template_id: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(candidate: candidate, job: job, applied_at: applied_at, rejected_at: rejected_at, source: source,
            credited_to: credited_to, current_stage: current_stage, reject_reason: reject_reason, remote_template_id: remote_template_id, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
