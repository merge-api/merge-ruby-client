...
module Merge
  module Ats
    class RemoteFieldApiResponse
      # @return [Array<Merge::Ats::RemoteFieldApi>]
      ...
      # @param activity [Array<Merge::Ats::RemoteFieldApi>]
      # @param application [Array<Merge::Ats::RemoteFieldApi>]
      # @param attachment [Array<Merge::Ats::RemoteFieldApi>]
      # @param candidate [Array<Merge::Ats::RemoteFieldApi>]
      # @param department [Array<Merge::Ats::RemoteFieldApi>]
      # @param eeoc [Array<Merge::Ats::RemoteFieldApi>]
      # @param scheduled_interview [Array<Merge::Ats::RemoteFieldApi>]
      # @param job [Array<Merge::Ats::RemoteFieldApi>]
      # @param job_posting [Array<Merge::Ats::RemoteFieldApi>]
      # @param job_interview_stage [Array<Merge::Ats::RemoteFieldApi>]
      # @param offer [Array<Merge::Ats::RemoteFieldApi>]
      # @param office [Array<Merge::Ats::RemoteFieldApi>]
      # @param reject_reason [Array<Merge::Ats::RemoteFieldApi>]
      # @param scorecard [Array<Merge::Ats::RemoteFieldApi>]
      # @param tag [Array<Merge::Ats::RemoteFieldApi>]
      # @param remote_user [Array<Merge::Ats::RemoteFieldApi>]
      ...
      def self.from_json(json_object:)
        ...
        activity = parsed_json["Activity"]&.map do |item|
          item = item.to_json
          Merge::Ats::RemoteFieldApi.from_json(json_object: item)
        end
