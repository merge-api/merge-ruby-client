...
module Merge
  module Ats
    class FieldMappingApiInstanceResponse
      # @return [Array<Merge::Ats::FieldMappingApiInstance>]
      ...
      # @param activity [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param application [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param attachment [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param candidate [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param department [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param eeoc [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param scheduled_interview [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param job [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param job_posting [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param job_interview_stage [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param offer [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param office [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param reject_reason [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param scorecard [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param tag [Array<Merge::Ats::FieldMappingApiInstance>]
      # @param remote_user [Array<Merge::Ats::FieldMappingApiInstance>]
