...
module Merge
  module Ats
    ...
    class ScheduledInterview
      attr_reader :id, :remote_id, :application, :job_interview_stage, :organizer, :interviewers, :location, :start_at,
                  :end_at, :remote_created_at, :remote_updated_at, :status, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      def initialize(id: nil, remote_id: nil, application: nil, job_interview_stage: nil, organizer: nil,
                     interviewers: nil, location: nil, start_at: nil, end_at: nil, remote_created_at: nil, remote_updated_at: nil, status: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, application: application, job_interview_stage: job_interview_stage,
