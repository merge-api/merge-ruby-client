...
module Merge
  module Ats
    ...
    class AttachmentRequest
      attr_reader :file_name, :file_url, :candidate, :attachment_type, :integration_params, :linked_account_params,
                  :additional_properties

      # @param file_name [String] The attachment's name.
      # @param file_url [String] The attachment's url.
      # @param candidate [String]
      # @param attachment_type [Ats::AttachmentRequestAttachmentType] The attachment's type.
      #   - `RESUME` - RESUME
      ...
      def initialize(file_name: nil, file_url: nil, candidate: nil, attachment_type: nil, integration_params: nil,
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["attachment_type"].nil?
          attachment_type = nil
        else
          attachment_type = parsed_json["attachment_type"].to_json
          attachment_type = Ats::AttachmentRequestAttachmentType.from_json(json_object: attachment_type)
        end
        integration_params = struct.integration_params
        linked_account_params = struct.linked_account_params
        new(file_name: file_name, file_url: file_url, candidate: candidate, attachment_type: attachment_type,
