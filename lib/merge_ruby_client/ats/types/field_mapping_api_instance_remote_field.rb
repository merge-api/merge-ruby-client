...
module Merge
  module Ats
    class FieldMappingApiInstanceRemoteField
      ...
      # @param remote_endpoint_info [Merge::Ats::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_endpoint_info"].nil?
          ...
          remote_endpoint_info = Merge::Ats::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.from_json(json_object: remote_endpoint_info)
        end
        new(
          remote_key_name: remote_key_name,
          schema: schema,
      ...
      def self.validate_raw(obj:)
        ...
        Merge::Ats::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.validate_raw(obj: obj.remote_endpoint_info)
      end
    end
  end
end
