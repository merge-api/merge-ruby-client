...
module Merge
  module Ats
    class PaginatedJobPostingList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Ats::JobPosting>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::JobPosting>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ats::PaginatedJobPostingList]
      ...
      # Deserialize a JSON object to an instance of PaginatedJobPostingList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::JobPosting.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedJobPostingList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
