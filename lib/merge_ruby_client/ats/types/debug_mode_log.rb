...
module Merge
  module Ats
    class DebugModeLog
      ...
      # @return [Merge::Ats::DebugModelLogSummary]
      ...
      # @param log_summary [Merge::Ats::DebugModelLogSummary]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ats::DebugModeLog]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["log_summary"].nil?
          ...
          log_summary = Merge::Ats::DebugModelLogSummary.from_json(json_object: log_summary)
        end
        new(
          log_id: log_id,
          dashboard_view: dashboard_view,
      ...
      def self.validate_raw(obj:)
        ...
        Merge::Ats::DebugModelLogSummary.validate_raw(obj: obj.log_summary)
      end
    end
  end
end
