...
module Merge
  module Ats
    ...
    class ScreeningQuestion
      attr_reader :id, :remote_id, :job, :description, :title, :type, :required, :options, :created_at, :modified_at,
      ...
      # @param type [TYPE_ENUM] The data type for the screening question.
      #   - `DATE` - DATE
      #   - `FILE` - FILE
      ...
      def initialize(id: nil, remote_id: nil, job: nil, description: nil, title: nil, type: nil, required: nil,
                     options: nil, created_at: nil, modified_at: nil, additional_properties: nil)
        # @type [String]
        @id = id
        ...
        @title = title
        # @type [TYPE_ENUM] The data type for the screening question.
        #   - `DATE` - DATE
        #   - `FILE` - FILE
        #   - `SINGLE_SELECT` - SINGLE_SELECT
        #   - `MULTI_SELECT` - MULTI_SELECT
      ...
      def self.from_json(json_object:)
        ...
        title = struct.title
        type = Ats::TYPE_ENUM.key(parsed_json["type"]) || parsed_json["type"]
        required = struct.required
        options = struct.options
        created_at = (DateTime.parse(parsed_json["created_at"]) unless parsed_json["created_at"].nil?)
        modified_at = (DateTime.parse(parsed_json["modified_at"]) unless parsed_json["modified_at"].nil?)
        new(id: id, remote_id: remote_id, job: job, description: description, title: title, type: type,
            required: required, options: options, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ats::TYPE_ENUM) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
