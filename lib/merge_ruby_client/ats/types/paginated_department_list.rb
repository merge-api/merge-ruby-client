...
module Merge
  module Ats
    class PaginatedDepartmentList
      ...
      # @return [Array<Merge::Ats::Department>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ats::Department>]
      ...
      # Deserialize a JSON object to an instance of PaginatedDepartmentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ats::Department.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedDepartmentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
