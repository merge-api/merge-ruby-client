...
module Merge
  module Ats
    class AuditLogEvent
      ...
      # @param role [Ats::AuditLogEventRole] Designates the role of the user (or SYSTEM/API if action not taken by a user) at the time of this Event occurring.
      #   - `ADMIN` - ADMIN
      #   - `DEVELOPER` - DEVELOPER
      #   - `MEMBER` - MEMBER
      #   - `API` - API
      ...
      # @param event_type [Ats::AuditLogEventEventType] Designates the type of event that occurred.
