...
module Merge
  module Ats
    class AuditTrailClient
      ...
      # @return [Ats::PaginatedAuditLogEventList]
      def list(cursor: nil, end_date: nil, event_type: nil, page_size: nil, start_date: nil, user_email: nil,
               request_options: nil)
        response = @request_client.conn.get("/api/ats/v1/audit-trail") do |req|
        ...
        Ats::PaginatedAuditLogEventList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncAuditTrailClient
      ...
      # @return [Ats::AsyncAuditTrailClient]
      def initialize(request_client:)
