...
module Merge
  module Ats
    class AvailableActionsClient
      ...
      #  )
      #  api.ats.available_actions.retrieve
      def retrieve(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ats/v1/available-actions"
        end
        Merge::Ats::AvailableActions.from_json(json_object: response.body)
      end
    end
