  ...
  module Ats
    class TagsClient
      ...
      def list(created_after: nil, created_before: nil, cursor: nil, include_deleted_data: nil,
        ...
        response = @request_client.conn.get("/api/ats/v1/tags") do |req|
        ...
        Ats::PaginatedTagList.from_json(json_object: response.body)
      end
    end
