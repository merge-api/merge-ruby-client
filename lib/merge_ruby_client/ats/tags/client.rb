...
module Merge
  module Ats
    class TagsClient
      ...
      #  )
      #  api.ats.tags.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(created_after: nil, created_before: nil, cursor: nil, include_deleted_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ats/v1/tags"
        end
        Merge::Ats::PaginatedTagList.from_json(json_object: response.body)
      end
    end
