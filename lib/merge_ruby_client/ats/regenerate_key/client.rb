...
module Merge
  module Ats
    class RegenerateKeyClient
      ...
      #  )
      #  api.ats.regenerate_key.create(name: "Remote Deployment Key 1")
      def create(name:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ats/v1/regenerate-key"
        end
        Merge::Ats::RemoteKey.from_json(json_object: response.body)
      end
    end
