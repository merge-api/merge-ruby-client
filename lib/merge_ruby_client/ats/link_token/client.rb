...
module Merge
  module Ats
    class LinkTokenClient
      ...
      #  unique identifiers.
      # @param categories [Array<Merge::Ats::CategoriesEnum>] The integration categories to show in Merge Link.
      ...
      #  given Linked Account.Request of type Array<Merge::Ats::CommonModelScopesBodyRequest>, as a Hash
      #   * :model_id (String)
      ...
      # @param language [Merge::Ats::LanguageEnum] The following subset of IETF language tags can be used to configure
      #  localization.
      #  * `en` - en
      #  * `de` - de
      ...
      # @param completed_account_initial_screen [Merge::Ats::COMPLETED_ACCOUNT_INITIAL_SCREEN_ENUM] When creating a Link token, you can specifiy the initial screen of Linking Flow
      ...
      def create(end_user_email_address:, end_user_organization_name:, end_user_origin_id:, categories:,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ats/v1/link-token"
        end
        Merge::Ats::LinkToken.from_json(json_object: response.body)
      end
    end
