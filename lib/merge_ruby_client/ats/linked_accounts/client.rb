...
module Merge
  module Ats
    class LinkedAccountsClient
      ...
      # @return [Ats::LinkedAccountsClient]
      ...
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        response = @request_client.conn.get("/api/ats/v1/linked-accounts") do |req|
        ...
        Ats::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncLinkedAccountsClient
      ...
      # @return [Ats::AsyncLinkedAccountsClient]
      def initialize(request_client:)
