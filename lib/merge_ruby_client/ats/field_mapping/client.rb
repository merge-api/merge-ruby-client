...
module Merge
  module Ats
    class FieldMappingClient
      ...
      #  )
      #  api.ats.field_mappings_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.ats.field_mappings_destroy(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.ats.field_mappings_partial_update(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.ats.remote_fields_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.ats.target_fields_retrieve
