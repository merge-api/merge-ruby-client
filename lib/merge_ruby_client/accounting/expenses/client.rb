...
require "date"
require_relative "types/list_expenses_request_expand"
...
require_relative "types/retrieve_expenses_request_expand"
...
module Merge
  module Accounting
    class ExpensesClient
      ...
      #  BEGIN_ACCOUNTING_EXPENSE_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  N2oqOck2vkrF/KvYiAKOf4AxXg///+8xP9l/kL7naqe18f2tqOn6CvvxvRiAnv88T+d5SsJIhMAAA=="
      #  /></Footer>{/* END_ACCOUNTING_EXPENSE_FETCH_SUPPORTED_FIELDS * /}
      #
      ...
      # @param expand [Merge::Accounting::Expenses::ListExpensesRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      ...
      #  )
      #  api.accounting.expenses.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      ...
      #  BEGIN_ACCOUNTING_EXPENSE_CREATE_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="POST"
      #  Ub+zZv9BbU6TJMzJfcPvCblQ2CvqVwykRo+RaqG2TV+ss+vGwSveAxKTP9PHNx//w+tOqVOAg0AAA=="
      #  /></Footer>{/* END_ACCOUNTING_EXPENSE_CREATE_SUPPORTED_FIELDS * /}
      #
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.expenses.create(model: {  })
      ...
      #
      # @param id [String]
      # @param expand [Merge::Accounting::Expenses::RetrieveExpensesRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      #  should be comma separated without spaces.
      # @param include_remote_data [Boolean] Whether to include the original data Merge fetched from the third-party to
      #  produce these models.
      # @param include_remote_fields [Boolean] Whether to include all remote fields, including fields that Merge did not map to
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.expenses.retrieve(id: "id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.expenses.lines_remote_field_classes_list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def lines_remote_field_classes_list(cursor: nil, include_deleted_data: nil, include_remote_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/expenses/lines/remote-field-classes"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.expenses.meta_post_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.expenses.remote_field_classes_list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def remote_field_classes_list(cursor: nil, include_deleted_data: nil, include_remote_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/expenses/remote-field-classes"
        end
        Merge::Accounting::PaginatedRemoteFieldClassList.from_json(json_object: response.body)
      end
    end
