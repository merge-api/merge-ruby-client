...
module Merge
  module Accounting
    class CompanyInfoClient
      ...
      #  )
      #  api.accounting.company_info.list
      def list(created_after: nil, created_before: nil, cursor: nil, expand: nil, include_deleted_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/company-info"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.company_info.retrieve(id: "id")
      def retrieve(id:, expand: nil, include_remote_data: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/company-info/#{id}"
        end
        Merge::Accounting::CompanyInfo.from_json(json_object: response.body)
      end
    end
