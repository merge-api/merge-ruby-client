...
require "date"
require_relative "types/list_general_ledger_transactions_request_expand"
require_relative "../types/paginated_general_ledger_transaction_list"
require_relative "types/retrieve_general_ledger_transactions_request_expand"
...
module Merge
  module Accounting
    class GeneralLedgerTransactionsClient
      ...
      #  BEGIN_ACCOUNTING_GENERALLEDGERTRANSACTION_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  SPhqyS+znD7M8PtKGBfUauXES7PFOz1f9d9UIt/35f720l7Uff/+eX3u79ONeub6fbHP7T+c6t5FAAA"
      #  /></Footer>{/* END_ACCOUNTING_GENERALLEDGERTRANSACTION_FETCH_SUPPORTED_FIELDS *
      #  /}
      #
      ...
      # @param expand [Merge::Accounting::GeneralLedgerTransactions::ListGeneralLedgerTransactionsRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      ...
      #  )
      #  api.accounting.general_ledger_transactions.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      ...
      #
      # @param id [String]
      # @param expand [Merge::Accounting::GeneralLedgerTransactions::RetrieveGeneralLedgerTransactionsRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      #  should be comma separated without spaces.
      # @param include_remote_data [Boolean] Whether to include the original data Merge fetched from the third-party to
      #  produce these models.
      # @param include_shell_data [Boolean] Whether to include shell records. Shell records are empty records (they may
