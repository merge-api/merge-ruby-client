...
require_relative "../types/paginated_payment_method_list"
    ...
    class PaymentMethodsClient
      ...
      def list(cursor: nil, include_deleted_data: nil, include_remote_data: nil, include_shell_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/payment-methods"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.payment_methods.retrieve(id: "id")
      def retrieve(id:, include_remote_data: nil, include_shell_data: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/payment-methods/#{id}"
        end
        Merge::Accounting::PaymentMethod.from_json(json_object: response.body)
      end
    end
