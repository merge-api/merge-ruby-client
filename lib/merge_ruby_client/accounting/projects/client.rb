...
require "date"
require_relative "types/list_projects_request_expand"
require_relative "../types/paginated_project_list"
require_relative "types/retrieve_projects_request_expand"
...
module Merge
  module Accounting
    class ProjectsClient
      ...
      #  BEGIN_ACCOUNTING_PROJECT_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  z353GpU/5Gj/72PI4ix1HNjKObwDhY6ItsT2Whn4molqGnAx/uWv2KNDvvhLbx/+gnzVwVQoQcAAA=="
      #  /></Footer>{/* END_ACCOUNTING_PROJECT_FETCH_SUPPORTED_FIELDS * /}
      #
      ...
      # @param expand [Merge::Accounting::Projects::ListProjectsRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      ...
      #
      # @param id [String]
      # @param expand [Merge::Accounting::Projects::RetrieveProjectsRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      #  should be comma separated without spaces.
      # @param include_remote_data [Boolean] Whether to include the original data Merge fetched from the third-party to
      #  produce these models.
      # @param include_shell_data [Boolean] Whether to include shell records. Shell records are empty records (they may
