...
module Merge
  module Accounting
    class TaxRatesClient
      ...
      # @return [Accounting::TaxRatesClient]
      ...
      # @return [Accounting::PaginatedTaxRateList]
      def list(company_id: nil, created_after: nil, created_before: nil, cursor: nil, expand: nil,
        ...
        response = @request_client.conn.get("/api/accounting/v1/tax-rates") do |req|
        ...
        Accounting::PaginatedTaxRateList.from_json(json_object: response.body)
      end
      ...
      def retrieve(id:, expand: nil, include_remote_data: nil, request_options: nil)
        response = @request_client.conn.get("/api/accounting/v1/tax-rates/#{id}") do |req|
          req.options.timeout = request_options.timeout_in_seconds unless request_options&.timeout_in_seconds.nil?
          req.headers["Authorization"] = request_options.api_key unless request_options&.api_key.nil?
          req.headers["X-Account-Token"] = request_options.account_token unless request_options&.account_token.nil?
          req.headers = { **req.headers, **(request_options&.additional_headers || {}) }.compact
        ...
        Accounting::TaxRate.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncTaxRatesClient
      ...
      # @return [Accounting::AsyncTaxRatesClient]
      def initialize(request_client:)
