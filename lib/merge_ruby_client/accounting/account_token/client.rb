...
module Merge
  module Accounting
    class AccountTokenClient
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.account_token.regenerate_create
      def regenerate_create(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/account-token/regenerate"
        end
        Merge::Accounting::RegenerateAccountToken.from_json(json_object: response.body)
      end
    end
