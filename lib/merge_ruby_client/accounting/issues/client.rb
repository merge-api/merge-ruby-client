...
module Merge
  module Accounting
    class IssuesClient
      ...
      #  this time
      # @param status [Merge::Accounting::Issues::IssuesListRequestStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      ...
      #  )
      #  api.accounting.issues.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
