...
module Merge
  module Accounting
    class CashFlowStatementsClient
      ...
      #  )
      #  api.accounting.cash_flow_statements.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.cash_flow_statements.retrieve(id: "id")
