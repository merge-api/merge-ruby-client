...
module Merge
  module Accounting
    class LinkedAccountsClient
      ...
      # @return [Accounting::LinkedAccountsClient]
      ...
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        response = @request_client.conn.get("/api/accounting/v1/linked-accounts") do |req|
        ...
        Accounting::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncLinkedAccountsClient
      ...
      # @return [Accounting::AsyncLinkedAccountsClient]
      def initialize(request_client:)
