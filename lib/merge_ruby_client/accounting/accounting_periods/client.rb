...
module Merge
  module Accounting
    class AccountingPeriodsClient
      ...
      #  BEGIN_ACCOUNTING_PERIOD_FETCH_SUPPORTED_FIELDS * /}{/*
      #  END_ACCOUNTING_PERIOD_FETCH_SUPPORTED_FIELDS * /}
      #
      ...
      #  )
      #  api.accounting.accounting_periods.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
