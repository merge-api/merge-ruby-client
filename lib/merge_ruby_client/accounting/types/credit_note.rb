    ...
    class CreditNote
      ...
      def self.from_json(json_object:)
        ...
        line_items = parsed_json["line_items"]&.map do |v|
          v = v.to_json
          Merge::Accounting::CreditNoteLineItem.from_json(json_object: v)
        end
        tracking_categories = parsed_json["tracking_categories"]&.map do |v|
          v = v.to_json
          Merge::Accounting::CreditNoteTrackingCategoriesItem.from_json(json_object: v)
        end
        ...
        payments = parsed_json["payments"]&.map do |v|
          v = v.to_json
          Merge::Accounting::CreditNotePaymentsItem.from_json(json_object: v)
        end
        applied_payments = parsed_json["applied_payments"]&.map do |v|
          v = v.to_json
          Merge::Accounting::CreditNoteAppliedPaymentsItem.from_json(json_object: v)
        end
