...
module Merge
  module Accounting
    class PaginatedIssueList
      ...
      # @return [Array<Merge::Accounting::Issue>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::Issue>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Accounting::PaginatedIssueList]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::Issue.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
