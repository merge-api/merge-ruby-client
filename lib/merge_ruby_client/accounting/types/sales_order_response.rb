...
module Merge
  module Accounting
    class SalesOrderResponse
      ...
      # @param model [Merge::Accounting::SalesOrder]
      ...
      # @return [Merge::Accounting::SalesOrderResponse]
      ...
      # Deserialize a JSON object to an instance of SalesOrderResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::SalesOrder.from_json(json_object: model)
        end
      ...
      # Serialize an instance of SalesOrderResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::SalesOrder.validate_raw(obj: obj.model)
