...
module Merge
  module Accounting
    ...
    class DataPassthroughRequest
      ...
      # @param method [Merge::Accounting::MethodEnum]
      ...
      def self.validate_raw(obj:)
        obj.method.is_a?(Merge::Accounting::MethodEnum) != false || raise("Passed value for field obj.method is not the expected type, validation failed.")
