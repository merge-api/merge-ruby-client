...
module Merge
  module Accounting
    ...
    class Transaction
      attr_reader :transaction_type, :number, :transaction_date, :account, :contact, :total_amount, :currency,
                  :exchange_rate, :company, :tracking_categories, :line_items, :remote_was_deleted, :accounting_period, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      # @param currency [CURRENCY_ENUM] The transaction's currency.
      ...
      def initialize(transaction_type: nil, number: nil, transaction_date: nil, account: nil, contact: nil,
                     total_amount: nil, currency: nil, exchange_rate: nil, company: nil, tracking_categories: nil, line_items: nil, remote_was_deleted: nil, accounting_period: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        ...
        # @type [CURRENCY_ENUM] The transaction's currency.
        #   - `XUA` - ADB Unit of Account
        #   - `AFN` - Afghan Afghani
        #   - `AFA` - Afghan Afghani (1927–2002)
        #   - `ALL` - Albanian Lek
      ...
      def self.from_json(json_object:)
        ...
        new(transaction_type: transaction_type, number: number, transaction_date: transaction_date, account: account,
            contact: contact, total_amount: total_amount, currency: currency, exchange_rate: exchange_rate, company: company, tracking_categories: tracking_categories, line_items: line_items, remote_was_deleted: remote_was_deleted, accounting_period: accounting_period, id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
