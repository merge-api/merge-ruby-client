...
module Merge
  module Accounting
    class MetaResponse
      ...
      # @return [Merge::Accounting::LinkedAccountStatus]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Accounting::LinkedAccountStatus]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["status"].nil?
          ...
          status = Merge::Accounting::LinkedAccountStatus.from_json(json_object: status)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Merge::Accounting::LinkedAccountStatus.validate_raw(obj: obj.status)
