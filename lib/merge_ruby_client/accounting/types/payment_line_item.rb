...
module Merge
  module Accounting
    ...
    class PaymentLineItem
      attr_reader :applied_amount, :applied_date, :remote_id, :related_object_id, :related_object_type, :id,
                  :created_at, :modified_at, :additional_properties
      ...
      def initialize(applied_amount: nil, applied_date: nil, remote_id: nil, related_object_id: nil,
                     related_object_type: nil, id: nil, created_at: nil, modified_at: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(applied_amount: applied_amount, applied_date: applied_date, remote_id: remote_id,
            related_object_id: related_object_id, related_object_type: related_object_type, id: id, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
