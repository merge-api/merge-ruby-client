...
module Merge
  module Accounting
    class CommonModelScopesBodyRequest
      ...
      # @return [Array<Merge::Accounting::EnabledActionsEnum>]
      ...
      # @param enabled_actions [Array<Merge::Accounting::EnabledActionsEnum>]
      # @param disabled_fields [Array<String>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Accounting::CommonModelScopesBodyRequest]
