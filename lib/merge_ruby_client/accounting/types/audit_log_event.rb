...
module Merge
  module Accounting
    class AuditLogEvent
      ...
      # @return [Merge::Accounting::RoleEnum] Designates the role of the user (or SYSTEM/API if action not taken by a user) at
      ...
      # @return [Merge::Accounting::EventTypeEnum] Designates the type of event that occurred.
      ...
      # @param role [Merge::Accounting::RoleEnum] Designates the role of the user (or SYSTEM/API if action not taken by a user) at
      #  the time of this Event occurring.
      #  - `ADMIN` - ADMIN
      #  - `DEVELOPER` - DEVELOPER
      #  - `MEMBER` - MEMBER
      ...
      # @return [Merge::Accounting::AuditLogEvent]
      ...
      def self.validate_raw(obj:)
        ...
        obj.role.is_a?(Merge::Accounting::RoleEnum) != false || raise("Passed value for field obj.role is not the expected type, validation failed.")
        obj.ip_address.is_a?(String) != false || raise("Passed value for field obj.ip_address is not the expected type, validation failed.")
        obj.event_type.is_a?(Merge::Accounting::EventTypeEnum) != false || raise("Passed value for field obj.event_type is not the expected type, validation failed.")
