...
require_relative "bank_feed_transaction"
require "ostruct"
require "json"

module Merge
  module Accounting
    class PaginatedBankFeedTransactionList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Accounting::BankFeedTransaction>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::BankFeedTransaction>]
      ...
      # Deserialize a JSON object to an instance of PaginatedBankFeedTransactionList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::BankFeedTransaction.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedBankFeedTransactionList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
