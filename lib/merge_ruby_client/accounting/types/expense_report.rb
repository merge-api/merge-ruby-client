...
module Merge
  module Accounting
    ...
    class ExpenseReport
      ...
      # @param lines [Array<Merge::Accounting::ExpenseReportLine>]
      ...
      def initialize(tracking_categories:, id: OMIT, remote_id: OMIT, created_at: OMIT, modified_at: OMIT, report_date: OMIT,
                     report_identifier: OMIT, employee: OMIT, status: OMIT, total_amount: OMIT, lines: OMIT, currency: OMIT, description: OMIT, accounting_period: OMIT, company: OMIT, remote_was_deleted: OMIT, field_mappings: OMIT, remote_data: OMIT, remote_fields: OMIT, additional_properties: nil)
        @id = id if id != OMIT
      ...
      # Deserialize a JSON object to an instance of ExpenseReport
      #
      ...
      # Serialize an instance of ExpenseReport to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
