...
module Merge
  module Accounting
    class ExternalTargetFieldApiResponse
      ...
      # @param account [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param accounting_attachment [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param balance_sheet [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param cash_flow_statement [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param company_info [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param contact [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param income_statement [Array<Merge::Accounting::ExternalTargetFieldApi>]
      ...
      # @param invoice [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param payment [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param expense [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param vendor_credit [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param transaction [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param accounting_period [Array<Merge::Accounting::ExternalTargetFieldApi>]
      # @param general_ledger_transaction [Array<Merge::Accounting::ExternalTargetFieldApi>]
