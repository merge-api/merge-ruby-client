...
module Merge
  module Accounting
    class CommonModelScopeApi
      # @return [Array<Merge::Accounting::IndividualCommonModelScopeDeserializer>] The common models you want to update the scopes for
      ...
      # @param common_models [Array<Merge::Accounting::IndividualCommonModelScopeDeserializer>] The common models you want to update the scopes for
