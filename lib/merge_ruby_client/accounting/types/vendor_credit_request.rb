...
module Merge
  module Accounting
    ...
    class VendorCreditRequest
      ...
      def initialize(number: OMIT, transaction_date: OMIT, vendor: OMIT, total_amount: OMIT, currency: OMIT,
                     exchange_rate: OMIT, inclusive_of_tax: OMIT, company: OMIT, tracking_categories: OMIT, applied_to_lines: OMIT, accounting_period: OMIT, integration_params: OMIT, linked_account_params: OMIT, additional_properties: nil)
