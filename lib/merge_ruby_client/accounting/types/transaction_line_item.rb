...
module Merge
  module Accounting
    ...
    class TransactionLineItem
      attr_reader :remote_id, :memo, :unit_price, :quantity, :item, :account, :tracking_category, :tracking_categories,
                  :total_line_amount, :tax_rate, :currency, :exchange_rate, :company, :remote_was_deleted, :id, :created_at, :modified_at, :additional_properties
      ...
      # @param currency [Accounting::TransactionLineItemCurrency] The line item's currency.
      ...
      def initialize(tracking_categories:, remote_id: nil, memo: nil, unit_price: nil, quantity: nil, item: nil, account: nil,
                     tracking_category: nil, total_line_amount: nil, tax_rate: nil, currency: nil, exchange_rate: nil, company: nil, remote_was_deleted: nil, id: nil, created_at: nil, modified_at: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(remote_id: remote_id, memo: memo, unit_price: unit_price, quantity: quantity, item: item, account: account,
