...
module Merge
  module Accounting
    class PaginatedRemoteFieldClassList
      ...
      # @return [Array<Merge::Accounting::RemoteFieldClass>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::RemoteFieldClass>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::RemoteFieldClass.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
