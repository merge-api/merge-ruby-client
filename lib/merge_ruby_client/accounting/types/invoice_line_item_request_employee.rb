...
module Merge
  module Accounting
    ...
    class InvoiceLineItemRequestEmployee
      # Deserialize a JSON object to an instance of InvoiceLineItemRequestEmployee
      #
      # @param json_object [String]
      # @return [Merge::Accounting::InvoiceLineItemRequestEmployee]
