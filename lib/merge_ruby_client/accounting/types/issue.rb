...
module Merge
  module Accounting
    class Issue
      # @return [String]
      attr_reader :id
      # @return [Merge::Accounting::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      attr_reader :status
      # @return [String]
      ...
      # @param id [String]
      # @param status [Merge::Accounting::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Merge::Accounting::IssueStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
