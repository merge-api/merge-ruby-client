...
module Merge
  module Accounting
    class PaginatedInvoiceList
      ...
      # @return [Array<Merge::Accounting::Invoice>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::Invoice>]
      ...
      # Deserialize a JSON object to an instance of PaginatedInvoiceList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::Invoice.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedInvoiceList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
