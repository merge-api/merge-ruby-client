...
module Merge
  module Accounting
    class JournalEntryResponse
      ...
      # @param model [Merge::Accounting::JournalEntry]
      ...
      # Deserialize a JSON object to an instance of JournalEntryResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::JournalEntry.from_json(json_object: model)
        end
      ...
      # Serialize an instance of JournalEntryResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::JournalEntry.validate_raw(obj: obj.model)
