...
require_relative "general_ledger_transaction"
require "ostruct"
require "json"

module Merge
  module Accounting
    class PaginatedGeneralLedgerTransactionList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Accounting::GeneralLedgerTransaction>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::GeneralLedgerTransaction>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::GeneralLedgerTransaction.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedGeneralLedgerTransactionList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
