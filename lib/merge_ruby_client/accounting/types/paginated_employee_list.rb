...
module Merge
  module Accounting
    class PaginatedEmployeeList
      ...
      # @return [Array<Merge::Accounting::Employee>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::Employee>]
      ...
      # Deserialize a JSON object to an instance of PaginatedEmployeeList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::Employee.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedEmployeeList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
