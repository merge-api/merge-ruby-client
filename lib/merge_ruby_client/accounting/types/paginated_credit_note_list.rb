...
module Merge
  module Accounting
    class PaginatedCreditNoteList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Accounting::CreditNote>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::CreditNote>]
      ...
      # Deserialize a JSON object to an instance of PaginatedCreditNoteList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::CreditNote.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedCreditNoteList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
