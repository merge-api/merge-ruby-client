...
module Merge
  module Accounting
    class PaginatedBalanceSheetList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Accounting::BalanceSheet>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::BalanceSheet>]
      ...
      # Deserialize a JSON object to an instance of PaginatedBalanceSheetList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::BalanceSheet.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedBalanceSheetList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
