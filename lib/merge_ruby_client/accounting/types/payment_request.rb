...
module Merge
  module Accounting
    ...
    class PaymentRequest
      ...
      # @return [Merge::Accounting::PaymentRequestContact] The supplier, or customer involved in the payment.
      attr_reader :contact
      ...
      # @return [Merge::Accounting::PaymentRequestCompany] The company the payment belongs to.
      attr_reader :company
      ...
      # @return [Array<Merge::Accounting::PaymentRequestAppliedToLinesItem>] A list of “Payment Applied to Lines” objects.
      ...
      def self.from_json(json_object:)
        ...
        applied_to_lines = parsed_json["applied_to_lines"]&.map do |v|
          v = v.to_json
          Merge::Accounting::PaymentRequestAppliedToLinesItem.from_json(json_object: v)
        end
