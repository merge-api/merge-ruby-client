...
require_relative "vendor_credit"
...
module Merge
  module Accounting
    class VendorCreditResponse
      ...
      # @param model [Merge::Accounting::VendorCredit]
      ...
      # Deserialize a JSON object to an instance of VendorCreditResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::VendorCredit.from_json(json_object: model)
        end
      ...
      # Serialize an instance of VendorCreditResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::VendorCredit.validate_raw(obj: obj.model)
