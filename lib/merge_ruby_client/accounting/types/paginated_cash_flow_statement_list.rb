...
module Merge
  module Accounting
    class PaginatedCashFlowStatementList
      ...
      # @return [Array<Merge::Accounting::CashFlowStatement>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::CashFlowStatement>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::CashFlowStatement.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
