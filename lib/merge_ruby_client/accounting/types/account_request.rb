...
module Merge
  module Accounting
    ...
    class AccountRequest
      ...
      # @param classification [CLASSIFICATION_ENUM] The account's broadest grouping.
      #   - `ASSET` - ASSET
      #   - `EQUITY` - EQUITY
      #   - `EXPENSE` - EXPENSE
      #   - `LIABILITY` - LIABILITY
      ...
      # @param status [ACCOUNT_STATUS_ENUM] The account's status.
      #   - `ACTIVE` - ACTIVE
      #   - `PENDING` - PENDING
      #   - `INACTIVE` - INACTIVE
      # @param current_balance [Float] The account's current balance.
      # @param currency [CURRENCY_ENUM] The account's currency.
      ...
      def initialize(name: nil, description: nil, classification: nil, type: nil, status: nil, current_balance: nil,
        ...
        # @type [CLASSIFICATION_ENUM] The account's broadest grouping.
        #   - `ASSET` - ASSET
        #   - `EQUITY` - EQUITY
        #   - `EXPENSE` - EXPENSE
        #   - `LIABILITY` - LIABILITY
        ...
        @type = type
        # @type [ACCOUNT_STATUS_ENUM] The account's status.
        #   - `ACTIVE` - ACTIVE
        #   - `PENDING` - PENDING
        #   - `INACTIVE` - INACTIVE
        @status = status
        ...
        # @type [CURRENCY_ENUM] The account's currency.
        #   - `XUA` - ADB Unit of Account
        #   - `AFN` - Afghan Afghani
        #   - `AFA` - Afghan Afghani (1927–2002)
        #   - `ALL` - Albanian Lek
      ...
      def self.from_json(json_object:)
        ...
        classification = Accounting::CLASSIFICATION_ENUM.key(parsed_json["classification"]) || parsed_json["classification"]
        type = struct.type
        status = Accounting::ACCOUNT_STATUS_ENUM.key(parsed_json["status"]) || parsed_json["status"]
      ...
      def to_json(*_args)
        {
          "name": @name,
          "description": @description,
          "classification": Accounting::CLASSIFICATION_ENUM[@classification] || @classification,
          "type": @type,
          "status": Accounting::ACCOUNT_STATUS_ENUM[@status] || @status,
          "current_balance": @current_balance,
      ...
      def self.validate_raw(obj:)
        ...
        obj.classification&.is_a?(Accounting::CLASSIFICATION_ENUM) != false || raise("Passed value for field obj.classification is not the expected type, validation failed.")
        obj.type&.is_a?(String) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
        obj.status&.is_a?(Accounting::ACCOUNT_STATUS_ENUM) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
