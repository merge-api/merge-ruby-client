...
require_relative "account_request_classification"
require_relative "account_request_status"
require_relative "account_request_currency"
require "json"
...
module Merge
  module Accounting
    ...
    class AccountRequest
      attr_reader :name, :description, :classification, :type, :status, :current_balance, :currency, :account_number,
                  :parent_account, :company, :integration_params, :linked_account_params, :additional_properties

      # @param name [String] The account's name.
      # @param description [String] The account's description.
      # @param classification [Accounting::AccountRequestClassification] The account's broadest grouping.
      #   - `ASSET` - ASSET
      #   - `EQUITY` - EQUITY
      #   - `EXPENSE` - EXPENSE
      #   - `LIABILITY` - LIABILITY
      ...
      # @param status [Accounting::AccountRequestStatus] The account's status.
      #   - `ACTIVE` - ACTIVE
      #   - `PENDING` - PENDING
      #   - `INACTIVE` - INACTIVE
      # @param current_balance [Float] The account's current balance.
      # @param currency [Accounting::AccountRequestCurrency] The account's currency.
      ...
      # @return [Accounting::AccountRequest]
      def initialize(name: nil, description: nil, classification: nil, type: nil, status: nil, current_balance: nil,
                     currency: nil, account_number: nil, parent_account: nil, company: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
        # @type [String] The account's name.
        @name = name
        # @type [String] The account's description.
        @description = description
        # @type [Accounting::AccountRequestClassification] The account's broadest grouping.
        #   - `ASSET` - ASSET
        #   - `EQUITY` - EQUITY
        #   - `EXPENSE` - EXPENSE
        #   - `LIABILITY` - LIABILITY
        ...
        @type = type
        # @type [Accounting::AccountRequestStatus] The account's status.
        #   - `ACTIVE` - ACTIVE
        #   - `PENDING` - PENDING
        #   - `INACTIVE` - INACTIVE
        @status = status
        ...
        # @type [Accounting::AccountRequestCurrency] The account's currency.
        #   - `XUA` - ADB Unit of Account
        #   - `AFN` - Afghan Afghani
        #   - `AFA` - Afghan Afghani (1927–2002)
        #   - `ALL` - Albanian Lek
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["classification"].nil?
          classification = nil
        else
          classification = parsed_json["classification"].to_json
          classification = Accounting::AccountRequestClassification.from_json(json_object: classification)
        end
        type = struct.type
        if parsed_json["status"].nil?
          ...
          status = Accounting::AccountRequestStatus.from_json(json_object: status)
        end
        ...
        if parsed_json["currency"].nil?
          ...
          currency = Accounting::AccountRequestCurrency.from_json(json_object: currency)
        end
        ...
        new(name: name, description: description, classification: classification, type: type, status: status,
            current_balance: current_balance, currency: currency, account_number: account_number, parent_account: parent_account, company: company, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.classification.nil? || Accounting::AccountRequestClassification.validate_raw(obj: obj.classification)
        obj.type&.is_a?(String) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
        obj.status.nil? || Accounting::AccountRequestStatus.validate_raw(obj: obj.status)
        ...
        obj.currency.nil? || Accounting::AccountRequestCurrency.validate_raw(obj: obj.currency)
