...
module Merge
  module Accounting
    ...
    class Account
      attr_reader :id, :remote_id, :name, :description, :classification, :type, :status, :current_balance, :currency,
                  :account_number, :parent_account, :company, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      def initialize(id: nil, remote_id: nil, name: nil, description: nil, classification: nil, type: nil, status: nil,
                     current_balance: nil, currency: nil, account_number: nil, parent_account: nil, company: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, description: description, classification: classification,
            type: type, status: status, current_balance: current_balance, currency: currency, account_number: account_number, parent_account: parent_account, company: company, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
