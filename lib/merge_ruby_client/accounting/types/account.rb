...
module Merge
  module Accounting
    ...
    class Account
      ...
      # @param classification [Accounting::AccountClassification] The account's broadest grouping.
      #   - `ASSET` - ASSET
      #   - `EQUITY` - EQUITY
      #   - `EXPENSE` - EXPENSE
      #   - `LIABILITY` - LIABILITY
      ...
      # @param status [Accounting::AccountStatus] The account's status.
      #   - `ACTIVE` - ACTIVE
      #   - `PENDING` - PENDING
      #   - `INACTIVE` - INACTIVE
      # @param current_balance [Float] The account's current balance.
      # @param currency [Accounting::AccountCurrency] The account's currency.
