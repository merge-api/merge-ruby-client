...
module Merge
  module Accounting
    # # The Invoice Object
    #  ### Description
    #  The `Invoice` object represents an itemized record of goods and/or services
    #  sold to a customer.
    ...
    class InvoiceRequest
      ...
      def initialize(type: OMIT, contact: OMIT, number: OMIT, issue_date: OMIT, due_date: OMIT, paid_on_date: OMIT,
                     memo: OMIT, status: OMIT, company: OMIT, currency: OMIT, exchange_rate: OMIT, total_discount: OMIT, sub_total: OMIT, total_tax_amount: OMIT, total_amount: OMIT, balance: OMIT, payments: OMIT, tracking_categories: OMIT, line_items: OMIT, purchase_orders: OMIT, integration_params: OMIT, linked_account_params: OMIT, additional_properties: nil)
