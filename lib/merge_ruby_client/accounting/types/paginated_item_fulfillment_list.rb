...
require_relative "item_fulfillment"
require "ostruct"
require "json"

module Merge
  module Accounting
    class PaginatedItemFulfillmentList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Accounting::ItemFulfillment>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::ItemFulfillment>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Accounting::PaginatedItemFulfillmentList]
      ...
      # Deserialize a JSON object to an instance of PaginatedItemFulfillmentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::ItemFulfillment.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedItemFulfillmentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
