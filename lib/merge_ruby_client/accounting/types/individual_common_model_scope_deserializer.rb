...
require_relative "field_permission_deserializer"
require "ostruct"
require "json"
...
module Merge
  module Accounting
    class IndividualCommonModelScopeDeserializer
      ...
      # @return [Hash{String => Merge::Accounting::ModelPermissionDeserializer}]
      attr_reader :model_permissions
      # @return [Merge::Accounting::FieldPermissionDeserializer]
      ...
      # @param model_permissions [Hash{String => Merge::Accounting::ModelPermissionDeserializer}]
      # @param field_permissions [Merge::Accounting::FieldPermissionDeserializer]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Accounting::IndividualCommonModelScopeDeserializer]
      ...
      def self.from_json(json_object:)
        ...
        model_permissions = parsed_json["model_permissions"]&.transform_values do |value|
          value = value.to_json
          Merge::Accounting::ModelPermissionDeserializer.from_json(json_object: value)
        end
        if parsed_json["field_permissions"].nil?
          field_permissions = nil
        else
          field_permissions = parsed_json["field_permissions"].to_json
          field_permissions = Merge::Accounting::FieldPermissionDeserializer.from_json(json_object: field_permissions)
        end
        new(
          model_name: model_name,
          model_permissions: model_permissions,
      ...
      # Serialize an instance of IndividualCommonModelScopeDeserializer to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_permissions.nil? || Merge::Accounting::FieldPermissionDeserializer.validate_raw(obj: obj.field_permissions)
      end
    end
  end
end
