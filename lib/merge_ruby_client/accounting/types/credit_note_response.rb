...
module Merge
  module Accounting
    class CreditNoteResponse
      ...
      # @param model [Merge::Accounting::CreditNote]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::CreditNote.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::CreditNote.validate_raw(obj: obj.model)
