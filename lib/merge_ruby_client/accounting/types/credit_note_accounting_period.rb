...
module Merge
  module Accounting
    ...
    class CreditNoteAccountingPeriod
      # Deserialize a JSON object to an instance of CreditNoteAccountingPeriod
      #
      # @param json_object [String]
      # @return [Merge::Accounting::CreditNoteAccountingPeriod]
