...
module Merge
  module Accounting
    class PurchaseOrderResponse
      ...
      # @param model [Accounting::PurchaseOrder]
      ...
      # Deserialize a JSON object to an instance of PurchaseOrderResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Accounting::PurchaseOrder.from_json(json_object: model)
        end
      ...
      # Serialize an instance of PurchaseOrderResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
      ...
      def self.validate_raw(obj:)
        Accounting::PurchaseOrder.validate_raw(obj: obj.model)
