...
module Merge
  module Accounting
    class PurchaseOrderResponse
      ...
      # @param model [Merge::Accounting::PurchaseOrder]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::PurchaseOrder.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::PurchaseOrder.validate_raw(obj: obj.model)
