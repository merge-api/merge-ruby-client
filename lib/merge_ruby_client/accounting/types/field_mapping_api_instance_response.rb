...
module Merge
  module Accounting
    class FieldMappingApiInstanceResponse
      ...
      # @param sales_order [Array<Merge::Accounting::FieldMappingApiInstance>]
      # @param item_fulfillment [Array<Merge::Accounting::FieldMappingApiInstance>]
      ...
      # @param accounting_period [Array<Merge::Accounting::FieldMappingApiInstance>]
