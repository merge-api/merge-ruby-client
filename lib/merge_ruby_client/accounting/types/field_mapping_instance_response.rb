...
module Merge
  module Accounting
    class FieldMappingInstanceResponse
      ...
      # @param model [Merge::Accounting::FieldMappingApiInstance]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::FieldMappingApiInstance.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::FieldMappingApiInstance.validate_raw(obj: obj.model)
