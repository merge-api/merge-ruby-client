...
module Merge
  module Accounting
    class PaginatedPaymentTermList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Accounting::PaymentTerm>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::PaymentTerm>]
      ...
      # Deserialize a JSON object to an instance of PaginatedPaymentTermList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::PaymentTerm.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedPaymentTermList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
