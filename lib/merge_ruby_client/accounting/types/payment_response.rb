...
module Merge
  module Accounting
    class PaymentResponse
      ...
      # @param model [Merge::Accounting::Payment]
      ...
      # Deserialize a JSON object to an instance of PaymentResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::Payment.from_json(json_object: model)
        end
      ...
      # Serialize an instance of PaymentResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::Payment.validate_raw(obj: obj.model)
