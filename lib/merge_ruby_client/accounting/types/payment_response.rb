...
module Merge
  module Accounting
    class PaymentResponse
      ...
      # @param model [Accounting::Payment]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Accounting::Payment.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Accounting::Payment.validate_raw(obj: obj.model)
