...
module Merge
  module Accounting
    class PaginatedTrackingCategoryList
      attr_reader :next_, :previous, :results, :additional_properties

      # @param next_ [String]
      # @param previous [String]
      # @param results [Array<Accounting::TrackingCategory>]
      ...
      def initialize(next_: nil, previous: nil, results: nil, additional_properties: nil)
        ...
        # @type [String]
        @previous = previous
        # @type [Array<Accounting::TrackingCategory>]
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of PaginatedTrackingCategoryList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          Accounting::TrackingCategory.from_json(json_object: v)
        end
        new(next_: next_, previous: previous, results: results, additional_properties: struct)
      end

      # Serialize an instance of PaginatedTrackingCategoryList to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
