...
module Merge
  module Accounting
    class RemoteFieldRequest
      ...
      # @param remote_field_class [Merge::Accounting::RemoteFieldRequestRemoteFieldClass]
      # @param value [Object]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_field_class"].nil?
          ...
          remote_field_class = Merge::Accounting::RemoteFieldRequestRemoteFieldClass.from_json(json_object: remote_field_class)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::RemoteFieldRequestRemoteFieldClass.validate_raw(obj: obj.remote_field_class)
