...
module Merge
  module Accounting
    class AccountResponse
      ...
      # @param model [Merge::Accounting::Account]
      ...
      # Deserialize a JSON object to an instance of AccountResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::Account.from_json(json_object: model)
        end
      ...
      # Serialize an instance of AccountResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::Account.validate_raw(obj: obj.model)
