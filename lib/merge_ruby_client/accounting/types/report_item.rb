...
module Merge
  module Accounting
    ...
    class ReportItem
      ...
      def initialize(remote_id: nil, name: nil, value: nil, sub_items: nil, company: nil, created_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(remote_id: remote_id, name: name, value: value, sub_items: sub_items, company: company,
