...
module Merge
  module Accounting
    ...
    class Payment
      attr_reader :id, :remote_id, :transaction_date, :contact, :account, :currency, :exchange_rate, :company,
                  :total_amount, :tracking_categories, :remote_updated_at, :remote_was_deleted, :accounting_period, :applied_to_lines, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      # @param currency [Accounting::PaymentCurrency] The payment's currency.
      ...
      def initialize(id: nil, remote_id: nil, transaction_date: nil, contact: nil, account: nil, currency: nil,
                     exchange_rate: nil, company: nil, total_amount: nil, tracking_categories: nil, remote_updated_at: nil, remote_was_deleted: nil, accounting_period: nil, applied_to_lines: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, transaction_date: transaction_date, contact: contact, account: account,
            currency: currency, exchange_rate: exchange_rate, company: company, total_amount: total_amount, tracking_categories: tracking_categories, remote_updated_at: remote_updated_at, remote_was_deleted: remote_was_deleted, accounting_period: accounting_period, applied_to_lines: applied_to_lines, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
