...
module Merge
  module Accounting
    ...
    class AccountingAttachmentRequest
      ...
      def initialize(file_name: nil, file_url: nil, company: nil, integration_params: nil, linked_account_params: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(file_name: file_name, file_url: file_url, company: company, integration_params: integration_params,
