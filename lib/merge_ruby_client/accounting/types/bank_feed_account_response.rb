...
module Merge
  module Accounting
    class BankFeedAccountResponse
      ...
      # @param model [Merge::Accounting::BankFeedAccount]
      ...
      # Deserialize a JSON object to an instance of BankFeedAccountResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::BankFeedAccount.from_json(json_object: model)
        end
      ...
      # Serialize an instance of BankFeedAccountResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::BankFeedAccount.validate_raw(obj: obj.model)
