...
module Merge
  module Accounting
    ...
    class VendorCredit
      ...
      # @return [String] The vendor credit's number.
      attr_reader :number
      # @return [DateTime] The vendor credit's transaction date.
      attr_reader :transaction_date
      # @return [Merge::Accounting::VendorCreditVendor] The vendor that owes the gift or refund.
      attr_reader :vendor
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["vendor"].nil?
          ...
          vendor = Merge::Accounting::VendorCreditVendor.from_json(json_object: vendor)
        end
        ...
        if parsed_json["company"].nil?
          ...
          company = Merge::Accounting::VendorCreditCompany.from_json(json_object: company)
        end
        lines = parsed_json["lines"]&.map do |v|
          v = v.to_json
          Merge::Accounting::VendorCreditLine.from_json(json_object: v)
        end
        tracking_categories = parsed_json["tracking_categories"]&.map do |v|
          v = v.to_json
          Merge::Accounting::VendorCreditTrackingCategoriesItem.from_json(json_object: v)
        end
        ...
        if parsed_json["accounting_period"].nil?
          ...
          accounting_period = Merge::Accounting::VendorCreditAccountingPeriod.from_json(json_object: accounting_period)
        end
