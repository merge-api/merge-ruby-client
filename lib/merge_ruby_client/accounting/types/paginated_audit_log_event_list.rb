...
module Merge
  module Accounting
    class PaginatedAuditLogEventList
      ...
      # @return [Array<Merge::Accounting::AuditLogEvent>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::AuditLogEvent>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::AuditLogEvent.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
