...
module Merge
  module Accounting
    class PaginatedPaymentList
      ...
      # @return [Array<Merge::Accounting::Payment>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::Payment>]
      ...
      # Deserialize a JSON object to an instance of PaginatedPaymentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::Payment.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedPaymentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
