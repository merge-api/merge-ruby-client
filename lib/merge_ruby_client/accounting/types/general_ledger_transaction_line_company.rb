...
module Merge
  module Accounting
    ...
    class GeneralLedgerTransactionLineCompany
      # Deserialize a JSON object to an instance of GeneralLedgerTransactionLineCompany
      #
      # @param json_object [String]
      # @return [Merge::Accounting::GeneralLedgerTransactionLineCompany]
