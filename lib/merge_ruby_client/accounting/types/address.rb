...
module Merge
  module Accounting
    ...
    class Address
      attr_reader :type, :street_1, :street_2, :city, :state, :country_subdivision, :country, :zip_code, :created_at,
                  :modified_at, :additional_properties

      # @param type [ADDRESS_TYPE_ENUM] The address type.
      #   - `BILLING` - BILLING
      #   - `SHIPPING` - SHIPPING
      ...
      def initialize(type: nil, street_1: nil, street_2: nil, city: nil, state: nil, country_subdivision: nil,
                     country: nil, zip_code: nil, created_at: nil, modified_at: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        type = Accounting::ADDRESS_TYPE_ENUM.key(parsed_json["type"]) || parsed_json["type"]
        street_1 = struct.street_1
        street_2 = struct.street_2
        city = struct.city
        state = struct.state
        country_subdivision = struct.country_subdivision
        country = Accounting::COUNTRY_ENUM.key(parsed_json["country"]) || parsed_json["country"]
        zip_code = struct.zip_code
        created_at = (DateTime.parse(parsed_json["created_at"]) unless parsed_json["created_at"].nil?)
        modified_at = (DateTime.parse(parsed_json["modified_at"]) unless parsed_json["modified_at"].nil?)
        new(type: type, street_1: street_1, street_2: street_2, city: city, state: state,
            country_subdivision: country_subdivision, country: country, zip_code: zip_code, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
      ...
      def to_json(*_args)
        {
          "type": Accounting::ADDRESS_TYPE_ENUM[@type] || @type,
          "street_1": @street_1,
          "street_2": @street_2,
          "city": @city,
          "state": @state,
          "country_subdivision": @country_subdivision,
          "country": Accounting::COUNTRY_ENUM[@country] || @country,
          "zip_code": @zip_code,
          "created_at": @created_at,
          "modified_at": @modified_at
        }.to_json
      ...
      def self.validate_raw(obj:)
        obj.type&.is_a?(Accounting::ADDRESS_TYPE_ENUM) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
        ...
        obj.country&.is_a?(Accounting::COUNTRY_ENUM) != false || raise("Passed value for field obj.country is not the expected type, validation failed.")
