...
module Merge
  module Accounting
    ...
    class CompanyInfo
      ...
      # @param currency [CURRENCY_ENUM] The currency set in the company's accounting platform.
      ...
      def initialize(id: nil, remote_id: nil, name: nil, legal_name: nil, tax_number: nil, fiscal_year_end_month: nil,
        ...
        # @type [CURRENCY_ENUM] The currency set in the company's accounting platform.
        #   - `XUA` - ADB Unit of Account
        #   - `AFN` - Afghan Afghani
        #   - `AFA` - Afghan Afghani (1927–2002)
        #   - `ALL` - Albanian Lek
