  ...
  module Accounting
    ...
    class PurchaseOrderLineItemRequest
      attr_reader :remote_id, :description, :unit_price, :quantity, :item, :account, :tracking_category,
                  :tracking_categories, :tax_amount, :total_line_amount, :currency, :exchange_rate, :company, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param currency [Accounting::PurchaseOrderLineItemRequestCurrency] The purchase order line item's currency.
      ...
      def initialize(tracking_categories:, remote_id: nil, description: nil, unit_price: nil, quantity: nil, item: nil, account: nil,
                     tracking_category: nil, tax_amount: nil, total_line_amount: nil, currency: nil, exchange_rate: nil, company: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
