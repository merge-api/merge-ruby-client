...
module Merge
  module Accounting
    ...
    class ContactRequest
      attr_reader :name, :is_supplier, :is_customer, :email_address, :tax_number, :status, :currency, :company,
                  :addresses, :phone_numbers, :integration_params, :linked_account_params, :additional_properties
      ...
      # @param status [STATUS_7_D_1_ENUM] The contact's status
      #   - `ACTIVE` - ACTIVE
      #   - `ARCHIVED` - ARCHIVED
      ...
      def initialize(name: nil, is_supplier: nil, is_customer: nil, email_address: nil, tax_number: nil, status: nil,
                     currency: nil, company: nil, addresses: nil, phone_numbers: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
        ...
        # @type [STATUS_7_D_1_ENUM] The contact's status
        #   - `ACTIVE` - ACTIVE
        #   - `ARCHIVED` - ARCHIVED
        @status = status
      ...
      def self.from_json(json_object:)
        ...
        new(name: name, is_supplier: is_supplier, is_customer: is_customer, email_address: email_address,
            tax_number: tax_number, status: status, currency: currency, company: company, addresses: addresses, phone_numbers: phone_numbers, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
