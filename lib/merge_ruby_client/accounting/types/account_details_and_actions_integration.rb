...
module Merge
  module Accounting
    class AccountDetailsAndActionsIntegration
      # @return [String]
      attr_reader :name
      # @return [Array<Merge::Accounting::CategoriesEnum>]
      ...
      # @return [Array<Merge::Accounting::ModelOperation>]
      ...
      # @param name [String]
      # @param categories [Array<Merge::Accounting::CategoriesEnum>]
      # @param image [String]
      # @param square_image [String]
      # @param color [String]
      # @param slug [String]
      # @param passthrough_available [Boolean]
      # @param available_model_operations [Array<Merge::Accounting::ModelOperation>]
