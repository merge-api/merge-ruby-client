...
module Merge
  module Accounting
    ...
    class TransactionAccountingPeriod
      # Deserialize a JSON object to an instance of TransactionAccountingPeriod
      #
      # @param json_object [String]
      # @return [Merge::Accounting::TransactionAccountingPeriod]
