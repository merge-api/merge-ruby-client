...
module Merge
  module Accounting
    class DebugModeLog
      ...
      # @param log_summary [Accounting::DebugModelLogSummary]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Accounting::DebugModeLog]
      def initialize(log_id:, dashboard_view:, log_summary:, additional_properties: nil)
        # @type [String]
        @log_id = log_id
        # @type [String]
        @dashboard_view = dashboard_view
        # @type [Accounting::DebugModelLogSummary]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["log_summary"].nil?
          ...
          log_summary = Accounting::DebugModelLogSummary.from_json(json_object: log_summary)
        end
      ...
      def self.validate_raw(obj:)
        ...
        Accounting::DebugModelLogSummary.validate_raw(obj: obj.log_summary)
      end
    end
  end
end
