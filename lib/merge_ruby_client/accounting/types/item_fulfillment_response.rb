...
module Merge
  module Accounting
    class ItemFulfillmentResponse
      ...
      # @param model [Merge::Accounting::ItemFulfillment]
      ...
      # @return [Merge::Accounting::ItemFulfillmentResponse]
      ...
      # Deserialize a JSON object to an instance of ItemFulfillmentResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::ItemFulfillment.from_json(json_object: model)
        end
      ...
      # Serialize an instance of ItemFulfillmentResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::ItemFulfillment.validate_raw(obj: obj.model)
