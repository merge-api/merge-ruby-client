...
module Merge
  module Accounting
    class BankFeedTransactionResponse
      ...
      # @param model [Merge::Accounting::BankFeedTransaction]
      ...
      # Deserialize a JSON object to an instance of BankFeedTransactionResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Accounting::BankFeedTransaction.from_json(json_object: model)
        end
      ...
      # Serialize an instance of BankFeedTransactionResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Accounting::BankFeedTransaction.validate_raw(obj: obj.model)
