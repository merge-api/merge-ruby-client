...
module Merge
  module Accounting
    ...
    class VendorCreditRequestAccountingPeriod
      # Deserialize a JSON object to an instance of VendorCreditRequestAccountingPeriod
      #
      # @param json_object [String]
      # @return [Merge::Accounting::VendorCreditRequestAccountingPeriod]
