...
module Merge
  module Accounting
    class RemoteFieldApi
      ...
      # @return [Merge::Accounting::RemoteFieldApiCoverage]
      ...
      # @param remote_endpoint_info [Merge::Accounting::RemoteEndpointInfo]
      # @param example_values [Array<Object>]
      # @param advanced_metadata [Merge::Accounting::AdvancedMetadata]
      # @param coverage [Merge::Accounting::RemoteFieldApiCoverage]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Accounting::RemoteFieldApi]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_endpoint_info"].nil?
          ...
          remote_endpoint_info = Merge::Accounting::RemoteEndpointInfo.from_json(json_object: remote_endpoint_info)
        end
        ...
        if parsed_json["advanced_metadata"].nil?
          ...
          advanced_metadata = Merge::Accounting::AdvancedMetadata.from_json(json_object: advanced_metadata)
        end
        if parsed_json["coverage"].nil?
          coverage = nil
        else
          coverage = parsed_json["coverage"].to_json
          coverage = Merge::Accounting::RemoteFieldApiCoverage.from_json(json_object: coverage)
        end
        new(
          schema: schema,
          remote_key_name: remote_key_name,
      ...
      def self.validate_raw(obj:)
        ...
        Merge::Accounting::RemoteEndpointInfo.validate_raw(obj: obj.remote_endpoint_info)
        ...
        obj.advanced_metadata.nil? || Merge::Accounting::AdvancedMetadata.validate_raw(obj: obj.advanced_metadata)
        obj.coverage.nil? || Merge::Accounting::RemoteFieldApiCoverage.validate_raw(obj: obj.coverage)
      end
    end
  end
end
