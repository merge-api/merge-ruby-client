...
module Merge
  module Accounting
    ...
    class PatchedPaymentRequestContact
      # Deserialize a JSON object to an instance of PatchedPaymentRequestContact
      #
      # @param json_object [String]
      # @return [Merge::Accounting::PatchedPaymentRequestContact]
