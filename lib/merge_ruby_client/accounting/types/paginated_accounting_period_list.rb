...
module Merge
  module Accounting
    class PaginatedAccountingPeriodList
      ...
      # @return [Array<Merge::Accounting::AccountingPeriod>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::AccountingPeriod>]
      ...
      # Deserialize a JSON object to an instance of PaginatedAccountingPeriodList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::AccountingPeriod.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedAccountingPeriodList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
