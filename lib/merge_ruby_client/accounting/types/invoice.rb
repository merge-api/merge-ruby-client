...
require_relative "credit_note_apply_line_for_invoice"
...
module Merge
  module Accounting
    ...
    class Invoice
      ...
      # @return [String] The accounting period that the Invoice was generated in.
      ...
      # @return [Array<Merge::Accounting::CreditNoteApplyLineForInvoice>] `CreditNoteApplyLines` applied to the Invoice.
      attr_reader :applied_credit_notes
      # @return [Array<Merge::Accounting::VendorCreditApplyLineForInvoice>] `VendorCreditApplyLines` applied to the Invoice.
      ...
      # @param accounting_period [String] The accounting period that the Invoice was generated in.
      # @param purchase_orders [Array<String>]
      # @param sales_orders [Array<String>]
      ...
      # @param applied_credit_notes [Array<Merge::Accounting::CreditNoteApplyLineForInvoice>] `CreditNoteApplyLines` applied to the Invoice.
      # @param applied_vendor_credits [Array<Merge::Accounting::VendorCreditApplyLineForInvoice>] `VendorCreditApplyLines` applied to the Invoice.
      ...
      def initialize(id: OMIT, remote_id: OMIT, created_at: OMIT, modified_at: OMIT, type: OMIT, contact: OMIT,
        ...
        @sales_orders = sales_orders if sales_orders != OMIT
      ...
      def self.from_json(json_object:)
        ...
        sales_orders = parsed_json["sales_orders"]
        ...
        applied_credit_notes = parsed_json["applied_credit_notes"]&.map do |item|
          item = item.to_json
          Merge::Accounting::CreditNoteApplyLineForInvoice.from_json(json_object: item)
        end
        applied_vendor_credits = parsed_json["applied_vendor_credits"]&.map do |item|
          item = item.to_json
          Merge::Accounting::VendorCreditApplyLineForInvoice.from_json(json_object: item)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.sales_orders&.is_a?(Array) != false || raise("Passed value for field obj.sales_orders is not the expected type, validation failed.")
