...
module Merge
  module Accounting
    ...
    class Invoice
      ...
      # @param id [String]
      # @param type [Accounting::InvoiceType] Whether the invoice is an accounts receivable or accounts payable. If `type` is `accounts_payable`, the invoice is a bill. If `type` is `accounts_receivable`, it is an invoice.
      ...
      # @param currency [Accounting::InvoiceCurrency] The invoice's currency.
      ...
      # @param status [Accounting::InvoiceStatus] The status of the invoice.
      #   - `PAID` - PAID
      #   - `DRAFT` - DRAFT
      #   - `SUBMITTED` - SUBMITTED
