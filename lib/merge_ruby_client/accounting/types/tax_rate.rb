...
module Merge
  module Accounting
    ...
    class TaxRate
      attr_reader :description, :total_tax_rate, :effective_tax_rate, :company, :remote_was_deleted, :id, :remote_id,
      ...
      def initialize(description: nil, total_tax_rate: nil, effective_tax_rate: nil, company: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(description: description, total_tax_rate: total_tax_rate, effective_tax_rate: effective_tax_rate,
