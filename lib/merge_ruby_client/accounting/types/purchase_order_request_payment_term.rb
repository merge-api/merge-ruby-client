...
module Merge
  module Accounting
    ...
    class PurchaseOrderRequestPaymentTerm
      # Deserialize a JSON object to an instance of PurchaseOrderRequestPaymentTerm
      #
      # @param json_object [String]
      # @return [Merge::Accounting::PurchaseOrderRequestPaymentTerm]
