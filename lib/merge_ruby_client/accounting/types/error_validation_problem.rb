...
module Merge
  module Accounting
    class ErrorValidationProblem
      # @return [Merge::Accounting::ValidationProblemSource]
      attr_reader :source
      # @return [String]
      attr_reader :title
      # @return [String]
      ...
      # @param source [Merge::Accounting::ValidationProblemSource]
      # @param title [String]
      # @param detail [String]
      # @param problem_type [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Accounting::ErrorValidationProblem]
      ...
      # Deserialize a JSON object to an instance of ErrorValidationProblem
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["source"].nil?
          ...
          source = Merge::Accounting::ValidationProblemSource.from_json(json_object: source)
        end
      ...
      # Serialize an instance of ErrorValidationProblem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Merge::Accounting::ValidationProblemSource.validate_raw(obj: obj.source)
