...
module Merge
  module Accounting
    ...
    #  to lines.
    class VendorCreditApplyLineForInvoice
      ...
      # @return [Merge::Accounting::VendorCreditApplyLineForInvoice]
      ...
      def self.from_json(json_object:)
        ...
        vendor_credit = parsed_json["vendor_credit"]
      ...
      def self.validate_raw(obj:)
        ...
        obj.vendor_credit&.is_a?(String) != false || raise("Passed value for field obj.vendor_credit is not the expected type, validation failed.")
