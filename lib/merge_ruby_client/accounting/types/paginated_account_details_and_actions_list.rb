...
module Merge
  module Accounting
    class PaginatedAccountDetailsAndActionsList
      ...
      # @return [Array<Merge::Accounting::AccountDetailsAndActions>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::AccountDetailsAndActions>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::AccountDetailsAndActions.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
