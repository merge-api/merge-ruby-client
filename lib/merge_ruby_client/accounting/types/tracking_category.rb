...
module Merge
  module Accounting
    ...
    class TrackingCategory
      ...
      # @param status [Accounting::TrackingCategoryStatus] The tracking category's status.
      #   - `ACTIVE` - ACTIVE
      #   - `ARCHIVED` - ARCHIVED
      # @param category_type [Accounting::TrackingCategoryCategoryType] The tracking category’s type.
      #   - `CLASS` - CLASS
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["category_type"].nil?
          category_type = nil
        else
          category_type = parsed_json["category_type"].to_json
