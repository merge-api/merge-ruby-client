...
module Merge
  module Accounting
    ...
    class SyncStatus
      ...
      # @return [Merge::Accounting::SyncStatusStatusEnum]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Accounting::SyncStatusStatusEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.is_a?(Merge::Accounting::SyncStatusStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
