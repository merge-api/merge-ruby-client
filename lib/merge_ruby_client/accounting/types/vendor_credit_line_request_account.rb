...
module Merge
  module Accounting
    # The line's account.
    class VendorCreditLineRequestAccount
      # Deserialize a JSON object to an instance of VendorCreditLineRequestAccount
      #
      # @param json_object [String]
      # @return [Merge::Accounting::VendorCreditLineRequestAccount]
