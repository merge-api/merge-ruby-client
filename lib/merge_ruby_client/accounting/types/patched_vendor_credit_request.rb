...
module Merge
  module Accounting
    ...
    class PatchedVendorCreditRequest
      ...
      # @return [Merge::Accounting::PatchedVendorCreditRequest]
      def initialize(number: OMIT, transaction_date: OMIT, vendor: OMIT, currency: OMIT, exchange_rate: OMIT,
                     inclusive_of_tax: OMIT, company: OMIT, tracking_categories: OMIT, integration_params: OMIT, linked_account_params: OMIT, additional_properties: nil)
      ...
      # Deserialize a JSON object to an instance of PatchedVendorCreditRequest
      #
      ...
      # Serialize an instance of PatchedVendorCreditRequest to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
