...
module Merge
  module Accounting
    ...
    class JournalEntry
      ...
      # @param currency [Accounting::JournalEntryCurrency] The journal's currency.
      ...
      # @param posting_status [Accounting::JournalEntryPostingStatus] The journal's posting status.
      #   - `UNPOSTED` - UNPOSTED
      #   - `POSTED` - POSTED
