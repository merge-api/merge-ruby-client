...
module Merge
  module Accounting
    ...
    class PurchaseOrder
      attr_reader :status, :issue_date, :purchase_order_number, :delivery_date, :delivery_address, :customer, :vendor,
                  :memo, :company, :total_amount, :currency, :exchange_rate, :line_items, :tracking_categories, :remote_created_at, :remote_updated_at, :remote_was_deleted, :accounting_period, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties

      # @param status [PURCHASE_ORDER_STATUS_ENUM] The purchase order's status.
      #   - `DRAFT` - DRAFT
      #   - `SUBMITTED` - SUBMITTED
      ...
      # @param currency [CURRENCY_ENUM] The purchase order's currency.
      ...
      def initialize(status: nil, issue_date: nil, purchase_order_number: nil, delivery_date: nil,
                     delivery_address: nil, customer: nil, vendor: nil, memo: nil, company: nil, total_amount: nil, currency: nil, exchange_rate: nil, line_items: nil, tracking_categories: nil, remote_created_at: nil, remote_updated_at: nil, remote_was_deleted: nil, accounting_period: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [PURCHASE_ORDER_STATUS_ENUM] The purchase order's status.
        #   - `DRAFT` - DRAFT
        #   - `SUBMITTED` - SUBMITTED
        #   - `AUTHORIZED` - AUTHORIZED
        #   - `BILLED` - BILLED
        ...
        # @type [CURRENCY_ENUM] The purchase order's currency.
        #   - `XUA` - ADB Unit of Account
        #   - `AFN` - Afghan Afghani
        #   - `AFA` - Afghan Afghani (1927–2002)
        #   - `ALL` - Albanian Lek
      ...
      def self.from_json(json_object:)
        ...
        status = Accounting::PURCHASE_ORDER_STATUS_ENUM.key(parsed_json["status"]) || parsed_json["status"]
        ...
        new(status: status, issue_date: issue_date, purchase_order_number: purchase_order_number,
      ...
      def to_json(*_args)
        {
          "status": Accounting::PURCHASE_ORDER_STATUS_ENUM[@status] || @status,
          "issue_date": @issue_date,
          "purchase_order_number": @purchase_order_number,
          "delivery_date": @delivery_date,
          "delivery_address": @delivery_address,
      ...
      def self.validate_raw(obj:)
        obj.status&.is_a?(Accounting::PURCHASE_ORDER_STATUS_ENUM) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
