...
module Merge
  module Accounting
    class PaginatedJournalEntryList
      ...
      # @return [Array<Merge::Accounting::JournalEntry>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Accounting::JournalEntry>]
      ...
      # Deserialize a JSON object to an instance of PaginatedJournalEntryList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Accounting::JournalEntry.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedJournalEntryList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
