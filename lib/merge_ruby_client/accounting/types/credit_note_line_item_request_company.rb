...
module Merge
  module Accounting
    ...
    class CreditNoteLineItemRequestCompany
      # Deserialize a JSON object to an instance of CreditNoteLineItemRequestCompany
      #
      # @param json_object [String]
      # @return [Merge::Accounting::CreditNoteLineItemRequestCompany]
