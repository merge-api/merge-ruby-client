...
module Merge
  module Accounting
    class AuditTrailClient
      ...
      # @return [Accounting::AuditTrailClient]
      ...
      # @return [Accounting::PaginatedAuditLogEventList]
      def list(cursor: nil, end_date: nil, event_type: nil, page_size: nil, start_date: nil, user_email: nil,
               request_options: nil)
        response = @request_client.conn.get("/api/accounting/v1/audit-trail") do |req|
        ...
        Accounting::PaginatedAuditLogEventList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncAuditTrailClient
      ...
      # @return [Accounting::AsyncAuditTrailClient]
      def initialize(request_client:)
