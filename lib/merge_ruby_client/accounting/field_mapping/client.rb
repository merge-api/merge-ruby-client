...
module Merge
  module Accounting
    class FieldMappingClient
      ...
      #  )
      #  api.accounting.field_mappings_retrieve
      ...
      #  category.
      # @param request_options [Merge::RequestOptions]
      # @return [Merge::Accounting::FieldMappingInstanceResponse]
      # @example
      #  api = Merge::Client.new(
      #    environment: Environment::PRODUCTION,
      #    base_url: "https://api.example.com",
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.field_mappings_destroy(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.field_mappings_partial_update(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.remote_fields_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.target_fields_retrieve
