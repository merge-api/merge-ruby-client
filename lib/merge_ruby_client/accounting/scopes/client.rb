...
module Merge
  module Accounting
    class ScopesClient
      ...
      # @return [Merge::Accounting::CommonModelScopeApi]
      # @example
      ...
      #  )
      #  api.accounting.scopes.default_scopes_retrieve
      def default_scopes_retrieve(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/default-scopes"
        end
        Merge::Accounting::CommonModelScopeApi.from_json(json_object: response.body)
      end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.scopes.linked_account_scopes_retrieve
      def linked_account_scopes_retrieve(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/accounting/v1/linked-account-scopes"
        end
        Merge::Accounting::CommonModelScopeApi.from_json(json_object: response.body)
      end
      ...
      #  more](https://help.merge.dev/en/articles/5950052-common-model-and-field-scopes)
      #
      # @param common_models [Array<Hash>] The common models you want to update the scopes forRequest of type Array<Merge::Accounting::IndividualCommonModelScopeDeserializerRequest>, as a Hash
      #   * :model_name (String)
      #   * :model_permissions (Hash{String => Merge::Accounting::ModelPermissionDeserializerRequest})
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.accounting.scopes.linked_account_scopes_create(common_models: [{ model_name: "Employee", model_permissions: { "READ": { is_enabled: true }, "WRITE": { is_enabled: false } }, field_permissions: { enabled_fields: ["avatar", "home_location"], disabled_fields: ["work_location"] } }, { model_name: "Benefit", model_permissions: { "WRITE": { is_enabled: false } } }])
