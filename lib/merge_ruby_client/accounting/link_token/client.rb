...
module Merge
  module Accounting
    class LinkTokenClient
      ...
      # @return [Accounting::LinkTokenClient]
      ...
      # @param categories [Array<Accounting::CATEGORIES_ENUM>] The integration categories to show in Merge Link.
      ...
      # @param common_models [Array<Hash>] An array of objects to specify the models and fields that will be disabled for a given Linked Account. Each object uses model_id, enabled_actions, and disabled_fields to specify the model, method, and fields that are scoped for a given Linked Account.Request of type Array<Accounting::CommonModelScopesBodyRequest>, as a Hash
      #   * :model_id (String)
      #   * :enabled_actions (Array<Accounting::ENABLED_ACTIONS_ENUM>)
      ...
      def create(end_user_email_address:, end_user_organization_name:, end_user_origin_id:, categories:,
        ...
        response = @request_client.conn.post("/api/accounting/v1/link-token") do |req|
        ...
        Accounting::LinkToken.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncLinkTokenClient
      ...
      # @return [Accounting::AsyncLinkTokenClient]
      def initialize(request_client:)
