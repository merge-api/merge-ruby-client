...
module Merge
  module Accounting
    class LinkTokenClient
      ...
      #  unique identifiers.
      # @param categories [Array<Merge::Accounting::CategoriesEnum>] The integration categories to show in Merge Link.
      ...
      #  given Linked Account.Request of type Array<Merge::Accounting::CommonModelScopesBodyRequest>, as a Hash
      #   * :model_id (String)
      ...
      # @param completed_account_initial_screen [Merge::Accounting::COMPLETED_ACCOUNT_INITIAL_SCREEN_ENUM] When creating a Link token, you can specifiy the initial screen of Linking Flow
