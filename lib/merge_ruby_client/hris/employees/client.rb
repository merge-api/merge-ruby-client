...
require_relative "types/ignore_common_model_request_reason"
...
module Merge
  module Hris
    class EmployeesClient
      ...
      # @param reason [Hash] Request of type Hris::Employees::IgnoreCommonModelRequestReason, as a Hash
