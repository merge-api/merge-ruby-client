...
module Merge
  module Hris
    class LinkTokenClient
      ...
      #  unique identifiers.
      # @param categories [Array<Merge::Hris::CategoriesEnum>] The integration categories to show in Merge Link.
      ...
      #  given Linked Account.Request of type Array<Merge::Hris::CommonModelScopesBodyRequest>, as a Hash
      #   * :model_id (String)
      #   * :enabled_actions (Array<Merge::Hris::EnabledActionsEnum>)
      ...
      # @param language [Merge::Hris::LanguageEnum] The following subset of IETF language tags can be used to configure
      #  localization.
      #  * `en` - en
      #  * `de` - de
      ...
      def create(end_user_email_address:, end_user_organization_name:, end_user_origin_id:, categories:,
        ...
        **(request_options&.additional_headers || {})
        ...
        Merge::Hris::LinkToken.from_json(json_object: response.body)
      end
    end
