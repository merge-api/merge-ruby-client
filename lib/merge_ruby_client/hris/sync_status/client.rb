...
module Merge
  module Hris
    class SyncStatusClient
      ...
      # @return [Hris::PaginatedSyncStatusList]
      def list(cursor: nil, page_size: nil, request_options: nil)
        response = @request_client.conn.get("/api/hris/v1/sync-status") do |req|
        ...
        Hris::PaginatedSyncStatusList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncSyncStatusClient
      ...
      # @return [Hris::AsyncSyncStatusClient]
      def initialize(request_client:)
