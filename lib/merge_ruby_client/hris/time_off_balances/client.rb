...
require "date"
require_relative "types/time_off_balances_list_request_policy_type"
require_relative "../types/paginated_time_off_balance_list"
require_relative "../types/time_off_balance"
require "async"
...
module Merge
  module Hris
    class TimeOffBalancesClient
      ...
      # @return [Hris::TimeOffBalancesClient]
      ...
      # @param employee_id [String] If provided, will only return time off balances for this employee.
      ...
      # @param policy_type [TIME_OFF_BALANCES_LIST_REQUEST_POLICY_TYPE] If provided, will only return TimeOffBalance with this policy type. Options: ('VACATION', 'SICK', 'PERSONAL', 'JURY_DUTY', 'VOLUNTEER', 'BEREAVEMENT')
      #   - `VACATION` - VACATION
      #   - `SICK` - SICK
      #   - `PERSONAL` - PERSONAL
      #   - `JURY_DUTY` - JURY_DUTY
      ...
      def list(created_after: nil, created_before: nil, cursor: nil, employee_id: nil, expand: nil,
        ...
        response = @request_client.conn.get("/api/hris/v1/time-off-balances") do |req|
        ...
        Hris::PaginatedTimeOffBalanceList.from_json(json_object: response.body)
      end
      ...
      def retrieve(id:, expand: nil, include_remote_data: nil, remote_fields: nil, show_enum_origins: nil,
                   request_options: nil)
        response = @request_client.conn.get("/api/hris/v1/time-off-balances/#{id}") do |req|
          req.options.timeout = request_options.timeout_in_seconds unless request_options&.timeout_in_seconds.nil?
          req.headers["Authorization"] = request_options.api_key unless request_options&.api_key.nil?
          req.headers["X-Account-Token"] = request_options.account_token unless request_options&.account_token.nil?
          req.headers = { **req.headers, **(request_options&.additional_headers || {}) }.compact
        ...
        Hris::TimeOffBalance.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncTimeOffBalancesClient
      ...
      # @return [Hris::AsyncTimeOffBalancesClient]
      def initialize(request_client:)
