...
module Merge
  module Hris
    class IssuesClient
      ...
      #  )
      #  api.hris.issues.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(account_token: nil, cursor: nil, end_date: nil, end_user_organization_name: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/issues"
        end
        Merge::Hris::PaginatedIssueList.from_json(json_object: response.body)
      end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.issues.retrieve(id: "id")
      def retrieve(id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/issues/#{id}"
        end
        Merge::Hris::Issue.from_json(json_object: response.body)
      end
    end
