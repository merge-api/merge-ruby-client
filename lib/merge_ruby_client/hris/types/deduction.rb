...
module Merge
  module Hris
    ...
    class Deduction
      attr_reader :id, :remote_id, :employee_payroll_run, :name, :employee_deduction, :company_deduction,
      ...
      def initialize(id: nil, remote_id: nil, employee_payroll_run: nil, name: nil, employee_deduction: nil,
                     company_deduction: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, employee_payroll_run: employee_payroll_run, name: name,
            employee_deduction: employee_deduction, company_deduction: company_deduction, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
