...
require_relative "timesheet_entry"
require "ostruct"
require "json"
...
module Merge
  module Hris
    class PaginatedTimesheetEntryList
      ...
      # @return [Array<Merge::Hris::TimesheetEntry>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::TimesheetEntry>]
      ...
      # Deserialize a JSON object to an instance of PaginatedTimesheetEntryList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::TimesheetEntry.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedTimesheetEntryList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
