...
module Merge
  module Hris
    ...
    class SyncStatus
      ...
      # @return [Merge::Hris::LastSyncResultEnum]
      attr_reader :last_sync_result
      # @return [DateTime]
      attr_reader :last_sync_finished
      # @return [Merge::Hris::StatusFd5Enum]
      attr_reader :status
      # @return [Boolean]
      attr_reader :is_initial_sync
      # @return [Merge::Hris::SelectiveSyncConfigurationsUsageEnum]
      ...
      # @param last_sync_result [Merge::Hris::LastSyncResultEnum]
      # @param last_sync_finished [DateTime]
      # @param status [Merge::Hris::StatusFd5Enum]
      # @param is_initial_sync [Boolean]
      # @param selective_sync_configurations_usage [Merge::Hris::SelectiveSyncConfigurationsUsageEnum]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Hris::SyncStatus]
      ...
      def self.validate_raw(obj:)
        ...
        obj.last_sync_result&.is_a?(Merge::Hris::LastSyncResultEnum) != false || raise("Passed value for field obj.last_sync_result is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Merge::Hris::StatusFd5Enum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
        ...
        obj.selective_sync_configurations_usage&.is_a?(Merge::Hris::SelectiveSyncConfigurationsUsageEnum) != false || raise("Passed value for field obj.selective_sync_configurations_usage is not the expected type, validation failed.")
      end
    end
  end
end
