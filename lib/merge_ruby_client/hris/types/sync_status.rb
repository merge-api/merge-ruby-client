...
module Merge
  module Hris
    ...
    class SyncStatus
      ...
      # @return [Merge::Hris::SyncStatusStatusEnum]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Hris::SyncStatusStatusEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.is_a?(Merge::Hris::SyncStatusStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
