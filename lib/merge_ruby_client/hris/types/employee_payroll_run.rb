...
module Merge
  module Hris
    ...
    class EmployeePayrollRun
      attr_reader :id, :remote_id, :employee, :payroll_run, :gross_pay, :net_pay, :start_date, :end_date, :check_date,
                  :earnings, :deductions, :taxes, :remote_was_deleted, :created_at, :modified_at, :field_mappings, :remote_data, :additional_properties
      ...
      def initialize(id: nil, remote_id: nil, employee: nil, payroll_run: nil, gross_pay: nil, net_pay: nil,
                     start_date: nil, end_date: nil, check_date: nil, earnings: nil, deductions: nil, taxes: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, employee: employee, payroll_run: payroll_run, gross_pay: gross_pay,
            net_pay: net_pay, start_date: start_date, end_date: end_date, check_date: check_date, earnings: earnings, deductions: deductions, taxes: taxes, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
