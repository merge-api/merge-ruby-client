...
module Merge
  module Hris
    class CommonModelScopeApi
      # @return [Array<Merge::Hris::IndividualCommonModelScopeDeserializer>] The common models you want to update the scopes for
      ...
      # @param common_models [Array<Merge::Hris::IndividualCommonModelScopeDeserializer>] The common models you want to update the scopes for
      ...
      def self.from_json(json_object:)
        ...
        common_models = parsed_json["common_models"]&.map do |item|
          item = item.to_json
          Merge::Hris::IndividualCommonModelScopeDeserializer.from_json(json_object: item)
        end
