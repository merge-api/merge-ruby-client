...
module Merge
  module Hris
    class PaginatedAccountDetailsAndActionsList
      ...
      # @return [Array<Merge::Hris::AccountDetailsAndActions>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::AccountDetailsAndActions>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::AccountDetailsAndActions.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
