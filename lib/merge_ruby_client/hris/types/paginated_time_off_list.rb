...
module Merge
  module Hris
    class PaginatedTimeOffList
      ...
      # @return [Array<Merge::Hris::TimeOff>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::TimeOff>]
      ...
      # Deserialize a JSON object to an instance of PaginatedTimeOffList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::TimeOff.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedTimeOffList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
