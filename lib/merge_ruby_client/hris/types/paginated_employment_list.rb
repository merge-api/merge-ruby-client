...
module Merge
  module Hris
    class PaginatedEmploymentList
      ...
      # @return [Array<Merge::Hris::Employment>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::Employment>]
      ...
      # Deserialize a JSON object to an instance of PaginatedEmploymentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::Employment.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedEmploymentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
