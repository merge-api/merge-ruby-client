...
module Merge
  module Hris
    ...
    class TimesheetEntryRequest
      attr_reader :employee, :hours_worked, :start_time, :end_time, :integration_params, :linked_account_params,
      ...
      def initialize(employee: nil, hours_worked: nil, start_time: nil, end_time: nil, integration_params: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(employee: employee, hours_worked: hours_worked, start_time: start_time, end_time: end_time,
