...
module Merge
  module Hris
    ...
    class Team
      attr_reader :id, :remote_id, :name, :parent_team, :remote_was_deleted, :created_at, :modified_at,
      ...
      # @return [Hris::Team]
      def initialize(id: nil, remote_id: nil, name: nil, parent_team: nil, remote_was_deleted: nil, created_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, parent_team: parent_team, remote_was_deleted: remote_was_deleted,
