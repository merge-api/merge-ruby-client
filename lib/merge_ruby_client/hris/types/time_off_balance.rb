...
module Merge
  module Hris
    ...
    class TimeOffBalance
      attr_reader :id, :remote_id, :employee, :balance, :used, :policy_type, :remote_was_deleted, :created_at,
      ...
      # @param policy_type [POLICY_TYPE_ENUM] The policy type of this time off balance.
      #   - `VACATION` - VACATION
      #   - `SICK` - SICK
      #   - `PERSONAL` - PERSONAL
      #   - `JURY_DUTY` - JURY_DUTY
      ...
      def initialize(id: nil, remote_id: nil, employee: nil, balance: nil, used: nil, policy_type: nil,
        ...
        @used = used
        # @type [POLICY_TYPE_ENUM] The policy type of this time off balance.
        #   - `VACATION` - VACATION
        #   - `SICK` - SICK
        #   - `PERSONAL` - PERSONAL
        #   - `JURY_DUTY` - JURY_DUTY
      ...
      def self.from_json(json_object:)
        ...
        used = struct.used
        policy_type = Hris::POLICY_TYPE_ENUM.key(parsed_json["policy_type"]) || parsed_json["policy_type"]
        ...
        new(id: id, remote_id: remote_id, employee: employee, balance: balance, used: used, policy_type: policy_type,
      ...
      def to_json(*_args)
        {
          ...
          "balance": @balance,
          "used": @used,
          "policy_type": Hris::POLICY_TYPE_ENUM[@policy_type] || @policy_type,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.policy_type&.is_a?(Hris::POLICY_TYPE_ENUM) != false || raise("Passed value for field obj.policy_type is not the expected type, validation failed.")
