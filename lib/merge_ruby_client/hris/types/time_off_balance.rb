...
module Merge
  module Hris
    ...
    class TimeOffBalance
      ...
      # @param policy_type [Hris::TimeOffBalancePolicyType] The policy type of this time off balance.
      #   - `VACATION` - VACATION
      #   - `SICK` - SICK
      #   - `PERSONAL` - PERSONAL
      #   - `JURY_DUTY` - JURY_DUTY
      ...
      def self.from_json(json_object:)
        ...
        used = struct.used
        if parsed_json["policy_type"].nil?
          policy_type = nil
        else
          policy_type = parsed_json["policy_type"].to_json
