...
module Merge
  module Hris
    ...
    class Dependent
      ...
      # @param relationship [Hris::DependentRelationship] The dependent's relationship to the employee.
      #   - `CHILD` - CHILD
      #   - `SPOUSE` - SPOUSE
      ...
      # @param gender [Hris::DependentGender] The dependent's gender.
      #   - `MALE` - MALE
      #   - `FEMALE` - FEMALE
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["relationship"].nil?
          relationship = nil
        else
