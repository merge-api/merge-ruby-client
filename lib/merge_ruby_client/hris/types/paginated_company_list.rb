...
module Merge
  module Hris
    class PaginatedCompanyList
      ...
      # @return [Array<Merge::Hris::Company>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::Company>]
      ...
      # Deserialize a JSON object to an instance of PaginatedCompanyList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::Company.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedCompanyList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
