...
module Merge
  module Hris
    # # The PayGroup Object
    #  ### Description
    #  The `PayGroup` object is used to represent a subset of employees that are put
    #  together for payroll processing purposes.
    #  ### Usage Example
    #  Fetch from the `LIST PayGroup` endpoint and filter by `ID` to show all pay group
    #  information.
    class PayGroup
      # @return [String]
      attr_reader :id
      ...
      def initialize(id: OMIT, remote_id: OMIT, created_at: OMIT, modified_at: OMIT, pay_group_name: OMIT,
                     remote_was_deleted: OMIT, field_mappings: OMIT, remote_data: OMIT, additional_properties: nil)
        @id = id if id != OMIT
        @remote_id = remote_id if remote_id != OMIT
        @created_at = created_at if created_at != OMIT
        @modified_at = modified_at if modified_at != OMIT
        @pay_group_name = pay_group_name if pay_group_name != OMIT
      ...
      def self.from_json(json_object:)
        ...
        pay_group_name = parsed_json["pay_group_name"]
