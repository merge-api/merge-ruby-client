...
module Merge
  module Hris
    ...
    class PayGroup
      attr_reader :id, :remote_id, :pay_group_name, :remote_was_deleted, :created_at, :modified_at, :field_mappings,
      ...
      def initialize(id: nil, remote_id: nil, pay_group_name: nil, remote_was_deleted: nil, created_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, pay_group_name: pay_group_name, remote_was_deleted: remote_was_deleted,
