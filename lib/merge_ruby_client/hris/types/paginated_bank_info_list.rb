...
module Merge
  module Hris
    class PaginatedBankInfoList
      ...
      # @return [Array<Merge::Hris::BankInfo>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::BankInfo>]
      ...
      # Deserialize a JSON object to an instance of PaginatedBankInfoList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::BankInfo.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedBankInfoList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
