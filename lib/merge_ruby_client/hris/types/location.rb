...
module Merge
  module Hris
    ...
    class Location
      ...
      # @param country [Hris::LocationCountry] The location's country.
      #   - `AF` - Afghanistan
      #   - `AX` - Åland Islands
      #   - `AL` - Albania
      #   - `DZ` - Algeria
      ...
      #   - `ZM` - Zambia
      #   - `ZW` - Zimbabwe
      # @param location_type [Hris::LocationLocationType] The location's type. Can be either WORK or HOME
      #   - `HOME` - HOME
      #   - `WORK` - WORK
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["location_type"].nil?
          location_type = nil
        else
          location_type = parsed_json["location_type"].to_json
