...
module Merge
  module Hris
    ...
    class Group
      ...
      # @param type [GROUP_TYPE_ENUM] The group type
      #   - `TEAM` - TEAM
      ...
      def initialize(id: nil, remote_id: nil, parent_group: nil, name: nil, type: nil, remote_was_deleted: nil,
        ...
        @name = name
        # @type [GROUP_TYPE_ENUM] The group type
        #   - `TEAM` - TEAM
        #   - `DEPARTMENT` - DEPARTMENT
        #   - `COST_CENTER` - COST_CENTER
        #   - `BUSINESS_UNIT` - BUSINESS_UNIT
      ...
      def self.from_json(json_object:)
        ...
        name = struct.name
        type = Hris::GROUP_TYPE_ENUM.key(parsed_json["type"]) || parsed_json["type"]
      ...
      def to_json(*_args)
        {
          ...
          "parent_group": @parent_group,
          "name": @name,
          "type": Hris::GROUP_TYPE_ENUM[@type] || @type,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Hris::GROUP_TYPE_ENUM) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
