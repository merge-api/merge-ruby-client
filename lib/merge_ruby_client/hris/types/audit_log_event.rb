...
module Merge
  module Hris
    class AuditLogEvent
      ...
      # @param role [Hris::AuditLogEventRole] Designates the role of the user (or SYSTEM/API if action not taken by a user) at the time of this Event occurring.
      #   - `ADMIN` - ADMIN
      #   - `DEVELOPER` - DEVELOPER
      #   - `MEMBER` - MEMBER
      #   - `API` - API
      ...
      # @param event_type [Hris::AuditLogEventEventType] Designates the type of event that occurred.
