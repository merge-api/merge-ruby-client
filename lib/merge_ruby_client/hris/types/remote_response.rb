...
module Merge
  module Hris
    ...
    class RemoteResponse
      ...
      # @return [Merge::Hris::ResponseTypeEnum]
      ...
      # @param response_type [Merge::Hris::ResponseTypeEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.response_type&.is_a?(Merge::Hris::ResponseTypeEnum) != false || raise("Passed value for field obj.response_type is not the expected type, validation failed.")
