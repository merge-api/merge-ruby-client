...
module Merge
  module Hris
    ...
    class Employee
      ...
      # @param gender [Hris::EmployeeGender] The employee's gender.
      #   - `MALE` - MALE
      #   - `FEMALE` - FEMALE
      #   - `NON-BINARY` - NON-BINARY
      #   - `OTHER` - OTHER
      #   - `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      # @param ethnicity [Hris::EmployeeEthnicity] The employee's ethnicity.
      ...
      #   - `WHITE` - WHITE
      #   - `PREFER_NOT_TO_DISCLOSE` - PREFER_NOT_TO_DISCLOSE
      # @param marital_status [Hris::EmployeeMaritalStatus] The employee's filing status as related to marital status.
      #   - `SINGLE` - SINGLE
      ...
      # @param employment_status [Hris::EmployeeEmploymentStatus] The employment status of the employee.
      #   - `ACTIVE` - ACTIVE
      #   - `PENDING` - PENDING
      #   - `INACTIVE` - INACTIVE
