...
module Merge
  module Hris
    class Issue
      # @return [String]
      attr_reader :id
      # @return [Merge::Hris::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      attr_reader :status
      # @return [String]
      ...
      # @param id [String]
      # @param status [Merge::Hris::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Merge::Hris::IssueStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
