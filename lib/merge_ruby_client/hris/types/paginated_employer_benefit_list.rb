...
require_relative "employer_benefit"
require "ostruct"
require "json"
...
module Merge
  module Hris
    class PaginatedEmployerBenefitList
      ...
      # @return [Array<Merge::Hris::EmployerBenefit>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::EmployerBenefit>]
      ...
      # Deserialize a JSON object to an instance of PaginatedEmployerBenefitList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::EmployerBenefit.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedEmployerBenefitList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
