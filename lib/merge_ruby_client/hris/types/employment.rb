...
module Merge
  module Hris
    ...
    class Employment
      ...
      # @param pay_period [PAY_PERIOD_ENUM] The time period this pay rate encompasses.
      #   - `HOUR` - HOUR
      #   - `DAY` - DAY
      #   - `WEEK` - WEEK
      ...
      #   - `YEAR` - YEAR
      # @param pay_frequency [PAY_FREQUENCY_ENUM] The position's pay frequency.
      #   - `WEEKLY` - WEEKLY
      #   - `BIWEEKLY` - BIWEEKLY
      #   - `MONTHLY` - MONTHLY
      #   - `QUARTERLY` - QUARTERLY
      ...
      #   - `PRO_RATA` - PRO_RATA
      #   - `SEMIMONTHLY` - SEMIMONTHLY
      # @param pay_currency [PAY_CURRENCY_ENUM] The position's currency code.
      ...
      # @param flsa_status [FLSA_STATUS_ENUM] The position's FLSA status.
      #   - `EXEMPT` - EXEMPT
      #   - `SALARIED_NONEXEMPT` - SALARIED_NONEXEMPT
      #   - `NONEXEMPT` - NONEXEMPT
      #   - `OWNER` - OWNER
      # @param effective_date [DateTime] The position's effective date.
      # @param employment_type [EMPLOYMENT_TYPE_ENUM] The position's type of employment.
      #   - `FULL_TIME` - FULL_TIME
      #   - `PART_TIME` - PART_TIME
      #   - `INTERN` - INTERN
      ...
      def initialize(id: nil, remote_id: nil, employee: nil, job_title: nil, pay_rate: nil, pay_period: nil,
        ...
        @pay_rate = pay_rate
        # @type [PAY_PERIOD_ENUM] The time period this pay rate encompasses.
        #   - `HOUR` - HOUR
        #   - `DAY` - DAY
        #   - `WEEK` - WEEK
        #   - `EVERY_TWO_WEEKS` - EVERY_TWO_WEEKS
        ...
        # @type [PAY_FREQUENCY_ENUM] The position's pay frequency.
        #   - `WEEKLY` - WEEKLY
        #   - `BIWEEKLY` - BIWEEKLY
        #   - `MONTHLY` - MONTHLY
        #   - `QUARTERLY` - QUARTERLY
        ...
        # @type [PAY_CURRENCY_ENUM] The position's currency code.
        #   - `XUA` - ADB Unit of Account
        #   - `AFN` - Afghan Afghani
        #   - `AFA` - Afghan Afghani (1927–2002)
        #   - `ALL` - Albanian Lek
        ...
        @pay_group = pay_group
        # @type [FLSA_STATUS_ENUM] The position's FLSA status.
        #   - `EXEMPT` - EXEMPT
        #   - `SALARIED_NONEXEMPT` - SALARIED_NONEXEMPT
        #   - `NONEXEMPT` - NONEXEMPT
        #   - `OWNER` - OWNER
        ...
        # @type [EMPLOYMENT_TYPE_ENUM] The position's type of employment.
        #   - `FULL_TIME` - FULL_TIME
        #   - `PART_TIME` - PART_TIME
        #   - `INTERN` - INTERN
        #   - `CONTRACTOR` - CONTRACTOR
      ...
      def self.from_json(json_object:)
        ...
        pay_period = Hris::PAY_PERIOD_ENUM.key(parsed_json["pay_period"]) || parsed_json["pay_period"]
        pay_frequency = Hris::PAY_FREQUENCY_ENUM.key(parsed_json["pay_frequency"]) || parsed_json["pay_frequency"]
        pay_currency = Hris::PAY_CURRENCY_ENUM.key(parsed_json["pay_currency"]) || parsed_json["pay_currency"]
        ...
        flsa_status = Hris::FLSA_STATUS_ENUM.key(parsed_json["flsa_status"]) || parsed_json["flsa_status"]
        effective_date = (DateTime.parse(parsed_json["effective_date"]) unless parsed_json["effective_date"].nil?)
        employment_type = Hris::EMPLOYMENT_TYPE_ENUM.key(parsed_json["employment_type"]) || parsed_json["employment_type"]
      ...
      def to_json(*_args)
        {
          ...
          "job_title": @job_title,
          "pay_rate": @pay_rate,
          "pay_period": Hris::PAY_PERIOD_ENUM[@pay_period] || @pay_period,
          "pay_frequency": Hris::PAY_FREQUENCY_ENUM[@pay_frequency] || @pay_frequency,
          "pay_currency": Hris::PAY_CURRENCY_ENUM[@pay_currency] || @pay_currency,
          "pay_group": @pay_group,
          "flsa_status": Hris::FLSA_STATUS_ENUM[@flsa_status] || @flsa_status,
          "effective_date": @effective_date,
          "employment_type": Hris::EMPLOYMENT_TYPE_ENUM[@employment_type] || @employment_type,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.pay_period&.is_a?(Hris::PAY_PERIOD_ENUM) != false || raise("Passed value for field obj.pay_period is not the expected type, validation failed.")
        obj.pay_frequency&.is_a?(Hris::PAY_FREQUENCY_ENUM) != false || raise("Passed value for field obj.pay_frequency is not the expected type, validation failed.")
        obj.pay_currency&.is_a?(Hris::PAY_CURRENCY_ENUM) != false || raise("Passed value for field obj.pay_currency is not the expected type, validation failed.")
        obj.pay_group.nil? || Hris::EmploymentPayGroup.validate_raw(obj: obj.pay_group)
        obj.flsa_status&.is_a?(Hris::FLSA_STATUS_ENUM) != false || raise("Passed value for field obj.flsa_status is not the expected type, validation failed.")
        ...
        obj.employment_type&.is_a?(Hris::EMPLOYMENT_TYPE_ENUM) != false || raise("Passed value for field obj.employment_type is not the expected type, validation failed.")
