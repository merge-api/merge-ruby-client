...
module Merge
  module Hris
    ...
    class Employment
      ...
      #   - `YEAR` - YEAR
      # @param pay_frequency [PAY_CURRENCY_ENUM] The position's pay frequency.
      #   - `WEEKLY` - WEEKLY
      #   - `BIWEEKLY` - BIWEEKLY
      #   - `MONTHLY` - MONTHLY
      #   - `QUARTERLY` - QUARTERLY
      ...
      def initialize(id: nil, remote_id: nil, employee: nil, job_title: nil, pay_rate: nil, pay_period: nil,
        ...
        # @type [PAY_CURRENCY_ENUM] The position's pay frequency.
        #   - `WEEKLY` - WEEKLY
        #   - `BIWEEKLY` - BIWEEKLY
        #   - `MONTHLY` - MONTHLY
        #   - `QUARTERLY` - QUARTERLY
      ...
      def self.from_json(json_object:)
        ...
        pay_frequency = Hris::PAY_CURRENCY_ENUM.key(parsed_json["pay_frequency"]) || parsed_json["pay_frequency"]
      ...
      def to_json(*_args)
        {
          ...
          "pay_rate": @pay_rate,
          "pay_period": @pay_period,
          "pay_frequency": Hris::PAY_CURRENCY_ENUM[@pay_frequency] || @pay_frequency,
      ...
      def self.validate_raw(obj:)
        ...
        obj.pay_frequency&.is_a?(Hris::PAY_CURRENCY_ENUM) != false || raise("Passed value for field obj.pay_frequency is not the expected type, validation failed.")
