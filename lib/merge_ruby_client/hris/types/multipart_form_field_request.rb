...
module Merge
  module Hris
    ...
    class MultipartFormFieldRequest
      ...
      # @param encoding [Hris::MultipartFormFieldRequestEncoding] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #   - `RAW` - RAW
      #   - `BASE64` - BASE64
      ...
      # @return [Hris::MultipartFormFieldRequest]
      def initialize(name:, data:, encoding: nil, file_name: nil, content_type: nil, additional_properties: nil)
        ...
        @data = data
        # @type [Hris::MultipartFormFieldRequestEncoding] The encoding of the value of `data`. Defaults to `RAW` if not defined.
        #   - `RAW` - RAW
        #   - `BASE64` - BASE64
        #   - `GZIP_BASE64` - GZIP_BASE64
        @encoding = encoding
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["encoding"].nil?
          ...
          encoding = Hris::MultipartFormFieldRequestEncoding.from_json(json_object: encoding)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.encoding.nil? || Hris::MultipartFormFieldRequestEncoding.validate_raw(obj: obj.encoding)
