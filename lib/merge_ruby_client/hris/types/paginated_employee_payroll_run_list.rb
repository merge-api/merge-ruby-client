...
require_relative "employee_payroll_run"
require "ostruct"
require "json"
...
module Merge
  module Hris
    class PaginatedEmployeePayrollRunList
      ...
      # @return [Array<Merge::Hris::EmployeePayrollRun>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::EmployeePayrollRun>]
      ...
      # Deserialize a JSON object to an instance of PaginatedEmployeePayrollRunList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::EmployeePayrollRun.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedEmployeePayrollRunList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
