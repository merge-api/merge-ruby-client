...
module Merge
  module Hris
    ...
    class AccountDetailsAndActions
      # @return [String]
      attr_reader :id
      # @return [Merge::Hris::CategoryEnum]
      attr_reader :category
      # @return [Merge::Hris::AccountDetailsAndActionsStatusEnum]
      attr_reader :status
      # @return [String]
      ...
      # @param id [String]
      # @param category [Merge::Hris::CategoryEnum]
      # @param status [Merge::Hris::AccountDetailsAndActionsStatusEnum]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["integration"].nil?
          ...
          integration = Merge::Hris::AccountDetailsAndActionsIntegration.from_json(json_object: integration)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.category&.is_a?(Merge::Hris::CategoryEnum) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
        obj.status.is_a?(Merge::Hris::AccountDetailsAndActionsStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
