...
module Merge
  module Hris
    ...
    class DataPassthroughRequest
      ...
      # @param method [Merge::Hris::MethodEnum]
      ...
      def self.validate_raw(obj:)
        obj.method.is_a?(Merge::Hris::MethodEnum) != false || raise("Passed value for field obj.method is not the expected type, validation failed.")
