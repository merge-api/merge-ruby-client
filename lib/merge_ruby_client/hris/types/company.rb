...
module Merge
  module Hris
    ...
    class Company
      attr_reader :id, :remote_id, :legal_name, :display_name, :eins, :remote_was_deleted, :created_at, :modified_at,
      ...
      # @return [Hris::Company]
      def initialize(id: nil, remote_id: nil, legal_name: nil, display_name: nil, eins: nil, remote_was_deleted: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, legal_name: legal_name, display_name: display_name, eins: eins,
