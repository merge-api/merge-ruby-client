...
module Merge
  module Hris
    class FieldMappingApiInstanceResponse
      # @return [Array<Merge::Hris::FieldMappingApiInstance>]
      attr_reader :benefit
      # @return [Array<Merge::Hris::FieldMappingApiInstance>]
      ...
      # @param benefit [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param employer_benefit [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param company [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param employee_payroll_run [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param employee [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param employment [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param location [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param payroll_run [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param team [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param time_off [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param time_off_balance [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param bank_info [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param pay_group [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param group [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param dependent [Array<Merge::Hris::FieldMappingApiInstance>]
      # @param timesheet_entry [Array<Merge::Hris::FieldMappingApiInstance>]
      ...
      def self.from_json(json_object:)
        ...
        benefit = parsed_json["Benefit"]&.map do |v|
          v = v.to_json
          Merge::Hris::FieldMappingApiInstance.from_json(json_object: v)
        end
