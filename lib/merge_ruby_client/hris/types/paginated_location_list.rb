...
module Merge
  module Hris
    class PaginatedLocationList
      ...
      # @return [Array<Merge::Hris::Location>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::Location>]
      ...
      # Deserialize a JSON object to an instance of PaginatedLocationList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::Location.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedLocationList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
