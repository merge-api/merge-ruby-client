...
module Merge
  module Hris
    class IndividualCommonModelScopeDeserializerRequest
      ...
      # @return [Hash{String => Merge::Hris::ModelPermissionDeserializerRequest}]
      attr_reader :model_permissions
      # @return [Merge::Hris::FieldPermissionDeserializerRequest]
      ...
      # @param model_permissions [Hash{String => Merge::Hris::ModelPermissionDeserializerRequest}]
      # @param field_permissions [Merge::Hris::FieldPermissionDeserializerRequest]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Hris::IndividualCommonModelScopeDeserializerRequest]
      ...
      def self.from_json(json_object:)
        ...
        model_permissions = parsed_json["model_permissions"]&.transform_values do |value|
          value = value.to_json
          Merge::Hris::ModelPermissionDeserializerRequest.from_json(json_object: value)
        end
        if parsed_json["field_permissions"].nil?
          field_permissions = nil
        else
          field_permissions = parsed_json["field_permissions"].to_json
          field_permissions = Merge::Hris::FieldPermissionDeserializerRequest.from_json(json_object: field_permissions)
        end
        new(
          model_name: model_name,
          model_permissions: model_permissions,
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_permissions.nil? || Merge::Hris::FieldPermissionDeserializerRequest.validate_raw(obj: obj.field_permissions)
      end
    end
  end
end
