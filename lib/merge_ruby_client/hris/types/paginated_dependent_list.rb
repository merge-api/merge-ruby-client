...
module Merge
  module Hris
    class PaginatedDependentList
      ...
      # @return [Array<Merge::Hris::Dependent>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::Dependent>]
      ...
      # Deserialize a JSON object to an instance of PaginatedDependentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::Dependent.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedDependentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
