...
module Merge
  module Hris
    class AccountIntegration
      ...
      # @param categories [Array<Hris::CATEGORIES_ENUM>] Category or categories this integration belongs to. Multiple categories should be comma separated, i.e. [ats, hris].
      ...
      # @return [Hris::AccountIntegration]
      def initialize(name:, categories: nil, image: nil, square_image: nil, color: nil, slug: nil, is_in_beta: nil,
        ...
        @name = name
        # @type [Array<Hris::CATEGORIES_ENUM>] Category or categories this integration belongs to. Multiple categories should be comma separated, i.e. [ats, hris].
