...
module Merge
  module Hris
    class PaginatedPayGroupList
      ...
      # @param results [Array<Hris::PayGroup>]
      ...
      def initialize(next_: nil, previous: nil, results: nil, additional_properties: nil)
        ...
        # @type [String]
        @previous = previous
        # @type [Array<Hris::PayGroup>]
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of PaginatedPayGroupList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          Hris::PayGroup.from_json(json_object: v)
        end
        new(next_: next_, previous: previous, results: results, additional_properties: struct)
      end

      # Serialize an instance of PaginatedPayGroupList to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
