...
module Merge
  module Hris
    class ErrorValidationProblem
      # @return [Merge::Hris::ValidationProblemSource]
      attr_reader :source
      # @return [String]
      attr_reader :title
      # @return [String]
      ...
      # @param source [Merge::Hris::ValidationProblemSource]
      # @param title [String]
      # @param detail [String]
      # @param problem_type [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Hris::ErrorValidationProblem]
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Merge::Hris::ValidationProblemSource.validate_raw(obj: obj.source)
