...
module Merge
  module Hris
    class PaginatedPayrollRunList
      ...
      # @return [Array<Merge::Hris::PayrollRun>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Hris::PayrollRun>]
      ...
      # Deserialize a JSON object to an instance of PaginatedPayrollRunList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Hris::PayrollRun.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedPayrollRunList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
