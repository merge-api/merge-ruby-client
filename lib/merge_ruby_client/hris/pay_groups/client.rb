...
require "date"
require_relative "../types/paginated_pay_group_list"
require_relative "../types/pay_group"
require "async"
...
module Merge
  module Hris
    class PayGroupsClient
      ...
      #  )
      #  api.hris.pay_groups.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(created_after: nil, created_before: nil, cursor: nil, include_deleted_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/pay-groups"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.pay_groups.retrieve(id: "id")
      def retrieve(id:, include_remote_data: nil, include_shell_data: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/pay-groups/#{id}"
        end
        Merge::Hris::PayGroup.from_json(json_object: response.body)
      end
    end
