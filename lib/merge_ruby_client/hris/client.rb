...
module Merge
  module Hris
    class HrisClient
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.field_mappings_destroy(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.field_mappings_partial_update(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.remote_fields_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.target_fields_retrieve
    ...
    class AsyncHrisClient
      ...
      # @return [Merge::Hris::AsyncHrisClient]
      def initialize(request_client:)
        @request_client = request_client
      end
