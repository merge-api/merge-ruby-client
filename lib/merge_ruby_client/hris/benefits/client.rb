...
require "date"
require_relative "../types/paginated_benefit_list"
require_relative "../types/benefit"
require "async"
...
module Merge
  module Hris
    class BenefitsClient
      ...
      # @param employee_id [String] If provided, will return the benefits associated with the employee.
      ...
      #  )
      #  api.hris.benefits.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(created_after: nil, created_before: nil, cursor: nil, employee_id: nil, expand: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/benefits"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.hris.benefits.retrieve(id: "id")
      def retrieve(id:, expand: nil, include_remote_data: nil, include_shell_data: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/benefits/#{id}"
        end
        Merge::Hris::Benefit.from_json(json_object: response.body)
      end
    end
