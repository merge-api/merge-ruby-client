...
module Merge
  module Hris
    class AccountDetailsClient
      ...
      #  )
      #  api.hris.account_details.retrieve
      def retrieve(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/hris/v1/account-details"
        end
        Merge::Hris::AccountDetails.from_json(json_object: response.body)
      end
    end
