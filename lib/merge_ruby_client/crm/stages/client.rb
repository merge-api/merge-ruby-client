...
module Merge
  module Crm
    class StagesClient
      ...
      # Returns a list of `Stage` objects.{/* BEGIN_CRM_STAGE_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  s9+mN6jSNGsW3Nnr8Bj/gdy8uvWnsbxX804W+9lLt2fq53M5TcV3mgYT6/HP9wpt5/+AaL6tzCJFwAA"
      ...
      #  )
      #  api.crm.stages.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      ...
      #  BEGIN_CRM_STAGE_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  s9+mN6jSNGsW3Nnr8Bj/gdy8uvWnsbxX804W+9lLt2fq53M5TcV3mgYT6/HP9wpt5/+AaL6tzCJFwAA"
      #  /></Footer>{/* END_CRM_STAGE_FETCH_SUPPORTED_FIELDS * /}
      #
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.stages.remote_field_classes_list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
