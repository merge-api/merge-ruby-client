...
module Merge
  module Crm
    class EngagementTypesClient
      ...
      #  )
      #  api.crm.engagement_types.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.engagement_types.remote_field_classes_list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
