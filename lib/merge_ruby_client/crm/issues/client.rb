...
module Merge
  module Crm
    class IssuesClient
      ...
      #  this time
      # @param status [Merge::Crm::Issues::IssuesListRequestStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      # @param request_options [Merge::RequestOptions]
      # @return [Merge::Crm::PaginatedIssueList]
      # @example
      ...
      #  )
      #  api.crm.issues.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(account_token: nil, cursor: nil, end_date: nil, end_user_organization_name: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/crm/v1/issues"
        end
        Merge::Crm::PaginatedIssueList.from_json(json_object: response.body)
      end
      ...
      def retrieve(id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/crm/v1/issues/#{id}"
        end
        Merge::Crm::Issue.from_json(json_object: response.body)
      end
    end
