...
module Merge
  module Crm
    class CustomObjectClassesClient
      ...
      #  )
      #  api.crm.custom_object_classes.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(created_after: nil, created_before: nil, cursor: nil, expand: nil, include_deleted_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/crm/v1/custom-object-classes"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.custom_object_classes.retrieve(id: "id")
      def retrieve(id:, expand: nil, include_remote_data: nil, include_shell_data: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/crm/v1/custom-object-classes/#{id}"
        end
        Merge::Crm::CustomObjectClass.from_json(json_object: response.body)
      end
    end
