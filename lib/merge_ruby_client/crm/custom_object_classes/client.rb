...
require "date"
require_relative "../types/paginated_custom_object_class_list"
require_relative "../types/custom_object_class"
require "async"
...
module Merge
  module Crm
    class CustomObjectClassesClient
      ...
      # @return [Crm::CustomObjectClassesClient]
      ...
      # @return [Crm::PaginatedCustomObjectClassList]
      def list(created_after: nil, created_before: nil, cursor: nil, expand: nil, include_deleted_data: nil,
        ...
        response = @request_client.conn.get("/api/crm/v1/custom-object-classes") do |req|
        ...
        Crm::PaginatedCustomObjectClassList.from_json(json_object: response.body)
      end
      ...
      def retrieve(id:, expand: nil, include_remote_data: nil, request_options: nil)
        response = @request_client.conn.get("/api/crm/v1/custom-object-classes/#{id}") do |req|
          req.options.timeout = request_options.timeout_in_seconds unless request_options&.timeout_in_seconds.nil?
          req.headers["Authorization"] = request_options.api_key unless request_options&.api_key.nil?
          req.headers["X-Account-Token"] = request_options.account_token unless request_options&.account_token.nil?
          req.headers = { **req.headers, **(request_options&.additional_headers || {}) }.compact
        ...
        Crm::CustomObjectClass.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncCustomObjectClassesClient
      ...
      # @return [Crm::AsyncCustomObjectClassesClient]
      def initialize(request_client:)
