...
module Merge
  module Crm
    class LinkTokenClient
      ...
      # @param completed_account_initial_screen [Merge::Crm::COMPLETED_ACCOUNT_INITIAL_SCREEN_ENUM] When creating a Link token, you can specifiy the initial screen of Linking Flow
