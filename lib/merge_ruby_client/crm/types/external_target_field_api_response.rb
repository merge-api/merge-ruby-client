...
module Merge
  module Crm
    class ExternalTargetFieldApiResponse
      # @return [Array<Merge::Crm::ExternalTargetFieldApi>]
      attr_reader :account
      # @return [Array<Merge::Crm::ExternalTargetFieldApi>]
      attr_reader :contact
      # @return [Array<Merge::Crm::ExternalTargetFieldApi>]
      ...
      # @param account [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param contact [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param lead [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param note [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param opportunity [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param stage [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param user [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param task [Array<Merge::Crm::ExternalTargetFieldApi>]
      # @param engagement [Array<Merge::Crm::ExternalTargetFieldApi>]
