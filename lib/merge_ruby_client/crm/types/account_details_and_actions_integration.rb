...
module Merge
  module Crm
    class AccountDetailsAndActionsIntegration
      ...
      # @param name [String]
      # @param categories [Array<Crm::CATEGORIES_ENUM>]
      # @param image [String]
      # @param square_image [String]
      # @param color [String]
      # @param slug [String]
      # @param passthrough_available [Boolean]
      # @param available_model_operations [Array<Crm::ModelOperation>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Crm::AccountDetailsAndActionsIntegration]
      def initialize(name:, categories:, color:, slug:, passthrough_available:, image: nil, square_image: nil,
        ...
        # @type [String]
        @name = name
        # @type [Array<Crm::CATEGORIES_ENUM>]
      ...
      def self.from_json(json_object:)
        ...
        available_model_operations = parsed_json["available_model_operations"]&.map do |v|
          v = v.to_json
          Crm::ModelOperation.from_json(json_object: v)
        end
