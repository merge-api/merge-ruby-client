...
module Merge
  module Crm
    class ItemSchema
      # @return [Merge::Crm::ItemTypeEnum]
      attr_reader :item_type
      # @return [Merge::Crm::ItemFormatEnum]
      ...
      # @param item_type [Merge::Crm::ItemTypeEnum]
      # @param item_format [Merge::Crm::ItemFormatEnum]
      ...
      def self.validate_raw(obj:)
        obj.item_type&.is_a?(Merge::Crm::ItemTypeEnum) != false || raise("Passed value for field obj.item_type is not the expected type, validation failed.")
        obj.item_format&.is_a?(Merge::Crm::ItemFormatEnum) != false || raise("Passed value for field obj.item_format is not the expected type, validation failed.")
