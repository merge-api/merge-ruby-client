  ...
  module Crm
    class ItemSchema
      ...
      def self.from_json(json_object:)
        ...
        item_type = Crm::ITEM_TYPE_ENUM.key(parsed_json["item_type"]) || parsed_json["item_type"]
        item_format = Crm::ITEM_FORMAT_ENUM.key(parsed_json["item_format"]) || parsed_json["item_format"]
      ...
      def to_json(*_args)
        {
          "item_type": Crm::ITEM_TYPE_ENUM[@item_type] || @item_type,
          "item_format": Crm::ITEM_FORMAT_ENUM[@item_format] || @item_format,
          "item_choices": @item_choices
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        obj.item_type&.is_a?(Crm::ITEM_TYPE_ENUM) != false || raise("Passed value for field obj.item_type is not the expected type, validation failed.")
        obj.item_format&.is_a?(Crm::ITEM_FORMAT_ENUM) != false || raise("Passed value for field obj.item_format is not the expected type, validation failed.")
