...
require_relative "patched_engagement_request_direction"
require "date"
...
module Merge
  module Crm
    ...
    class PatchedEngagementRequest
      ...
      # @param direction [Crm::PatchedEngagementRequestDirection] The engagement's direction.
      #   - `INBOUND` - INBOUND
      #   - `OUTBOUND` - OUTBOUND
      ...
      def initialize(owner: nil, content: nil, subject: nil, direction: nil, engagement_type: nil, start_time: nil,
        ...
        @subject = subject
        # @type [Crm::PatchedEngagementRequestDirection] The engagement's direction.
        #   - `INBOUND` - INBOUND
        #   - `OUTBOUND` - OUTBOUND
        @direction = direction
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["direction"].nil?
          direction = nil
        else
          direction = parsed_json["direction"].to_json
          direction = Crm::PatchedEngagementRequestDirection.from_json(json_object: direction)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.direction.nil? || Crm::PatchedEngagementRequestDirection.validate_raw(obj: obj.direction)
