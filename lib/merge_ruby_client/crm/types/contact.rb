  ...
  module Crm
    ...
    class Contact
      attr_reader :first_name, :last_name, :account, :owner, :addresses, :email_addresses, :phone_numbers,
                  :last_activity_at, :remote_created_at, :remote_was_deleted, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :remote_fields, :additional_properties
      ...
      def initialize(first_name: nil, last_name: nil, account: nil, owner: nil, addresses: nil, email_addresses: nil,
                     phone_numbers: nil, last_activity_at: nil, remote_created_at: nil, remote_was_deleted: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, remote_fields: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(first_name: first_name, last_name: last_name, account: account, owner: owner, addresses: addresses,
            email_addresses: email_addresses, phone_numbers: phone_numbers, last_activity_at: last_activity_at, remote_created_at: remote_created_at, remote_was_deleted: remote_was_deleted, id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, remote_fields: remote_fields, additional_properties: struct)
      end
