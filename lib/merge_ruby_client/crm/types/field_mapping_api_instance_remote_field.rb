...
module Merge
  module Crm
    class FieldMappingApiInstanceRemoteField
      ...
      # @param remote_endpoint_info [Merge::Crm::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_endpoint_info"].nil?
          ...
          remote_endpoint_info = Merge::Crm::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.from_json(json_object: remote_endpoint_info)
        end
        new(
          remote_key_name: remote_key_name,
          schema: schema,
      ...
      def self.validate_raw(obj:)
        ...
        Merge::Crm::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.validate_raw(obj: obj.remote_endpoint_info)
      end
    end
  end
end
