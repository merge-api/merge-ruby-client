...
module Merge
  module Crm
    class LinkedAccountSelectiveSyncConfiguration
      # @return [Array<Merge::Crm::LinkedAccountCondition>] The conditions belonging to a selective sync.
      ...
      # @param linked_account_conditions [Array<Merge::Crm::LinkedAccountCondition>] The conditions belonging to a selective sync.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Crm::LinkedAccountSelectiveSyncConfiguration]
      ...
      def self.from_json(json_object:)
        ...
        linked_account_conditions = parsed_json["linked_account_conditions"]&.map do |v|
          v = v.to_json
          Merge::Crm::LinkedAccountCondition.from_json(json_object: v)
        end
