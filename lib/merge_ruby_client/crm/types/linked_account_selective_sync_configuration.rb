...
module Merge
  module Crm
    class LinkedAccountSelectiveSyncConfiguration
      ...
      # @param linked_account_conditions [Array<Crm::LinkedAccountCondition>] The conditions belonging to a selective sync.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Crm::LinkedAccountSelectiveSyncConfiguration]
      def initialize(linked_account_conditions: nil, additional_properties: nil)
        # @type [Array<Crm::LinkedAccountCondition>] The conditions belonging to a selective sync.
      ...
      def self.from_json(json_object:)
        ...
        linked_account_conditions = parsed_json["linked_account_conditions"]&.map do |v|
          v = v.to_json
          Crm::LinkedAccountCondition.from_json(json_object: v)
        end
