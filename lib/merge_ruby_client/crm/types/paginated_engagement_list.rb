...
module Merge
  module Crm
    class PaginatedEngagementList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Crm::Engagement>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Crm::Engagement>]
      ...
      # Deserialize a JSON object to an instance of PaginatedEngagementList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Crm::Engagement.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedEngagementList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
