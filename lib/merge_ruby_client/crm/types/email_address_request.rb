...
module Merge
  module Crm
    ...
    class EmailAddressRequest
      attr_reader :email_address, :email_address_type, :integration_params, :linked_account_params,
      ...
      def initialize(email_address: nil, email_address_type: nil, integration_params: nil, linked_account_params: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(email_address: email_address, email_address_type: email_address_type,
