...
module Merge
  module Crm
    class LeadResponse
      ...
      # Deserialize a JSON object to an instance of LeadResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Crm::Lead.from_json(json_object: model)
        end
      ...
      # Serialize an instance of LeadResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Crm::Lead.validate_raw(obj: obj.model)
