...
module Merge
  module Crm
    class IndividualCommonModelScopeDeserializerRequest
      ...
      # @return [Hash{String => Merge::Crm::ModelPermissionDeserializerRequest}]
      ...
      # @param model_permissions [Hash{String => Merge::Crm::ModelPermissionDeserializerRequest}]
      # @param field_permissions [Merge::Crm::FieldPermissionDeserializerRequest]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Crm::IndividualCommonModelScopeDeserializerRequest]
      ...
      def self.from_json(json_object:)
        ...
        model_permissions = parsed_json["model_permissions"]&.transform_values do |value|
          value = value.to_json
          Merge::Crm::ModelPermissionDeserializerRequest.from_json(json_object: value)
        end
        if parsed_json["field_permissions"].nil?
          field_permissions = nil
        else
          field_permissions = parsed_json["field_permissions"].to_json
          field_permissions = Merge::Crm::FieldPermissionDeserializerRequest.from_json(json_object: field_permissions)
        end
        new(
          model_name: model_name,
          model_permissions: model_permissions,
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_permissions.nil? || Merge::Crm::FieldPermissionDeserializerRequest.validate_raw(obj: obj.field_permissions)
      end
    end
  end
end
