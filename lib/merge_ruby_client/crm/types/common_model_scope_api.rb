...
module Merge
  module Crm
    class CommonModelScopeApi
      # @return [Array<Merge::Crm::IndividualCommonModelScopeDeserializer>] The common models you want to update the scopes for
      ...
      # @param common_models [Array<Merge::Crm::IndividualCommonModelScopeDeserializer>] The common models you want to update the scopes for
      ...
      def self.from_json(json_object:)
        ...
        common_models = parsed_json["common_models"]&.map do |item|
          item = item.to_json
          Merge::Crm::IndividualCommonModelScopeDeserializer.from_json(json_object: item)
        end
