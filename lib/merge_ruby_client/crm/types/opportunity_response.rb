...
module Merge
  module Crm
    class OpportunityResponse
      ...
      # @param model [Merge::Crm::Opportunity]
      ...
      # Deserialize a JSON object to an instance of OpportunityResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Crm::Opportunity.from_json(json_object: model)
        end
      ...
      # Serialize an instance of OpportunityResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Crm::Opportunity.validate_raw(obj: obj.model)
