  ...
  module Crm
    class AssociationAssociationType
      ...
      def self.from_json(json_object:)
        ...
        begin
          Merge::Crm::AssociationType.validate_raw(obj: struct)
          return Merge::Crm::AssociationType.from_json(json_object: json_object) unless json_object.nil?
      ...
      def self.validate_raw(obj:)
        ...
        begin
          return Merge::Crm::AssociationType.validate_raw(obj: obj)
        rescue StandardError
          # noop
        end
