...
module Merge
  module Crm
    ...
    class Association
      ...
      def initialize(source_object: nil, target_object: nil, association_type: nil, created_at: nil, modified_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(source_object: source_object, target_object: target_object, association_type: association_type,
            created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
