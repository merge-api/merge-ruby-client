...
module Merge
  module Crm
    class IndividualCommonModelScopeDeserializer
      ...
      # @return [Hash{String => Merge::Crm::ModelPermissionDeserializer}]
      attr_reader :model_permissions
      # @return [Merge::Crm::FieldPermissionDeserializer]
      ...
      # @param model_permissions [Hash{String => Merge::Crm::ModelPermissionDeserializer}]
      # @param field_permissions [Merge::Crm::FieldPermissionDeserializer]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Crm::IndividualCommonModelScopeDeserializer]
      ...
      def self.from_json(json_object:)
        ...
        model_permissions = parsed_json["model_permissions"]&.transform_values do |value|
          value = value.to_json
          Merge::Crm::ModelPermissionDeserializer.from_json(json_object: value)
        end
        if parsed_json["field_permissions"].nil?
          field_permissions = nil
        else
          field_permissions = parsed_json["field_permissions"].to_json
          field_permissions = Merge::Crm::FieldPermissionDeserializer.from_json(json_object: field_permissions)
        end
        new(
          model_name: model_name,
          model_permissions: model_permissions,
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_permissions.nil? || Merge::Crm::FieldPermissionDeserializer.validate_raw(obj: obj.field_permissions)
      end
    end
  end
end
