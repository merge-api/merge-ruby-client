...
module Merge
  module Crm
    ...
    class AccountDetailsAndActions
      # @return [String]
      attr_reader :id
      # @return [Merge::Crm::CategoryEnum]
      attr_reader :category
      # @return [Merge::Crm::AccountDetailsAndActionsStatusEnum]
      attr_reader :status
      # @return [String]
      ...
      # @param id [String]
      # @param category [Merge::Crm::CategoryEnum]
      # @param status [Merge::Crm::AccountDetailsAndActionsStatusEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.category&.is_a?(Merge::Crm::CategoryEnum) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
        obj.status.is_a?(Merge::Crm::AccountDetailsAndActionsStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
