...
module Merge
  module Crm
    class PaginatedAssociationList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Crm::Association>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Crm::Association>]
      ...
      # Deserialize a JSON object to an instance of PaginatedAssociationList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Crm::Association.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedAssociationList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
