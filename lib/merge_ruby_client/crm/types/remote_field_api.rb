...
module Merge
  module Crm
    class RemoteFieldApi
      ...
      # @return [Merge::Crm::RemoteEndpointInfo]
      attr_reader :remote_endpoint_info
      # @return [Array<Object>]
      attr_reader :example_values
      # @return [Merge::Crm::AdvancedMetadata]
      attr_reader :advanced_metadata
      # @return [Merge::Crm::RemoteFieldApiCoverage]
      ...
      # @param remote_endpoint_info [Merge::Crm::RemoteEndpointInfo]
      # @param example_values [Array<Object>]
      # @param advanced_metadata [Merge::Crm::AdvancedMetadata]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_endpoint_info"].nil?
          ...
          remote_endpoint_info = Merge::Crm::RemoteEndpointInfo.from_json(json_object: remote_endpoint_info)
        end
        ...
        if parsed_json["advanced_metadata"].nil?
          ...
          advanced_metadata = Merge::Crm::AdvancedMetadata.from_json(json_object: advanced_metadata)
        end
        if parsed_json["coverage"].nil?
          coverage = nil
        else
          coverage = parsed_json["coverage"].to_json
          coverage = Merge::Crm::RemoteFieldApiCoverage.from_json(json_object: coverage)
        end
        new(
          schema: schema,
          remote_key_name: remote_key_name,
