  ...
  module Crm
    class ConditionSchema
      ...
      def self.from_json(json_object:)
        ...
        condition_type = Crm::CONDITION_TYPE_ENUM.key(parsed_json["condition_type"]) || parsed_json["condition_type"]
      ...
      def to_json(*_args)
        {
          ...
          "field_name": @field_name,
          "is_unique": @is_unique,
          "condition_type": Crm::CONDITION_TYPE_ENUM[@condition_type] || @condition_type,
          "operators": @operators
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.condition_type.is_a?(Crm::CONDITION_TYPE_ENUM) != false || raise("Passed value for field obj.condition_type is not the expected type, validation failed.")
