...
module Merge
  module Crm
    class AuditLogEvent
      ...
      # @return [Merge::Crm::RoleEnum] Designates the role of the user (or SYSTEM/API if action not taken by a user) at
      ...
      # @return [Merge::Crm::EventTypeEnum] Designates the type of event that occurred.
      ...
      # @param role [Merge::Crm::RoleEnum] Designates the role of the user (or SYSTEM/API if action not taken by a user) at
      #  the time of this Event occurring.
      #  - `ADMIN` - ADMIN
      #  - `DEVELOPER` - DEVELOPER
      #  - `MEMBER` - MEMBER
      ...
      # @param event_type [Merge::Crm::EventTypeEnum] Designates the type of event that occurred.
      #  - `CREATED_REMOTE_PRODUCTION_API_KEY` - CREATED_REMOTE_PRODUCTION_API_KEY
      #  - `DELETED_REMOTE_PRODUCTION_API_KEY` - DELETED_REMOTE_PRODUCTION_API_KEY
      #  - `CREATED_TEST_API_KEY` - CREATED_TEST_API_KEY
      #  - `DELETED_TEST_API_KEY` - DELETED_TEST_API_KEY
      ...
      # @return [Merge::Crm::AuditLogEvent]
      ...
      def self.validate_raw(obj:)
        ...
        obj.role.is_a?(Merge::Crm::RoleEnum) != false || raise("Passed value for field obj.role is not the expected type, validation failed.")
        obj.ip_address.is_a?(String) != false || raise("Passed value for field obj.ip_address is not the expected type, validation failed.")
        obj.event_type.is_a?(Merge::Crm::EventTypeEnum) != false || raise("Passed value for field obj.event_type is not the expected type, validation failed.")
