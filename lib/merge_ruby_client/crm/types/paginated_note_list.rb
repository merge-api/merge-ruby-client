...
module Merge
  module Crm
    class PaginatedNoteList
      ...
      # @param results [Array<Merge::Crm::Note>]
      ...
      # Deserialize a JSON object to an instance of PaginatedNoteList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Crm::Note.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedNoteList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
