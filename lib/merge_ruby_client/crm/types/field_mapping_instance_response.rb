...
module Merge
  module Crm
    class FieldMappingInstanceResponse
      ...
      # @param model [Merge::Crm::FieldMappingApiInstance]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Crm::FieldMappingApiInstance.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Crm::FieldMappingApiInstance.validate_raw(obj: obj.model)
