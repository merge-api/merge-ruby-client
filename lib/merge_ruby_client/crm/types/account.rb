...
module Merge
  module Crm
    ...
    # TODO
    class Account
      attr_reader :owner, :name, :description, :industry, :website, :number_of_employees, :addresses, :phone_numbers,
                  :last_activity_at, :remote_updated_at, :remote_created_at, :remote_was_deleted, :id, :remote_id, :created_at, :modified_at, :field_mappings, :remote_data, :remote_fields, :additional_properties
      ...
      def initialize(owner: nil, name: nil, description: nil, industry: nil, website: nil, number_of_employees: nil,
                     addresses: nil, phone_numbers: nil, last_activity_at: nil, remote_updated_at: nil, remote_created_at: nil, remote_was_deleted: nil, id: nil, remote_id: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, remote_fields: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(owner: owner, name: name, description: description, industry: industry, website: website,
            number_of_employees: number_of_employees, addresses: addresses, phone_numbers: phone_numbers, last_activity_at: last_activity_at, remote_updated_at: remote_updated_at, remote_created_at: remote_created_at, remote_was_deleted: remote_was_deleted, id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, remote_fields: remote_fields, additional_properties: struct)
      end
