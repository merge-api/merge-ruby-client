...
module Merge
  module Crm
    class RemoteField
      ...
      # @param remote_field_class [Merge::Crm::RemoteFieldClass]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_field_class"].nil?
          ...
          remote_field_class = Merge::Crm::RemoteFieldClass.from_json(json_object: remote_field_class)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Crm::RemoteFieldClass.validate_raw(obj: obj.remote_field_class)
