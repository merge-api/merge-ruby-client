...
module Merge
  module Crm
    class RemoteFieldRequest
      ...
      # @param remote_field_class [String]
      ...
      def self.from_json(json_object:)
        ...
        remote_field_class = parsed_json["remote_field_class"]
      ...
      def self.validate_raw(obj:)
        obj.remote_field_class.is_a?(String) != false || raise("Passed value for field obj.remote_field_class is not the expected type, validation failed.")
