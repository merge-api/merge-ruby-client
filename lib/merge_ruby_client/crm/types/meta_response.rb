...
module Merge
  module Crm
    class MetaResponse
      ...
      # @param status [Merge::Crm::LinkedAccountStatus]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["status"].nil?
          ...
          status = Merge::Crm::LinkedAccountStatus.from_json(json_object: status)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Merge::Crm::LinkedAccountStatus.validate_raw(obj: obj.status)
