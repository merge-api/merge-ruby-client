...
module Merge
  module Crm
    class ErrorValidationProblem
      ...
      # @param source [Merge::Crm::ValidationProblemSource]
      # @param title [String]
      # @param detail [String]
      # @param problem_type [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Crm::ErrorValidationProblem]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["source"].nil?
          ...
          source = Merge::Crm::ValidationProblemSource.from_json(json_object: source)
        end
        title = struct["title"]
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Merge::Crm::ValidationProblemSource.validate_raw(obj: obj.source)
