    ...
    class ErrorValidationProblem
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["source"].nil?
          ...
          source = Crm::ValidationProblemSource.from_json(json_object: source)
        end
        title = struct.title
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Crm::ValidationProblemSource.validate_raw(obj: obj.source)
