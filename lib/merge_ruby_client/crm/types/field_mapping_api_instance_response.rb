...
module Merge
  module Crm
    class FieldMappingApiInstanceResponse
      # @return [Array<Merge::Crm::FieldMappingApiInstance>]
      attr_reader :account
      # @return [Array<Merge::Crm::FieldMappingApiInstance>]
      attr_reader :contact
      # @return [Array<Merge::Crm::FieldMappingApiInstance>]
      ...
      # @param account [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param contact [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param lead [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param note [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param opportunity [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param stage [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param user [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param task [Array<Merge::Crm::FieldMappingApiInstance>]
      # @param engagement [Array<Merge::Crm::FieldMappingApiInstance>]
      ...
      def self.from_json(json_object:)
        ...
        account = parsed_json["Account"]&.map do |v|
          v = v.to_json
          Merge::Crm::FieldMappingApiInstance.from_json(json_object: v)
        end
