...
module Merge
  module Crm
    ...
    class CustomObjectClass
      attr_reader :name, :description, :labels, :fields, :association_types, :id, :remote_id, :created_at,
      ...
      def initialize(name: nil, description: nil, labels: nil, fields: nil, association_types: nil, id: nil,
                     remote_id: nil, created_at: nil, modified_at: nil, additional_properties: nil)
        # @type [String]
        @name = name
        # @type [String]
      ...
      def self.from_json(json_object:)
        ...
        new(name: name, description: description, labels: labels, fields: fields, association_types: association_types,
            id: id, remote_id: remote_id, created_at: created_at, modified_at: modified_at, additional_properties: struct)
      end
