...
module Merge
  module Crm
    class EngagementResponse
      ...
      # @param model [Merge::Crm::Engagement]
      ...
      # Deserialize a JSON object to an instance of EngagementResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Crm::Engagement.from_json(json_object: model)
        end
      ...
      # Serialize an instance of EngagementResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        Merge::Crm::Engagement.validate_raw(obj: obj.model)
