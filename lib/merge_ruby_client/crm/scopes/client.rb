...
module Merge
  module Crm
    class ScopesClient
      ...
      #  )
      #  api.crm.scopes.default_scopes_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.scopes.linked_account_scopes_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.scopes.linked_account_scopes_create(common_models: [{ model_name: "Employee", model_permissions: { "READ": { is_enabled: true }, "WRITE": { is_enabled: false } }, field_permissions: { enabled_fields: ["avatar", "home_location"], disabled_fields: ["work_location"] } }, { model_name: "Benefit", model_permissions: { "WRITE": { is_enabled: false } } }])
