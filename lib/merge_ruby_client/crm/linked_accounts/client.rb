...
module Merge
  module Crm
    class LinkedAccountsClient
      ...
      #
      # @param category [Merge::Crm::LinkedAccounts::LinkedAccountsListRequestCategory] Options: `accounting`, `ats`, `crm`, `filestorage`, `hris`, `mktg`, `ticketing`
      #  * `hris` - hris
      #  * `ats` - ats
      ...
      #  )
      #  api.crm.linked_accounts.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/crm/v1/linked-accounts"
        end
        Merge::Crm::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
