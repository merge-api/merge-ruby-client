...
module Merge
  module Crm
    class LinkedAccountsClient
      ...
      # @return [Crm::LinkedAccountsClient]
      ...
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        response = @request_client.conn.get("/api/crm/v1/linked-accounts") do |req|
        ...
        Crm::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncLinkedAccountsClient
      ...
      # @return [Crm::AsyncLinkedAccountsClient]
      def initialize(request_client:)
