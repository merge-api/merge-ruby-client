...
module Merge
  module Crm
    class AccountTokenClient
      ...
      #  )
      #  api.crm.account_token.retrieve(public_token: "public_token")
      ...
      #
      # @param request_options [Merge::RequestOptions]
      # @return [Merge::Crm::RegenerateAccountToken]
      # @example
      #  api = Merge::Client.new(
      #    base_url: "https://api.example.com",
      #    environment: Merge::Environment::PRODUCTION,
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.account_token.regenerate_create
      def regenerate_create(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/crm/v1/account-token/regenerate"
        end
        Merge::Crm::RegenerateAccountToken.from_json(json_object: response.body)
      end
    end
