...
module Merge
  module Crm
    class TasksClient
      ...
      # Returns a list of `Task` objects.{/* BEGIN_CRM_TASK_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  D9gEaPOWueN3cM2cNfK4Y8LcxgEv+/jy+M+wX/LTaSi+YRcilT8o1q5o4b1zK+Ey89/AhNW0cNDGQAA"
      #  /></Footer>{/* END_CRM_TASK_FETCH_SUPPORTED_FIELDS * /}
      #
      # @param created_after [DateTime] If provided, will only return objects created after this datetime.
      # @param created_before [DateTime] If provided, will only return objects created before this datetime.
      # @param cursor [String] The pagination cursor value.
      # @param expand [Merge::Crm::Tasks::ListTasksRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      ...
      #  )
      #  api.crm.tasks.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      ...
      #  BEGIN_CRM_TASK_CREATE_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="POST"
      #  e5oX3HCbwa9q86/+fDOsv+B1juOw/peoCA9kYq9scA/ee08e0+F/3fS/zLeuxHjx/HjD64N4oKzBgAA"
      #  /></Footer>{/* END_CRM_TASK_CREATE_SUPPORTED_FIELDS * /}
      #
      ...
      #  BEGIN_CRM_TASK_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  D9gEaPOWueN3cM2cNfK4Y8LcxgEv+/jy+M+wX/LTaSi+YRcilT8o1q5o4b1zK+Ey89/AhNW0cNDGQAA"
      #  /></Footer>{/* END_CRM_TASK_FETCH_SUPPORTED_FIELDS * /}
      #
      # @param id [String]
      # @param expand [Merge::Crm::Tasks::RetrieveTasksRequestExpand] Which relations should be returned in expanded form. Multiple relation names
      #  should be comma separated without spaces.
      # @param include_remote_data [Boolean] Whether to include the original data Merge fetched from the third-party to
      #  produce these models.
      # @param include_remote_fields [Boolean] Whether to include all remote fields, including fields that Merge did not map to
      ...
      #  BEGIN_CRM_TASK_EDIT_SUPPORTED_FIELDS * /}{/* END_CRM_TASK_EDIT_SUPPORTED_FIELDS
      #  * /}
      #
      # @param id [String]
      # @param is_debug_mode [Boolean] Whether to include debug fields (such as log file links) in the response.
      ...
      # Returns metadata for `Task` PATCHs.{/* BEGIN_CRM_TASK_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  D9gEaPOWueN3cM2cNfK4Y8LcxgEv+/jy+M+wX/LTaSi+YRcilT8o1q5o4b1zK+Ey89/AhNW0cNDGQAA"
      #  /></Footer>{/* END_CRM_TASK_FETCH_SUPPORTED_FIELDS * /}
      #
      ...
      # Returns metadata for `Task` POSTs.{/* BEGIN_CRM_TASK_FETCH_SUPPORTED_FIELDS *
      #  /}<Footer><MergeSupportedFieldsByIntegrationWidget requestType="GET"
      #  D9gEaPOWueN3cM2cNfK4Y8LcxgEv+/jy+M+wX/LTaSi+YRcilT8o1q5o4b1zK+Ey89/AhNW0cNDGQAA"
      #  /></Footer>{/* END_CRM_TASK_FETCH_SUPPORTED_FIELDS * /}
      #
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.tasks.remote_field_classes_list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
