...
module Merge
  module Crm
    class AsyncPassthroughClient
      ...
      #  )
      #  api.crm.async_passthrough.create(request: { method: GET, path: "/scooters" })
      ...
      # @param request_options [Merge::RequestOptions]
      # @return [Merge::Crm::RemoteResponse, String]
      # @example
      #  api = Merge::Client.new(
      #    base_url: "https://api.example.com",
      #    environment: Merge::Environment::PRODUCTION,
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.crm.async_passthrough.retrieve(async_passthrough_receipt_id: "async_passthrough_receipt_id")
      def retrieve(async_passthrough_receipt_id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
        ...
        Merge::Crm::AsyncPassthrough::AsyncPassthroughRetrieveResponse.from_json(json_object: response.body)
      end
    end
