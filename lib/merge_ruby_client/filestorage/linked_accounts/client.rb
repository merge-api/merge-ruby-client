...
module Merge
  module Filestorage
    class LinkedAccountsClient
      ...
      # @return [Filestorage::LinkedAccountsClient]
      ...
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        response = @request_client.conn.get("/api/filestorage/v1/linked-accounts") do |req|
        ...
        Filestorage::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncLinkedAccountsClient
      ...
      # @return [Filestorage::AsyncLinkedAccountsClient]
      def initialize(request_client:)
