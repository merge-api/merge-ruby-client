...
module Merge
  module Filestorage
    class SyncStatusClient
      ...
      # @return [Filestorage::SyncStatusClient]
      ...
      # @return [Filestorage::PaginatedSyncStatusList]
      def list(cursor: nil, page_size: nil, request_options: nil)
        response = @request_client.conn.get("/api/filestorage/v1/sync-status") do |req|
        ...
        Filestorage::PaginatedSyncStatusList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncSyncStatusClient
      ...
      # @return [Filestorage::AsyncSyncStatusClient]
      def initialize(request_client:)
