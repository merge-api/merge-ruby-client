...
module Merge
  module Filestorage
    class GroupsClient
      ...
      #  )
      #  api.filestorage.groups.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(created_after: nil, created_before: nil, cursor: nil, expand: nil, include_deleted_data: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/filestorage/v1/groups"
        end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.filestorage.groups.retrieve(id: "id")
      def retrieve(id:, expand: nil, include_remote_data: nil, include_shell_data: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/filestorage/v1/groups/#{id}"
        end
        Merge::Filestorage::Group.from_json(json_object: response.body)
      end
    end
