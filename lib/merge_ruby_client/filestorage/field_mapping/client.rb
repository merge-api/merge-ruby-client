...
module Merge
  module Filestorage
    class FieldMappingClient
      ...
      #  )
      #  api.filestorage.field_mappings_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.filestorage.field_mappings_destroy(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.filestorage.field_mappings_partial_update(field_mapping_id: "field_mapping_id")
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.filestorage.remote_fields_retrieve
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.filestorage.target_fields_retrieve
