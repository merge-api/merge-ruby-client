...
module Merge
  module Filestorage
    class AuditTrailClient
      ...
      # @return [Filestorage::AuditTrailClient]
      ...
      # @return [Filestorage::PaginatedAuditLogEventList]
      def list(cursor: nil, end_date: nil, event_type: nil, page_size: nil, start_date: nil, user_email: nil,
               request_options: nil)
        response = @request_client.conn.get("/api/filestorage/v1/audit-trail") do |req|
        ...
        Filestorage::PaginatedAuditLogEventList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncAuditTrailClient
      ...
      # @return [Filestorage::AsyncAuditTrailClient]
      def initialize(request_client:)
