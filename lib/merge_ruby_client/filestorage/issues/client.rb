...
module Merge
  module Filestorage
    class IssuesClient
      ...
      #  this time
      # @param status [Merge::Filestorage::Issues::IssuesListRequestStatus] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  * `ONGOING` - ONGOING
      #  * `RESOLVED` - RESOLVED
      ...
      #  )
      #  api.filestorage.issues.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
