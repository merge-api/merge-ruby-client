...
module Merge
  module Filestorage
    class LinkTokenClient
      ...
      # @param language [Merge::Filestorage::LanguageEnum] The following subset of IETF language tags can be used to configure
      #  localization.
      #  * `en` - en
      #  * `de` - de
      ...
      # @param completed_account_initial_screen [Merge::Filestorage::COMPLETED_ACCOUNT_INITIAL_SCREEN_ENUM] When creating a Link token, you can specifiy the initial screen of Linking Flow
      ...
      #  )
      #  api.filestorage.link_token.create(
