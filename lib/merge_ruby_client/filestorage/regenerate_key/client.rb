...
module Merge
  module Filestorage
    class RegenerateKeyClient
      ...
      #  )
      #  api.filestorage.regenerate_key.create(name: "Remote Deployment Key 1")
      def create(name:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/filestorage/v1/regenerate-key"
        end
