...
module Merge
  module Filestorage
    class AvailableActionsClient
      ...
      #  )
      #  api.filestorage.available_actions.retrieve
      def retrieve(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/filestorage/v1/available-actions"
        end
        Merge::Filestorage::AvailableActions.from_json(json_object: response.body)
      end
    end
