...
module Merge
  module Filestorage
    class DebugModeLog
      ...
      # @param log_summary [Filestorage::DebugModelLogSummary]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Filestorage::DebugModeLog]
      def initialize(log_id:, dashboard_view:, log_summary:, additional_properties: nil)
        # @type [String]
        @log_id = log_id
        # @type [String]
        @dashboard_view = dashboard_view
        # @type [Filestorage::DebugModelLogSummary]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["log_summary"].nil?
          ...
          log_summary = Filestorage::DebugModelLogSummary.from_json(json_object: log_summary)
        end
      ...
      def self.validate_raw(obj:)
        ...
        Filestorage::DebugModelLogSummary.validate_raw(obj: obj.log_summary)
      end
    end
  end
end
