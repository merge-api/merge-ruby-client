...
module Merge
  module Filestorage
    class PaginatedIssueList
      ...
      # @return [Array<Merge::Filestorage::Issue>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Filestorage::Issue>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Filestorage::PaginatedIssueList]
      ...
      # Deserialize a JSON object to an instance of PaginatedIssueList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::Issue.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedIssueList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
