...
module Merge
  module Filestorage
    class PaginatedAccountDetailsAndActionsList
      ...
      # @return [Array<Merge::Filestorage::AccountDetailsAndActions>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Filestorage::AccountDetailsAndActions>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::AccountDetailsAndActions.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
