...
module Merge
  module Filestorage
    class FieldMappingApiInstanceRemoteField
      ...
      attr_reader :schema
      # @return [Merge::Filestorage::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo]
      ...
      # @param remote_endpoint_info [Merge::Filestorage::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["remote_endpoint_info"].nil?
          ...
          remote_endpoint_info = Merge::Filestorage::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.from_json(json_object: remote_endpoint_info)
        end
        new(
          remote_key_name: remote_key_name,
          schema: schema,
      ...
      def self.validate_raw(obj:)
        ...
        Merge::Filestorage::FieldMappingApiInstanceRemoteFieldRemoteEndpointInfo.validate_raw(obj: obj.remote_endpoint_info)
      end
    end
  end
end
