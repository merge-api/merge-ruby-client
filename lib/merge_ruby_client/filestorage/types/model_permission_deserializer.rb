...
module Merge
  module Filestorage
    class ModelPermissionDeserializer
      ...
      # @return [Merge::Filestorage::ModelPermissionDeserializer]
      ...
      # Deserialize a JSON object to an instance of ModelPermissionDeserializer
      #
      ...
      # Serialize an instance of ModelPermissionDeserializer to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
