...
module Merge
  module Filestorage
    class AccountIntegration
      ...
      # @param categories [Array<Filestorage::CATEGORIES_ENUM>] Category or categories this integration belongs to. Multiple categories should be comma separated, i.e. [ats, hris].
      ...
      # @return [Filestorage::AccountIntegration]
      def initialize(name:, categories: nil, image: nil, square_image: nil, color: nil, slug: nil, is_in_beta: nil,
        ...
        @name = name
        # @type [Array<Filestorage::CATEGORIES_ENUM>] Category or categories this integration belongs to. Multiple categories should be comma separated, i.e. [ats, hris].
      ...
      def self.from_json(json_object:)
        ...
        categories = parsed_json["categories"]&.map do |v|
          v = v.to_json
          Filestorage::CATEGORIES_ENUM.key(v) || v
        end
        image = struct.image
