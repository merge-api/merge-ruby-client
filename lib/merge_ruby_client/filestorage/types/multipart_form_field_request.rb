...
module Merge
  module Filestorage
    ...
    class MultipartFormFieldRequest
      ...
      # @param encoding [Filestorage::MultipartFormFieldRequestEncoding] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #   - `RAW` - RAW
      #   - `BASE64` - BASE64
      ...
      # @return [Filestorage::MultipartFormFieldRequest]
      def initialize(name:, data:, encoding: nil, file_name: nil, content_type: nil, additional_properties: nil)
        ...
        @data = data
        # @type [Filestorage::MultipartFormFieldRequestEncoding] The encoding of the value of `data`. Defaults to `RAW` if not defined.
        #   - `RAW` - RAW
        #   - `BASE64` - BASE64
        #   - `GZIP_BASE64` - GZIP_BASE64
        @encoding = encoding
      ...
      def self.from_json(json_object:)
        ...
        name = struct.name
        data = struct.data
        if parsed_json["encoding"].nil?
          encoding = nil
        else
          encoding = parsed_json["encoding"].to_json
          encoding = Filestorage::MultipartFormFieldRequestEncoding.from_json(json_object: encoding)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.encoding.nil? || Filestorage::MultipartFormFieldRequestEncoding.validate_raw(obj: obj.encoding)
