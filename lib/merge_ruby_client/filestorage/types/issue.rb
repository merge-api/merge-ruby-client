...
module Merge
  module Filestorage
    class Issue
      # @return [String]
      attr_reader :id
      # @return [Merge::Filestorage::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  - `ONGOING` - ONGOING
      #  - `RESOLVED` - RESOLVED
      attr_reader :status
      # @return [String]
      ...
      # @param id [String]
      # @param status [Merge::Filestorage::IssueStatusEnum] Status of the issue. Options: ('ONGOING', 'RESOLVED')
      #  - `ONGOING` - ONGOING
      #  - `RESOLVED` - RESOLVED
      ...
      # @return [Merge::Filestorage::Issue]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status&.is_a?(Merge::Filestorage::IssueStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
