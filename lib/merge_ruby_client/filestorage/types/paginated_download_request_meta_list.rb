...
require_relative "download_request_meta"
require "ostruct"
require "json"

module Merge
  module Filestorage
    class PaginatedDownloadRequestMetaList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Filestorage::DownloadRequestMeta>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Filestorage::DownloadRequestMeta>]
      ...
      # Deserialize a JSON object to an instance of PaginatedDownloadRequestMetaList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::DownloadRequestMeta.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedDownloadRequestMetaList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
