...
module Merge
  module Filestorage
    ...
    class SyncStatus
      ...
      # @return [Merge::Filestorage::SyncStatusStatusEnum]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Filestorage::SyncStatusStatusEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.is_a?(Merge::Filestorage::SyncStatusStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
