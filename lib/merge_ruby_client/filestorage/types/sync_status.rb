...
module Merge
  module Filestorage
    ...
    class SyncStatus
      ...
      # @return [Merge::Filestorage::LastSyncResultEnum]
      attr_reader :last_sync_result
      # @return [DateTime]
      attr_reader :last_sync_finished
      # @return [Merge::Filestorage::StatusFd5Enum]
      attr_reader :status
      # @return [Boolean]
      attr_reader :is_initial_sync
      # @return [Merge::Filestorage::SelectiveSyncConfigurationsUsageEnum]
      ...
      # @param last_sync_result [Merge::Filestorage::LastSyncResultEnum]
      # @param last_sync_finished [DateTime]
      # @param status [Merge::Filestorage::StatusFd5Enum]
      # @param is_initial_sync [Boolean]
      # @param selective_sync_configurations_usage [Merge::Filestorage::SelectiveSyncConfigurationsUsageEnum]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Filestorage::SyncStatus]
      ...
      def self.validate_raw(obj:)
        ...
        obj.last_sync_result&.is_a?(Merge::Filestorage::LastSyncResultEnum) != false || raise("Passed value for field obj.last_sync_result is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Merge::Filestorage::StatusFd5Enum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
        ...
        obj.selective_sync_configurations_usage&.is_a?(Merge::Filestorage::SelectiveSyncConfigurationsUsageEnum) != false || raise("Passed value for field obj.selective_sync_configurations_usage is not the expected type, validation failed.")
      end
    end
  end
end
