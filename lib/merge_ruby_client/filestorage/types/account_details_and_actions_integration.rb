...
module Merge
  module Filestorage
    class AccountDetailsAndActionsIntegration
      # @return [String]
      attr_reader :name
      # @return [Array<Merge::Filestorage::CategoriesEnum>]
      ...
      # @param name [String]
      # @param categories [Array<Merge::Filestorage::CategoriesEnum>]
      # @param image [String]
      ...
      def self.from_json(json_object:)
        ...
        available_model_operations = parsed_json["available_model_operations"]&.map do |v|
          v = v.to_json
          Merge::Filestorage::ModelOperation.from_json(json_object: v)
        end
        new(
          name: name,
          categories: categories,
