...
module Merge
  module Filestorage
    class ConditionSchema
      ...
      # @param condition_type [Filestorage::ConditionSchemaConditionType] The type of value(s) that can be set for this condition.
      #   - `BOOLEAN` - BOOLEAN
      #   - `DATE` - DATE
      #   - `DATE_TIME` - DATE_TIME
      #   - `INTEGER` - INTEGER
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["condition_type"].nil?
          condition_type = nil
        else
          condition_type = parsed_json["condition_type"].to_json
