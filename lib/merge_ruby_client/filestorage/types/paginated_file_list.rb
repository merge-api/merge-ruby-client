...
module Merge
  module Filestorage
    class PaginatedFileList
      ...
      # @return [Array<Merge::Filestorage::File>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Filestorage::File>]
      ...
      # Deserialize a JSON object to an instance of PaginatedFileList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::File.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedFileList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
