...
module Merge
  module Filestorage
    ...
    class FolderRequest
      attr_reader :name, :folder_url, :size, :description, :parent_folder, :drive, :permissions, :integration_params,
      ...
      def initialize(name: nil, folder_url: nil, size: nil, description: nil, parent_folder: nil, drive: nil,
                     permissions: nil, integration_params: nil, linked_account_params: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(name: name, folder_url: folder_url, size: size, description: description, parent_folder: parent_folder,
            drive: drive, permissions: permissions, integration_params: integration_params, linked_account_params: linked_account_params, additional_properties: struct)
      end
