...
module Merge
  module Filestorage
    class WebhookReceiverRequest
      ...
      # @return [Merge::Filestorage::WebhookReceiverRequest]
      ...
      # Deserialize a JSON object to an instance of WebhookReceiverRequest
      #
      ...
      # Serialize an instance of WebhookReceiverRequest to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
