...
module Merge
  module Filestorage
    ...
    class FolderPermissions
      # Deserialize a JSON object to an instance of FolderPermissions
      #
      # @param json_object [String]
      # @return [Merge::Filestorage::FolderPermissions]
      def self.from_json(json_object:)
        ...
        begin
          ...
          return struct&.map do |item|
                   item = item.to_json
                   Merge::Filestorage::FolderPermissionsItem.from_json(json_object: item)
                 end
        rescue StandardError
          # noop
        end
