...
module Merge
  module Filestorage
    ...
    class DataPassthroughRequest
      ...
      # @param method_ [Merge::Filestorage::MethodEnum]
      ...
      def self.validate_raw(obj:)
        obj.method_.is_a?(Merge::Filestorage::MethodEnum) != false || raise("Passed value for field obj.method_ is not the expected type, validation failed.")
