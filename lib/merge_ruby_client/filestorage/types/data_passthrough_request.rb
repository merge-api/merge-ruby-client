  ...
  module Filestorage
    ...
    class DataPassthroughRequest
      ...
      def self.from_json(json_object:)
        ...
        method = Filestorage::METHOD_ENUM.key(parsed_json["method"]) || parsed_json["method"]
        path = struct.path
        ...
        request_format = Filestorage::REQUEST_FORMAT_ENUM.key(parsed_json["request_format"]) || parsed_json["request_format"]
      ...
      def to_json(*_args)
        {
          "method": Filestorage::METHOD_ENUM[@method] || @method,
          "path": @path,
          "base_url_override": @base_url_override,
          "data": @data,
          "multipart_form_data": @multipart_form_data,
          "headers": @headers,
          "request_format": Filestorage::REQUEST_FORMAT_ENUM[@request_format] || @request_format,
          "normalize_response": @normalize_response
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        obj.method.is_a?(Filestorage::METHOD_ENUM) != false || raise("Passed value for field obj.method is not the expected type, validation failed.")
        ...
        obj.request_format&.is_a?(Filestorage::REQUEST_FORMAT_ENUM) != false || raise("Passed value for field obj.request_format is not the expected type, validation failed.")
