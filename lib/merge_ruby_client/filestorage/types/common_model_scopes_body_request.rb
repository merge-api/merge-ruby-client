...
module Merge
  module Filestorage
    class CommonModelScopesBodyRequest
      ...
      # @return [Array<Merge::Filestorage::EnabledActionsEnum>]
      ...
      # @param enabled_actions [Array<Merge::Filestorage::EnabledActionsEnum>]
      # @param disabled_fields [Array<String>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Filestorage::CommonModelScopesBodyRequest]
