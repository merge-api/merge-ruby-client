...
module Merge
  module Filestorage
    class MetaResponse
      ...
      # @return [Merge::Filestorage::LinkedAccountStatus]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Filestorage::LinkedAccountStatus]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Merge::Filestorage::LinkedAccountStatus.validate_raw(obj: obj.status)
