  ...
  module Filestorage
    ...
    class RemoteResponse
      ...
      def self.from_json(json_object:)
        ...
        response_type = Filestorage::RESPONSE_TYPE_ENUM.key(parsed_json["response_type"]) || parsed_json["response_type"]
      ...
      def to_json(*_args)
        {
          ...
          "response": @response,
          "response_headers": @response_headers,
          "response_type": Filestorage::RESPONSE_TYPE_ENUM[@response_type] || @response_type,
          "headers": @headers
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.response_type&.is_a?(Filestorage::RESPONSE_TYPE_ENUM) != false || raise("Passed value for field obj.response_type is not the expected type, validation failed.")
