...
module Merge
  module Filestorage
    ...
    class RemoteResponse
      ...
      # @return [Merge::Filestorage::ResponseTypeEnum]
      ...
      # @param response_type [Merge::Filestorage::ResponseTypeEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.response_type&.is_a?(Merge::Filestorage::ResponseTypeEnum) != false || raise("Passed value for field obj.response_type is not the expected type, validation failed.")
