...
module Merge
  module Filestorage
    class PaginatedFolderList
      ...
      # @return [Array<Merge::Filestorage::Folder>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Filestorage::Folder>]
      ...
      # Deserialize a JSON object to an instance of PaginatedFolderList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::Folder.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedFolderList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
