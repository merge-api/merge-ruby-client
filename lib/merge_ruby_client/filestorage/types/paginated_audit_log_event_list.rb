...
module Merge
  module Filestorage
    class PaginatedAuditLogEventList
      ...
      # @return [Array<Merge::Filestorage::AuditLogEvent>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Filestorage::AuditLogEvent>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::AuditLogEvent.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
