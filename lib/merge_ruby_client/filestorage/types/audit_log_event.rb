...
module Merge
  module Filestorage
    class AuditLogEvent
      ...
      # @param role [Filestorage::AuditLogEventRole] Designates the role of the user (or SYSTEM/API if action not taken by a user) at the time of this Event occurring.
      #   - `ADMIN` - ADMIN
      #   - `DEVELOPER` - DEVELOPER
      #   - `MEMBER` - MEMBER
      #   - `API` - API
      ...
      # @param event_type [Filestorage::AuditLogEventEventType] Designates the type of event that occurred.
