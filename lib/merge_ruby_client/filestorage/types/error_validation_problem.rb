...
module Merge
  module Filestorage
    class ErrorValidationProblem
      ...
      # @param source [Merge::Filestorage::ValidationProblemSource]
      # @param title [String]
      # @param detail [String]
      # @param problem_type [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Filestorage::ErrorValidationProblem]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["source"].nil?
          ...
          source = Merge::Filestorage::ValidationProblemSource.from_json(json_object: source)
        end
        title = struct["title"]
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Merge::Filestorage::ValidationProblemSource.validate_raw(obj: obj.source)
