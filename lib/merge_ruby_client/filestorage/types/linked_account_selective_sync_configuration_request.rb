...
module Merge
  module Filestorage
    class LinkedAccountSelectiveSyncConfigurationRequest
      ...
      # @param linked_account_conditions [Array<Filestorage::LinkedAccountConditionRequest>] The conditions belonging to a selective sync.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Filestorage::LinkedAccountSelectiveSyncConfigurationRequest]
      def initialize(linked_account_conditions:, additional_properties: nil)
        # @type [Array<Filestorage::LinkedAccountConditionRequest>] The conditions belonging to a selective sync.
      ...
      def self.from_json(json_object:)
        ...
        linked_account_conditions = parsed_json["linked_account_conditions"]&.map do |v|
          v = v.to_json
          Filestorage::LinkedAccountConditionRequest.from_json(json_object: v)
        end
