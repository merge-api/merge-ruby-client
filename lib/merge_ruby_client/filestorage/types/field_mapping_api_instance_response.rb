...
module Merge
  module Filestorage
    class FieldMappingApiInstanceResponse
      # @return [Array<Merge::Filestorage::FieldMappingApiInstance>]
      attr_reader :file
      # @return [Array<Merge::Filestorage::FieldMappingApiInstance>]
      attr_reader :folder
      # @return [Array<Merge::Filestorage::FieldMappingApiInstance>]
      ...
      # @param file [Array<Merge::Filestorage::FieldMappingApiInstance>]
      # @param folder [Array<Merge::Filestorage::FieldMappingApiInstance>]
      # @param drive [Array<Merge::Filestorage::FieldMappingApiInstance>]
      # @param group [Array<Merge::Filestorage::FieldMappingApiInstance>]
      # @param user [Array<Merge::Filestorage::FieldMappingApiInstance>]
      ...
      def self.from_json(json_object:)
        ...
        file = parsed_json["File"]&.map do |item|
          item = item.to_json
          Merge::Filestorage::FieldMappingApiInstance.from_json(json_object: item)
        end
