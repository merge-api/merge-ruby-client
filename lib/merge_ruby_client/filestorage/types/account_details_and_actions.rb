...
module Merge
  module Filestorage
    ...
    class AccountDetailsAndActions
      # @return [String]
      attr_reader :id
      # @return [Merge::Filestorage::CategoryEnum]
      attr_reader :category
      # @return [Merge::Filestorage::AccountDetailsAndActionsStatusEnum]
      attr_reader :status
      # @return [String]
      ...
      # @return [Merge::Filestorage::AccountDetailsAndActionsIntegration]
      ...
      # @param id [String]
      # @param category [Merge::Filestorage::CategoryEnum]
      # @param status [Merge::Filestorage::AccountDetailsAndActionsStatusEnum]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["integration"].nil?
          ...
          integration = Merge::Filestorage::AccountDetailsAndActionsIntegration.from_json(json_object: integration)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.category&.is_a?(Merge::Filestorage::CategoryEnum) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
        obj.status.is_a?(Merge::Filestorage::AccountDetailsAndActionsStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
