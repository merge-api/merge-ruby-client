...
module Merge
  module Filestorage
    class IndividualCommonModelScopeDeserializer
      ...
      # @return [Hash{String => Merge::Filestorage::ModelPermissionDeserializer}]
      attr_reader :model_permissions
      # @return [Merge::Filestorage::FieldPermissionDeserializer]
      ...
      # @param model_permissions [Hash{String => Merge::Filestorage::ModelPermissionDeserializer}]
      # @param field_permissions [Merge::Filestorage::FieldPermissionDeserializer]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Filestorage::IndividualCommonModelScopeDeserializer]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["field_permissions"].nil?
          ...
          field_permissions = Merge::Filestorage::FieldPermissionDeserializer.from_json(json_object: field_permissions)
        end
        new(
          model_name: model_name,
          model_permissions: model_permissions,
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_permissions.nil? || Merge::Filestorage::FieldPermissionDeserializer.validate_raw(obj: obj.field_permissions)
      end
    end
  end
end
