...
module Merge
  module Filestorage
    class AsyncPassthroughClient
      ...
      #
      # @param request [Hash] Request of type Merge::Filestorage::DataPassthroughRequest, as a Hash
      #   * :method_ (Merge::Filestorage::MethodEnum)
      #   * :path (String)
      #   * :base_url_override (String)
      #   * :data (String)
      #   * :multipart_form_data (Array<Merge::Filestorage::MultipartFormFieldRequest>)
      #   * :headers (Hash{String => Object})
      #   * :request_format (Merge::Filestorage::RequestFormatEnum)
      ...
      #  )
      #  api.filestorage.async_passthrough.create(request: { method_: GET, path: "/scooters" })
      def create(request:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/filestorage/v1/async-passthrough"
        end
        Merge::Filestorage::AsyncPassthroughReciept.from_json(json_object: response.body)
      end
      ...
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.filestorage.async_passthrough.retrieve(async_passthrough_receipt_id: "async_passthrough_receipt_id")
