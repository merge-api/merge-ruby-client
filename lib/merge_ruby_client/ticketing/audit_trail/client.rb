...
module Merge
  module Ticketing
    class AuditTrailClient
      ...
      # @return [Ticketing::AuditTrailClient]
      ...
      # @return [Ticketing::PaginatedAuditLogEventList]
      def list(cursor: nil, end_date: nil, event_type: nil, page_size: nil, start_date: nil, user_email: nil,
               request_options: nil)
        response = @request_client.conn.get("/api/ticketing/v1/audit-trail") do |req|
        ...
        Ticketing::PaginatedAuditLogEventList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncAuditTrailClient
      ...
      # @return [Ticketing::AsyncAuditTrailClient]
      def initialize(request_client:)
