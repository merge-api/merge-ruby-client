...
module Merge
  module Ticketing
    class AuditTrailClient
      ...
      # @return [Merge::Ticketing::PaginatedAuditLogEventList]
      # @example
      ...
      def list(cursor: nil, end_date: nil, event_type: nil, page_size: nil, start_date: nil, user_email: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/audit-trail"
        end
        Merge::Ticketing::PaginatedAuditLogEventList.from_json(json_object: response.body)
      end
    end
