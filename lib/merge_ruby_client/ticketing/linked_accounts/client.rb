...
module Merge
  module Ticketing
    class LinkedAccountsClient
      ...
      #
      # @param category [Merge::Ticketing::LinkedAccounts::ListLinkedAccountsRequestCategory] Options: `accounting`, `ats`, `crm`, `filestorage`, `hris`, `knowledgebase`,
      #  `mktg`, `ticketing`
      #  * `hris` - hris
      #  * `ats` - ats
      ...
      # @return [Merge::Ticketing::PaginatedAccountDetailsAndActionsList]
      # @example
      ...
      #  )
      #  api.ticketing.linked_accounts.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/linked-accounts"
        end
        Merge::Ticketing::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
