...
module Merge
  module Ticketing
    class LinkedAccountsClient
      ...
      #
      # @param category [Merge::Ticketing::LinkedAccounts::LinkedAccountsListRequestCategory] Options: ('hris', 'ats', 'accounting', 'ticketing', 'crm', 'mktg',
      #  'filestorage')
      #  - `hris` - hris
      #  - `ats` - ats
      ...
      #  )
      #  api.ticketing.linked_accounts.list
