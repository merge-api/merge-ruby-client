...
module Merge
  module Ticketing
    class LinkedAccountsClient
      ...
      # @return [Ticketing::LinkedAccountsClient]
      ...
      def list(category: nil, cursor: nil, end_user_email_address: nil, end_user_organization_name: nil,
        ...
        response = @request_client.conn.get("/api/ticketing/v1/linked-accounts") do |req|
        ...
        Ticketing::PaginatedAccountDetailsAndActionsList.from_json(json_object: response.body)
      end
    end
    ...
    class AsyncLinkedAccountsClient
      ...
      # @return [Ticketing::AsyncLinkedAccountsClient]
      def initialize(request_client:)
