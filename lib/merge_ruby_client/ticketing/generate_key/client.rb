...
module Merge
  module Ticketing
    class GenerateKeyClient
      ...
      #  )
      #  api.ticketing.generate_key.create(name: "Remote Deployment Key 1")
      def create(name:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/generate-key"
        end
