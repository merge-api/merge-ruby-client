...
module Merge
  module Ticketing
    class MetaResponse
      ...
      # @param status [Ticketing::LinkedAccountStatus]
      ...
      def initialize(request_schema:, has_conditional_params:, has_required_linked_account_params:,
        ...
        # @type [Ticketing::LinkedAccountStatus]
        @status = status
        # @type [Boolean]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["status"].nil?
          ...
          status = Ticketing::LinkedAccountStatus.from_json(json_object: status)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Ticketing::LinkedAccountStatus.validate_raw(obj: obj.status)
