...
module Merge
  module Ticketing
    class MetaResponse
      ...
      # @return [Merge::Ticketing::LinkedAccountStatus]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param status [Merge::Ticketing::LinkedAccountStatus]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["status"].nil?
          ...
          status = Merge::Ticketing::LinkedAccountStatus.from_json(json_object: status)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.nil? || Merge::Ticketing::LinkedAccountStatus.validate_raw(obj: obj.status)
