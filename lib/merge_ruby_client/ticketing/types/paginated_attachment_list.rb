...
module Merge
  module Ticketing
    class PaginatedAttachmentList
      ...
      # @return [Array<Merge::Ticketing::Attachment>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Attachment>]
      ...
      # Deserialize a JSON object to an instance of PaginatedAttachmentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Attachment.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedAttachmentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
