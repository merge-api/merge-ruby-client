...
module Merge
  module Ticketing
    ...
    class Collection
      ...
      # @param collection_type [Ticketing::CollectionCollectionType] The collection's type.
      #   - `LIST` - LIST
      #   - `PROJECT` - PROJECT
      ...
      # @param access_level [Ticketing::CollectionAccessLevel] The level of access a User has to the Collection and its sub-objects.
      #   - `PRIVATE` - PRIVATE
      #   - `COMPANY` - COMPANY
      #   - `PUBLIC` - PUBLIC
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["collection_type"].nil?
          collection_type = nil
        else
          collection_type = parsed_json["collection_type"].to_json
        ...
        if parsed_json["access_level"].nil?
          access_level = nil
        else
          access_level = parsed_json["access_level"].to_json
