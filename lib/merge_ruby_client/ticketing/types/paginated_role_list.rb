...
module Merge
  module Ticketing
    class PaginatedRoleList
      ...
      # @return [Array<Merge::Ticketing::Role>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Role>]
      ...
      # Deserialize a JSON object to an instance of PaginatedRoleList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Role.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedRoleList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
