...
module Merge
  module Ticketing
    ...
    # TODO
    class Comment
      attr_reader :id, :remote_id, :user, :contact, :body, :html_body, :ticket, :is_private, :remote_created_at,
      ...
      def initialize(id: nil, remote_id: nil, user: nil, contact: nil, body: nil, html_body: nil, ticket: nil,
                     is_private: nil, remote_created_at: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, user: user, contact: contact, body: body, html_body: html_body,
            ticket: ticket, is_private: is_private, remote_created_at: remote_created_at, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
