...
module Merge
  module Ticketing
    class FieldMappingApiInstance
      ...
      # @param target_field [Merge::Ticketing::FieldMappingApiInstanceTargetField]
      # @param remote_field [Merge::Ticketing::FieldMappingApiInstanceRemoteField]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ticketing::FieldMappingApiInstance]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["target_field"].nil?
          ...
          target_field = Merge::Ticketing::FieldMappingApiInstanceTargetField.from_json(json_object: target_field)
        end
        if parsed_json["remote_field"].nil?
          remote_field = nil
        else
          remote_field = parsed_json["remote_field"].to_json
          remote_field = Merge::Ticketing::FieldMappingApiInstanceRemoteField.from_json(json_object: remote_field)
        end
        new(
          id: id,
          is_integration_wide: is_integration_wide,
      ...
      def self.validate_raw(obj:)
        ...
        obj.target_field.nil? || Merge::Ticketing::FieldMappingApiInstanceTargetField.validate_raw(obj: obj.target_field)
        obj.remote_field.nil? || Merge::Ticketing::FieldMappingApiInstanceRemoteField.validate_raw(obj: obj.remote_field)
      end
    end
  end
end
