...
module Merge
  module Ticketing
    ...
    # TODO
    class Project
      attr_reader :id, :remote_id, :name, :description, :remote_was_deleted, :created_at, :modified_at,
      ...
      def initialize(id: nil, remote_id: nil, name: nil, description: nil, remote_was_deleted: nil, created_at: nil,
                     modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
        # @type [String] The third-party API ID of the matching object.
        @remote_id = remote_id
        # @type [String] The project's name.
        @name = name
        # @type [String] The project's description.
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, description: description, remote_was_deleted: remote_was_deleted,
