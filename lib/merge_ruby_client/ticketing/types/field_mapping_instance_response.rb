...
module Merge
  module Ticketing
    class FieldMappingInstanceResponse
      ...
      # @param model [Merge::Ticketing::FieldMappingApiInstance]
      ...
      # @return [Merge::Ticketing::FieldMappingInstanceResponse]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["model"].nil?
          ...
          model = Merge::Ticketing::FieldMappingApiInstance.from_json(json_object: model)
        end
      ...
      def self.validate_raw(obj:)
        Merge::Ticketing::FieldMappingApiInstance.validate_raw(obj: obj.model)
