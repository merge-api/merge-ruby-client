...
module Merge
  module Ticketing
    ...
    class AvailableActions
      ...
      # @return [Array<Merge::Ticketing::ModelOperation>]
      ...
      # @param integration [Merge::Ticketing::AccountIntegration]
      # @param passthrough_available [Boolean]
      # @param available_model_operations [Array<Merge::Ticketing::ModelOperation>]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["integration"].nil?
          ...
          integration = Merge::Ticketing::AccountIntegration.from_json(json_object: integration)
        end
        ...
        available_model_operations = parsed_json["available_model_operations"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::ModelOperation.from_json(json_object: item)
        end
        new(
          integration: integration,
          passthrough_available: passthrough_available,
      ...
      def self.validate_raw(obj:)
        Merge::Ticketing::AccountIntegration.validate_raw(obj: obj.integration)
