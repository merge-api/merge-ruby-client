...
module Merge
  module Ticketing
    class PaginatedTeamList
      ...
      # @return [Array<Merge::Ticketing::Team>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Team>]
      ...
      # Deserialize a JSON object to an instance of PaginatedTeamList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Team.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedTeamList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
