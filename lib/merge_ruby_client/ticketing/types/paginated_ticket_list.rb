...
module Merge
  module Ticketing
    class PaginatedTicketList
      ...
      # @return [Array<Merge::Ticketing::Ticket>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Ticket>]
      ...
      # Deserialize a JSON object to an instance of PaginatedTicketList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Ticket.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedTicketList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
