...
module Merge
  module Ticketing
    class IndividualCommonModelScopeDeserializerRequest
      ...
      # @return [Hash{String => Merge::Ticketing::ModelPermissionDeserializerRequest}]
      attr_reader :model_permissions
      # @return [Merge::Ticketing::FieldPermissionDeserializerRequest]
      ...
      # @param model_permissions [Hash{String => Merge::Ticketing::ModelPermissionDeserializerRequest}]
      # @param field_permissions [Merge::Ticketing::FieldPermissionDeserializerRequest]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ticketing::IndividualCommonModelScopeDeserializerRequest]
      ...
      def self.from_json(json_object:)
        ...
        model_permissions = parsed_json["model_permissions"]&.transform_values do |value|
          value = value.to_json
          Merge::Ticketing::ModelPermissionDeserializerRequest.from_json(json_object: value)
        end
        if parsed_json["field_permissions"].nil?
          field_permissions = nil
        else
          field_permissions = parsed_json["field_permissions"].to_json
          field_permissions = Merge::Ticketing::FieldPermissionDeserializerRequest.from_json(json_object: field_permissions)
        end
        new(
          model_name: model_name,
          model_permissions: model_permissions,
      ...
      def self.validate_raw(obj:)
        ...
        obj.field_permissions.nil? || Merge::Ticketing::FieldPermissionDeserializerRequest.validate_raw(obj: obj.field_permissions)
      end
    end
  end
end
