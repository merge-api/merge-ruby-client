...
module Merge
  module Ticketing
    class AuditLogEvent
      ...
      # @param role [Ticketing::AuditLogEventRole] Designates the role of the user (or SYSTEM/API if action not taken by a user) at the time of this Event occurring.
      #   - `ADMIN` - ADMIN
      #   - `DEVELOPER` - DEVELOPER
      #   - `MEMBER` - MEMBER
      #   - `API` - API
      ...
      # @param event_type [Ticketing::AuditLogEventEventType] Designates the type of event that occurred.
