...
module Merge
  module Ticketing
    class ErrorValidationProblem
      # @return [Merge::Ticketing::ValidationProblemSource]
      attr_reader :source
      # @return [String]
      attr_reader :title
      # @return [String]
      ...
      # @param source [Merge::Ticketing::ValidationProblemSource]
      # @param title [String]
      # @param detail [String]
      # @param problem_type [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ticketing::ErrorValidationProblem]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["source"].nil?
          ...
          source = Merge::Ticketing::ValidationProblemSource.from_json(json_object: source)
        end
        title = struct["title"]
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Merge::Ticketing::ValidationProblemSource.validate_raw(obj: obj.source)
