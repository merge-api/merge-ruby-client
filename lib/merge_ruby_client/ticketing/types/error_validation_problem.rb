...
module Merge
  module Ticketing
    class ErrorValidationProblem
      ...
      # @param source [Ticketing::ValidationProblemSource]
      # @param title [String]
      # @param detail [String]
      # @param problem_type [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ticketing::ErrorValidationProblem]
      def initialize(title:, detail:, problem_type:, source: nil, additional_properties: nil)
        # @type [Ticketing::ValidationProblemSource]
        @source = source
        # @type [String]
        @title = title
        # @type [String]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["source"].nil?
          ...
          source = Ticketing::ValidationProblemSource.from_json(json_object: source)
        end
        title = struct.title
      ...
      def self.validate_raw(obj:)
        obj.source.nil? || Ticketing::ValidationProblemSource.validate_raw(obj: obj.source)
