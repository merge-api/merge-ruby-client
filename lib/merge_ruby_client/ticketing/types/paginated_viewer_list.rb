...
module Merge
  module Ticketing
    class PaginatedViewerList
      # @return [String]
      attr_reader :next_
      # @return [String]
      attr_reader :previous
      # @return [Array<Merge::Ticketing::Viewer>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Viewer>]
      ...
      # Deserialize a JSON object to an instance of PaginatedViewerList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Viewer.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedViewerList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
