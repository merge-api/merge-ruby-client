...
module Merge
  module Ticketing
    class DebugModeLog
      ...
      # @return [Merge::Ticketing::DebugModelLogSummary]
      ...
      # @param log_summary [Merge::Ticketing::DebugModelLogSummary]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Merge::Ticketing::DebugModeLog]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["log_summary"].nil?
          ...
          log_summary = Merge::Ticketing::DebugModelLogSummary.from_json(json_object: log_summary)
        end
        new(
          log_id: log_id,
          dashboard_view: dashboard_view,
      ...
      def self.validate_raw(obj:)
        ...
        Merge::Ticketing::DebugModelLogSummary.validate_raw(obj: obj.log_summary)
      end
    end
  end
end
