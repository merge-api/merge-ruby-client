...
module Merge
  module Ticketing
    class PaginatedCollectionList
      ...
      # @return [Array<Merge::Ticketing::Collection>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Collection>]
      ...
      # Deserialize a JSON object to an instance of PaginatedCollectionList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Collection.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedCollectionList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
