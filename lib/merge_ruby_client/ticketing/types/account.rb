...
module Merge
  module Ticketing
    ...
    # TODO
    class Account
      attr_reader :id, :remote_id, :name, :domains, :remote_was_deleted, :created_at, :modified_at, :field_mappings,
      ...
      def initialize(id: nil, remote_id: nil, name: nil, domains: nil, remote_was_deleted: nil, created_at: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, domains: domains, remote_was_deleted: remote_was_deleted,
