...
module Merge
  module Ticketing
    ...
    class SyncStatus
      ...
      # @return [Merge::Ticketing::LastSyncResultEnum]
      attr_reader :last_sync_result
      # @return [DateTime]
      attr_reader :last_sync_finished
      # @return [Merge::Ticketing::StatusFd5Enum]
      attr_reader :status
      # @return [Boolean]
      ...
      # @param last_sync_result [Merge::Ticketing::LastSyncResultEnum]
      # @param last_sync_finished [DateTime]
      # @param status [Merge::Ticketing::StatusFd5Enum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.last_sync_result&.is_a?(Merge::Ticketing::LastSyncResultEnum) != false || raise("Passed value for field obj.last_sync_result is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Merge::Ticketing::StatusFd5Enum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
