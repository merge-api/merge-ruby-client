...
module Merge
  module Ticketing
    class PaginatedRemoteFieldClassList
      ...
      # @return [Array<Merge::Ticketing::RemoteFieldClass>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::RemoteFieldClass>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::RemoteFieldClass.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
