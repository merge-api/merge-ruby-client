...
module Merge
  module Ticketing
    ...
    class DataPassthroughRequest
      ...
      attr_reader :data
      # @return [Array<Merge::Ticketing::MultipartFormFieldRequest>] Pass an array of `MultipartFormField` objects in here instead of using the
      ...
      attr_reader :headers
      # @return [Merge::Ticketing::RequestFormatEnum]
      ...
      #  matching the data's format
      # @param multipart_form_data [Array<Merge::Ticketing::MultipartFormFieldRequest>] Pass an array of `MultipartFormField` objects in here instead of using the
      #  `data` param if `request_format` is set to `MULTIPART`.
      # @param headers [Hash{String => Object}] The headers to use for the request (Merge will handle the account's
      #  authorization headers). `Content-Type` header is required for passthrough.
      #  Choose content type corresponding to expected format of receiving server.
      # @param request_format [Merge::Ticketing::RequestFormatEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.request_format&.is_a?(Merge::Ticketing::RequestFormatEnum) != false || raise("Passed value for field obj.request_format is not the expected type, validation failed.")
