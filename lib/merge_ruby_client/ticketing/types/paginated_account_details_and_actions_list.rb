...
module Merge
  module Ticketing
    class PaginatedAccountDetailsAndActionsList
      ...
      # @return [Array<Merge::Ticketing::AccountDetailsAndActions>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::AccountDetailsAndActions>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::AccountDetailsAndActions.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
