...
module Merge
  module Ticketing
    class PaginatedTagList
      ...
      # @return [Array<Merge::Ticketing::Tag>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Tag>]
      ...
      # Deserialize a JSON object to an instance of PaginatedTagList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Tag.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedTagList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
