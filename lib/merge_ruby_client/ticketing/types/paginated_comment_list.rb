...
module Merge
  module Ticketing
    class PaginatedCommentList
      ...
      # @return [Array<Merge::Ticketing::Comment>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Comment>]
      ...
      # Deserialize a JSON object to an instance of PaginatedCommentList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Comment.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedCommentList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
