...
module Merge
  module Ticketing
    class LinkedAccountSelectiveSyncConfiguration
      ...
      # @param linked_account_conditions [Array<Ticketing::LinkedAccountCondition>] The conditions belonging to a selective sync.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ticketing::LinkedAccountSelectiveSyncConfiguration]
      def initialize(linked_account_conditions: nil, additional_properties: nil)
        # @type [Array<Ticketing::LinkedAccountCondition>] The conditions belonging to a selective sync.
      ...
      def self.from_json(json_object:)
        ...
        linked_account_conditions = parsed_json["linked_account_conditions"]&.map do |v|
          v = v.to_json
          Ticketing::LinkedAccountCondition.from_json(json_object: v)
        end
