...
module Merge
  module Ticketing
    ...
    # TODO
    class User
      attr_reader :id, :remote_id, :name, :email_address, :is_active, :teams, :roles, :avatar, :remote_was_deleted,
      ...
      def initialize(id: nil, remote_id: nil, name: nil, email_address: nil, is_active: nil, teams: nil, roles: nil,
                     avatar: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, name: name, email_address: email_address, is_active: is_active, teams: teams,
            roles: roles, avatar: avatar, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
