  ...
  module Ticketing
    ...
    class TicketRequest
      attr_reader :name, :assignees, :creator, :due_date, :status, :description, :collections, :ticket_type, :account,
                  :contact, :parent_ticket, :attachments, :tags, :completed_at, :ticket_url, :priority, :integration_params, :linked_account_params, :remote_fields, :additional_properties
      ...
      # @param status [Ticketing::TicketRequestStatus] The current status of the ticket.
      #   - `OPEN` - OPEN
      #   - `CLOSED` - CLOSED
      ...
      # @param priority [Ticketing::TicketRequestPriority] The priority or urgency of the Ticket.
      #   - `URGENT` - URGENT
      #   - `HIGH` - HIGH
      #   - `NORMAL` - NORMAL
      #   - `LOW` - LOW
      ...
      def initialize(name: nil, assignees: nil, creator: nil, due_date: nil, status: nil, description: nil,
                     collections: nil, ticket_type: nil, account: nil, contact: nil, parent_ticket: nil, attachments: nil, tags: nil, completed_at: nil, ticket_url: nil, priority: nil, integration_params: nil, linked_account_params: nil, remote_fields: nil, additional_properties: nil)
