...
module Merge
  module Ticketing
    class PaginatedAccountList
      ...
      # @return [Array<Merge::Ticketing::Account>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::Account>]
      ...
      # Deserialize a JSON object to an instance of PaginatedAccountList
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |item|
          item = item.to_json
          Merge::Ticketing::Account.from_json(json_object: item)
        end
        new(
          next_: next_,
          previous: previous,
      ...
      # Serialize an instance of PaginatedAccountList to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
