...
module Merge
  module Ticketing
    ...
    class Role
      ...
      # @param ticket_actions [Array<Ticketing::TICKET_ACTIONS_ENUM>] The set of actions that a User with this Role can perform. Possible enum values include: `VIEW`, `CREATE`, `EDIT`, `DELETE`, `CLOSE`, and `ASSIGN`.
      # @param ticket_access [TICKET_ACCESS_ENUM] The level of Ticket access that a User with this Role can perform.
      #   - `ALL` - ALL
      ...
      def initialize(id: nil, remote_id: nil, name: nil, ticket_actions: nil, ticket_access: nil,
        ...
        @name = name
        # @type [Array<Ticketing::TICKET_ACTIONS_ENUM>] The set of actions that a User with this Role can perform. Possible enum values include: `VIEW`, `CREATE`, `EDIT`, `DELETE`, `CLOSE`, and `ASSIGN`.
        @ticket_actions = ticket_actions
        # @type [TICKET_ACCESS_ENUM] The level of Ticket access that a User with this Role can perform.
        #   - `ALL` - ALL
        #   - `ASSIGNED_ONLY` - ASSIGNED_ONLY
        #   - `TEAM_ONLY` - TEAM_ONLY
      ...
      def self.from_json(json_object:)
        ...
        ticket_actions = parsed_json["ticket_actions"]&.map do |v|
          v = v.to_json
          Ticketing::TICKET_ACTIONS_ENUM.key(v) || v
        end
        ticket_access = Ticketing::TICKET_ACCESS_ENUM.key(parsed_json["ticket_access"]) || parsed_json["ticket_access"]
      ...
      def to_json(*_args)
        {
          ...
          "name": @name,
          "ticket_actions": @ticket_actions,
          "ticket_access": Ticketing::TICKET_ACCESS_ENUM[@ticket_access] || @ticket_access,
          "remote_was_deleted": @remote_was_deleted,
          "created_at": @created_at,
          "modified_at": @modified_at,
          "field_mappings": @field_mappings,
      ...
      def self.validate_raw(obj:)
        ...
        obj.ticket_access&.is_a?(Ticketing::TICKET_ACCESS_ENUM) != false || raise("Passed value for field obj.ticket_access is not the expected type, validation failed.")
