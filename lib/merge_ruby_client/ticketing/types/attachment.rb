...
module Merge
  module Ticketing
    ...
    # TODO
    class Attachment
      attr_reader :id, :remote_id, :file_name, :ticket, :file_url, :content_type, :uploaded_by, :remote_created_at,
      ...
      def initialize(id: nil, remote_id: nil, file_name: nil, ticket: nil, file_url: nil, content_type: nil,
                     uploaded_by: nil, remote_created_at: nil, remote_was_deleted: nil, created_at: nil, modified_at: nil, field_mappings: nil, remote_data: nil, additional_properties: nil)
        # @type [String]
        @id = id
      ...
      def self.from_json(json_object:)
        ...
        new(id: id, remote_id: remote_id, file_name: file_name, ticket: ticket, file_url: file_url,
            content_type: content_type, uploaded_by: uploaded_by, remote_created_at: remote_created_at, remote_was_deleted: remote_was_deleted, created_at: created_at, modified_at: modified_at, field_mappings: field_mappings, remote_data: remote_data, additional_properties: struct)
      end
