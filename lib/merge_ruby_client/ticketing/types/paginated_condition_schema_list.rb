...
module Merge
  module Ticketing
    class PaginatedConditionSchemaList
      ...
      # @return [Array<Merge::Ticketing::ConditionSchema>]
      attr_reader :results
      ...
      # @param results [Array<Merge::Ticketing::ConditionSchema>]
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          Merge::Ticketing::ConditionSchema.from_json(json_object: v)
        end
        new(
          next_: next_,
          previous: previous,
