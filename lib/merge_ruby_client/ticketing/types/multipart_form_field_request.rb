...
module Merge
  module Ticketing
    ...
    class MultipartFormFieldRequest
      ...
      attr_reader :data
      # @return [Merge::Ticketing::EncodingEnum] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #  - `RAW` - RAW
      #  - `BASE64` - BASE64
      ...
      # @param encoding [Merge::Ticketing::EncodingEnum] The encoding of the value of `data`. Defaults to `RAW` if not defined.
      #  - `RAW` - RAW
      #  - `BASE64` - BASE64
      #  - `GZIP_BASE64` - GZIP_BASE64
      ...
      # @return [Merge::Ticketing::MultipartFormFieldRequest]
      ...
      def self.validate_raw(obj:)
        ...
        obj.encoding&.is_a?(Merge::Ticketing::EncodingEnum) != false || raise("Passed value for field obj.encoding is not the expected type, validation failed.")
