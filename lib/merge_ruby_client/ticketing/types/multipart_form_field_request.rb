  ...
  module Ticketing
    ...
    class MultipartFormFieldRequest
      ...
      def self.from_json(json_object:)
        ...
        name = struct.name
        data = struct.data
        encoding = Ticketing::ENCODING_ENUM.key(parsed_json["encoding"]) || parsed_json["encoding"]
      ...
      def to_json(*_args)
        {
          "name": @name,
          "data": @data,
          "encoding": Ticketing::ENCODING_ENUM[@encoding] || @encoding,
          "file_name": @file_name,
          "content_type": @content_type
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.encoding&.is_a?(Ticketing::ENCODING_ENUM) != false || raise("Passed value for field obj.encoding is not the expected type, validation failed.")
