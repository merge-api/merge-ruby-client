...
module Merge
  module Ticketing
    ...
    class RemoteResponse
      ...
      # @return [Merge::Ticketing::ResponseTypeEnum]
      ...
      # @param response_type [Merge::Ticketing::ResponseTypeEnum]
      ...
      def self.validate_raw(obj:)
        ...
        obj.response_type&.is_a?(Merge::Ticketing::ResponseTypeEnum) != false || raise("Passed value for field obj.response_type is not the expected type, validation failed.")
