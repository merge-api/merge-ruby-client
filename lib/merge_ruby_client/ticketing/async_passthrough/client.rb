...
module Merge
  module Ticketing
    class AsyncPassthroughClient
      ...
      # @return [Merge::Ticketing::AsyncPassthroughReciept]
      # @example
      ...
      #  )
      #  api.ticketing.async_passthrough.create(request: { method: GET, path: "/scooters" })
      def create(request:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/async-passthrough"
        end
        Merge::Ticketing::AsyncPassthroughReciept.from_json(json_object: response.body)
      end
      ...
      # @param request_options [Merge::RequestOptions]
      # @return [Merge::Ticketing::RemoteResponse, String]
      # @example
      #  api = Merge::Client.new(
      #    base_url: "https://api.example.com",
      #    environment: Merge::Environment::PRODUCTION,
      #    api_key: "YOUR_AUTH_TOKEN"
      #  )
      #  api.ticketing.async_passthrough.retrieve(async_passthrough_receipt_id: "async_passthrough_receipt_id")
      def retrieve(async_passthrough_receipt_id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/async-passthrough/#{async_passthrough_receipt_id}"
        end
        Merge::Ticketing::AsyncPassthrough::AsyncPassthroughRetrieveResponse.from_json(json_object: response.body)
      end
    end
