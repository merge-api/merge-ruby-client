...
module Merge
  module Ticketing
    class LinkTokenClient
      ...
      #  unique identifiers.
      # @param categories [Array<Merge::Ticketing::CategoriesEnum>] The integration categories to show in Merge Link.
      ...
      #  given Linked Account.Request of type Array<Merge::Ticketing::CommonModelScopesBodyRequest>, as a Hash
      #   * :model_id (String)
      #   * :enabled_actions (Array<Merge::Ticketing::EnabledActionsEnum>)
      ...
      # @param language [Merge::Ticketing::LanguageEnum] The following subset of IETF language tags can be used to configure
      #  localization.
      #  * `en` - en
      #  * `de` - de
      ...
      # @param completed_account_initial_screen [Merge::Ticketing::COMPLETED_ACCOUNT_INITIAL_SCREEN_ENUM] When creating a Link token, you can specifiy the initial screen of Linking Flow
      ...
      #  )
      #  api.ticketing.link_token.create(
      ...
      def create(end_user_email_address:, end_user_organization_name:, end_user_origin_id:, categories:,
        ...
        **(request_options&.additional_headers || {})
        ...
        Merge::Ticketing::LinkToken.from_json(json_object: response.body)
      end
    end
