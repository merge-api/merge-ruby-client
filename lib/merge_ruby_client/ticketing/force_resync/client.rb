...
module Merge
  module Ticketing
    class ForceResyncClient
      ...
      # @return [Ticketing::ForceResyncClient]
      ...
      # @return [Array<Ticketing::SyncStatus>]
      def sync_status_resync_create(request_options: nil)
        response = @request_client.conn.post("/api/ticketing/v1/sync-status/resync") do |req|
    ...
    class AsyncForceResyncClient
      ...
      # @return [Ticketing::AsyncForceResyncClient]
      def initialize(request_client:)
