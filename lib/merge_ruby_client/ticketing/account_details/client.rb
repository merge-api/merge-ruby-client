...
module Merge
  module Ticketing
    class AccountDetailsClient
      ...
      #  )
      #  api.ticketing.account_details.retrieve
      def retrieve(request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/account-details"
        end
        Merge::Ticketing::AccountDetails.from_json(json_object: response.body)
      end
    end
