...
module Merge
  module Ticketing
    class Tickets
      class RetrieveTicketsRequestExpand
        ACCOUNT = "account"
        ...
        ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "assignees,assigned_teams,account,contact,creator,parent_ticket"
        ...
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR = "assignees,collections,assigned_teams,account,contact,creator"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "assignees,collections,assigned_teams,account,contact,creator,parent_ticket"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET = "assignees,collections,assigned_teams,account,contact,parent_ticket"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR = "assignees,collections,assigned_teams,account,creator"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET = "assignees,collections,assigned_teams,account,creator,parent_ticket"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET = "assignees,collections,assigned_teams,account,parent_ticket"
        ...
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET = "assignees,collections,assigned_teams,contact,creator,parent_ticket"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET = "assignees,collections,assigned_teams,contact,parent_ticket"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR = "assignees,collections,assigned_teams,creator"
        ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET = "assignees,collections,assigned_teams,creator,parent_ticket"
        ...
        ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "attachments,assigned_teams,account,contact,creator,parent_ticket"
        ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET = "attachments,assigned_teams,account,contact,parent_ticket"
        ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CREATOR = "attachments,assigned_teams,account,creator"
        ATTACHMENTS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET = "attachments,assigned_teams,account,creator,parent_ticket"
        ...
        ATTACHMENTS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET = "attachments,assigned_teams,contact,creator,parent_ticket"
        ...
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR = "attachments,assignees,assigned_teams,account,contact,creator"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "attachments,assignees,assigned_teams,account,contact,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET = "attachments,assignees,assigned_teams,account,contact,parent_ticket"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CREATOR = "attachments,assignees,assigned_teams,account,creator"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET = "attachments,assignees,assigned_teams,account,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET = "attachments,assignees,assigned_teams,account,parent_ticket"
        ...
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET = "attachments,assignees,assigned_teams,contact,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET = "attachments,assignees,assigned_teams,contact,parent_ticket"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CREATOR = "attachments,assignees,assigned_teams,creator"
        ATTACHMENTS_ASSIGNEES_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET = "attachments,assignees,assigned_teams,creator,parent_ticket"
        ...
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT = "attachments,assignees,collections,assigned_teams,account"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT = "attachments,assignees,collections,assigned_teams,account,contact"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR = "attachments,assignees,collections,assigned_teams,account,contact,creator"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,account,contact,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,account,contact,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR = "attachments,assignees,collections,assigned_teams,account,creator"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,account,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,account,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT = "attachments,assignees,collections,assigned_teams,contact"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR = "attachments,assignees,collections,assigned_teams,contact,creator"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,contact,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,contact,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR = "attachments,assignees,collections,assigned_teams,creator"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,creator,parent_ticket"
        ATTACHMENTS_ASSIGNEES_COLLECTIONS_ASSIGNED_TEAMS_PARENT_TICKET = "attachments,assignees,collections,assigned_teams,parent_ticket"
        ...
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR = "attachments,collections,assigned_teams,account,contact,creator"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "attachments,collections,assigned_teams,account,contact,creator,parent_ticket"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET = "attachments,collections,assigned_teams,account,contact,parent_ticket"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR = "attachments,collections,assigned_teams,account,creator"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET = "attachments,collections,assigned_teams,account,creator,parent_ticket"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_PARENT_TICKET = "attachments,collections,assigned_teams,account,parent_ticket"
        ...
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET = "attachments,collections,assigned_teams,contact,creator,parent_ticket"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CONTACT_PARENT_TICKET = "attachments,collections,assigned_teams,contact,parent_ticket"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CREATOR = "attachments,collections,assigned_teams,creator"
        ATTACHMENTS_COLLECTIONS_ASSIGNED_TEAMS_CREATOR_PARENT_TICKET = "attachments,collections,assigned_teams,creator,parent_ticket"
        ...
        COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_CREATOR_PARENT_TICKET = "collections,assigned_teams,account,contact,creator,parent_ticket"
        COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CONTACT_PARENT_TICKET = "collections,assigned_teams,account,contact,parent_ticket"
        COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR = "collections,assigned_teams,account,creator"
        COLLECTIONS_ASSIGNED_TEAMS_ACCOUNT_CREATOR_PARENT_TICKET = "collections,assigned_teams,account,creator,parent_ticket"
        ...
        COLLECTIONS_ASSIGNED_TEAMS_CONTACT_CREATOR_PARENT_TICKET = "collections,assigned_teams,contact,creator,parent_ticket"
