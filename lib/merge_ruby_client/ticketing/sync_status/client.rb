...
module Merge
  module Ticketing
    class SyncStatusClient
      ...
      # @return [Merge::Ticketing::PaginatedSyncStatusList]
      # @example
      ...
      #  )
      #  api.ticketing.sync_status.list(cursor: "cD0yMDIxLTAxLTA2KzAzJTNBMjQlM0E1My40MzQzMjYlMkIwMCUzQTAw")
      def list(cursor: nil, page_size: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/sync-status"
        end
        Merge::Ticketing::PaginatedSyncStatusList.from_json(json_object: response.body)
      end
    end
