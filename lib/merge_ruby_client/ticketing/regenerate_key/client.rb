...
module Merge
  module Ticketing
    class RegenerateKeyClient
      ...
      # @return [Merge::Ticketing::RemoteKey]
      # @example
      ...
      #  )
      #  api.ticketing.regenerate_key.create(name: "Remote Deployment Key 1")
      def create(name:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/ticketing/v1/regenerate-key"
        end
        Merge::Ticketing::RemoteKey.from_json(json_object: response.body)
      end
    end
