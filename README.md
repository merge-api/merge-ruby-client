...
account_token_response = merge.ats.account_token.retrieve(PUBLIC_TOKEN)
...
employee = merge.hris.employees.retrieve(EMPLOYEE_ID)
```
...
merge.accounting.contacts.retrieve(CONTACT_ID)
```
